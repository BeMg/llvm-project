...
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr getelementptr inbounds ({ i32, [2 x i64] }, ptr @__riscv_feature_bits, i32 0, i32 1, i32 0), align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr getelementptr inbounds ({ i32, [2 x i64] }, ptr @__riscv_feature_bits, i32 0, i32 1, i32 1), align 8
// CHECK-NEXT:    [[TMP4:%.*]] = and i64 [[TMP2]], 256
// CHECK-NEXT:    [[TMP5:%.*]] = icmp eq i64 [[TMP4]], 256
// CHECK-NEXT:    [[TMP6:%.*]] = and i1 true, [[TMP5]]
...
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr getelementptr inbounds ({ i32, [2 x i64] }, ptr @__riscv_feature_bits, i32 0, i32 1, i32 0), align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr getelementptr inbounds ({ i32, [2 x i64] }, ptr @__riscv_feature_bits, i32 0, i32 1, i32 1), align 8
// CHECK-NEXT:    [[TMP4:%.*]] = and i64 [[TMP2]], 260
// CHECK-NEXT:    [[TMP5:%.*]] = icmp eq i64 [[TMP4]], 260
// CHECK-NEXT:    [[TMP6:%.*]] = and i1 true, [[TMP5]]
// CHECK-NEXT:    [[TMP7:%.*]] = and i64 [[TMP3]], 4096
// CHECK-NEXT:    [[TMP8:%.*]] = icmp eq i64 [[TMP7]], 4096
// CHECK-NEXT:    [[TMP9:%.*]] = and i1 [[TMP6]], [[TMP8]]
...
// CHECK-NEXT:    [[TMP9:%.*]] = and i64 [[TMP7]], 2097408
// CHECK-NEXT:    [[TMP10:%.*]] = icmp eq i64 [[TMP9]], 2097408
