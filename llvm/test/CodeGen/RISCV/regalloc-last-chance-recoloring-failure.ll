...
; CHECK-NEXT:    vfwadd.vv v8, v20, v16, v0.t
; CHECK-NEXT:    csrr a0, vlenb
...
; CHECK-NEXT:    li a0, 32
; CHECK-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; CHECK-NEXT:    vrgather.vv v4, v12, v8, v0.t
; CHECK-NEXT:    vsetvli zero, s0, e16, m4, ta, ma
; CHECK-NEXT:    csrr a1, vlenb
...
; CHECK-NEXT:    vfdiv.vv v24, v8, v8, v0.t
...
; SUBREGLIVENESS-NEXT:    vloxseg2ei32.v v8, (a0), v16
...
; SUBREGLIVENESS-NEXT:    vfwadd.vv v8, v20, v16, v0.t
; SUBREGLIVENESS-NEXT:    csrr a0, vlenb
...
; SUBREGLIVENESS-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; SUBREGLIVENESS-NEXT:    vrgather.vv v4, v12, v8, v0.t
; SUBREGLIVENESS-NEXT:    vsetvli zero, s0, e16, m4, ta, ma
; SUBREGLIVENESS-NEXT:    csrr a1, vlenb
; SUBREGLIVENESS-NEXT:    slli a1, a1, 3
; SUBREGLIVENESS-NEXT:    add a1, sp, a1
; SUBREGLIVENESS-NEXT:    addi a1, a1, 16
; SUBREGLIVENESS-NEXT:    vl8r.v v16, (a1) # Unknown-size Folded Reload
...
; SUBREGLIVENESS-NEXT:    vfwsub.wv v24, v16, v8
...
; SUBREGLIVENESS-NEXT:    vfdiv.vv v24, v8, v8, v0.t
; SUBREGLIVENESS-NEXT:    vse32.v v24, (a0)
; SUBREGLIVENESS-NEXT:    csrr a0, vlenb
; SUBREGLIVENESS-NEXT:    slli a0, a0, 4
