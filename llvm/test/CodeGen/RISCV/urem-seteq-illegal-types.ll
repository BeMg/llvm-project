...
; RV32MV-NEXT:    vle16.v v8, (a2)
; RV32MV-NEXT:    vand.vx v10, v9, a1
; RV32MV-NEXT:    vid.v v9
; RV32MV-NEXT:    vsub.vv v9, v10, v9
; RV32MV-NEXT:    vmul.vv v12, v9, v8
; RV32MV-NEXT:    vadd.vv v10, v12, v12
; RV32MV-NEXT:    lui a2, 41121
; RV32MV-NEXT:    addi a2, a2, -1527
; RV32MV-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV32MV-NEXT:    vmv.s.x v9, a2
; RV32MV-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; RV32MV-NEXT:    vsext.vf2 v8, v9
; RV32MV-NEXT:    vsll.vv v11, v10, v8
; RV32MV-NEXT:    vand.vx v10, v12, a1
; RV32MV-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV32MV-NEXT:    vmv.v.i v8, 1
; RV32MV-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; RV32MV-NEXT:    vsext.vf2 v9, v8
; RV32MV-NEXT:    lui a2, %hi(.LCPI4_1)
; RV32MV-NEXT:    addi a2, a2, %lo(.LCPI4_1)
; RV32MV-NEXT:    vle16.v v8, (a2)
; RV32MV-NEXT:    vsrl.vv v9, v10, v9
; RV32MV-NEXT:    vor.vv v9, v9, v11
; RV32MV-NEXT:    vand.vx v9, v9, a1
; RV32MV-NEXT:    vmsltu.vv v0, v8, v9
; RV32MV-NEXT:    vmv.v.i v8, 0
; RV32MV-NEXT:    vmerge.vim v9, v8, -1, v0
; RV32MV-NEXT:    vslidedown.vi v8, v9, 2
...
; RV32MV-NEXT:    vslidedown.vi v8, v9, 1
...
; RV64MV-NEXT:    vle16.v v8, (a2)
; RV64MV-NEXT:    vand.vx v10, v9, a1
; RV64MV-NEXT:    vid.v v9
; RV64MV-NEXT:    vsub.vv v9, v10, v9
; RV64MV-NEXT:    vmul.vv v12, v9, v8
; RV64MV-NEXT:    vadd.vv v10, v12, v12
; RV64MV-NEXT:    lui a2, 41121
; RV64MV-NEXT:    addi a2, a2, -1527
; RV64MV-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV64MV-NEXT:    vmv.s.x v9, a2
; RV64MV-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; RV64MV-NEXT:    vsext.vf2 v8, v9
; RV64MV-NEXT:    vsll.vv v11, v10, v8
; RV64MV-NEXT:    vand.vx v10, v12, a1
; RV64MV-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV64MV-NEXT:    vmv.v.i v8, 1
; RV64MV-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; RV64MV-NEXT:    vsext.vf2 v9, v8
; RV64MV-NEXT:    lui a2, %hi(.LCPI4_1)
; RV64MV-NEXT:    addi a2, a2, %lo(.LCPI4_1)
; RV64MV-NEXT:    vle16.v v8, (a2)
; RV64MV-NEXT:    vsrl.vv v9, v10, v9
; RV64MV-NEXT:    vor.vv v9, v9, v11
; RV64MV-NEXT:    vand.vx v9, v9, a1
; RV64MV-NEXT:    vmsltu.vv v0, v8, v9
; RV64MV-NEXT:    vmv.v.i v8, 0
; RV64MV-NEXT:    vmerge.vim v9, v8, -1, v0
; RV64MV-NEXT:    vmv.x.s a1, v9
; RV64MV-NEXT:    andi a1, a1, 2047
; RV64MV-NEXT:    vslidedown.vi v8, v9, 1
; RV64MV-NEXT:    vmv.x.s a2, v8
; RV64MV-NEXT:    andi a2, a2, 2047
; RV64MV-NEXT:    slli a2, a2, 11
; RV64MV-NEXT:    vslidedown.vi v8, v9, 2
