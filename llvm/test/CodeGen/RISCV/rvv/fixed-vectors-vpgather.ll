...
; RV64-NEXT:    vluxei64.v v8, (zero), v10, v0.t
; RV64-NEXT:    ret
...
; RV64-NEXT:    vluxei64.v v8, (zero), v12, v0.t
; RV64-NEXT:    ret
...
; RV64-NEXT:    vslidedown.vi v10, v12, 2
...
; RV32-NEXT:    vslidedown.vi v16, v16, 2
...
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v8, v1, 2
...
; RV32-NEXT:    vmv1r.v v0, v16
; RV32-NEXT:    vluxei32.v v24, (a0), v8, v0.t
...
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    vluxei64.v v24, (a0), v24, v0.t
...
; RV32-NEXT:    vluxei16.v v24, (a0), v8, v0.t
; RV32-NEXT:    addi a2, a1, -16
; RV32-NEXT:    sltu a1, a1, a2
; RV32-NEXT:    addi a1, a1, -1
; RV32-NEXT:    and a1, a1, a2
...
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vmv1r.v v0, v12
; RV32-NEXT:    vluxei16.v v16, (a0), v8, v0.t
; RV32-NEXT:    vmv8r.v v8, v24
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v12
; RV64-NEXT:    vluxei16.v v24, (a0), v8, v0.t
; RV64-NEXT:    addi a2, a1, -16
; RV64-NEXT:    sltu a1, a1, a2
; RV64-NEXT:    addi a1, a1, -1
; RV64-NEXT:    and a1, a1, a2
...
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v12
; RV64-NEXT:    vluxei16.v v16, (a0), v8, v0.t
; RV64-NEXT:    vmv8r.v v8, v24
; RV64-NEXT:    ret
...
; RV64-NEXT:    vluxei32.v v24, (a0), v8, v0.t
; RV64-NEXT:    addi a2, a1, -16
; RV64-NEXT:    sltu a1, a1, a2
; RV64-NEXT:    addi a1, a1, -1
; RV64-NEXT:    and a1, a1, a2
...
; RV64-NEXT:    vslidedown.vi v8, v8, 16
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v16, v16, 2
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v16
...
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v1
; RV64-NEXT:    vluxei64.v v24, (a0), v8, v0.t
; RV64-NEXT:    addi a2, a1, -16
; RV64-NEXT:    sltu a1, a1, a2
; RV64-NEXT:    addi a1, a1, -1
; RV64-NEXT:    and a1, a1, a2
