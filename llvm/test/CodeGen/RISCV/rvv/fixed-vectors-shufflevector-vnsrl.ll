...
; ZVE32F:       # %bb.0: # %entry
; ZVE32F-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; ZVE32F-NEXT:    vle32.v v11, (a0)
; ZVE32F-NEXT:    vsetivli zero, 2, e32, m1, ta, mu
; ZVE32F-NEXT:    vslidedown.vi v10, v11, 2
; ZVE32F-NEXT:    vmv.v.i v9, 2
; ZVE32F-NEXT:    vrgather.vi v8, v11, 1
; ZVE32F-NEXT:    vmv.v.v v0, v9
; ZVE32F-NEXT:    vrgather.vi v8, v10, 1, v0.t
; ZVE32F-NEXT:    vse32.v v8, (a1)
; ZVE32F-NEXT:    ret
entry:
  %0 = load <4 x i32>, ptr %in, align 4
...
; V:       # %bb.0: # %entry
; V-NEXT:    vsetivli zero, 4, e64, m1, ta, ma
; V-NEXT:    vle64.v v11, (a0)
; V-NEXT:    vsetivli zero, 2, e64, m1, ta, mu
; V-NEXT:    vslidedown.vi v10, v11, 2
; V-NEXT:    vmv.v.i v9, 2
; V-NEXT:    vrgather.vi v8, v11, 1
; V-NEXT:    vmv.v.v v0, v9
; V-NEXT:    vrgather.vi v8, v10, 1, v0.t
; V-NEXT:    vse64.v v8, (a1)
; V-NEXT:    ret
;
