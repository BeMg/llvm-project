...
; SPILL-O2-NEXT:    csrr a1, vlenb
; SPILL-O2-NEXT:    add a1, sp, a1
; SPILL-O2-NEXT:    addi a1, a1, 16
...
; SPILL-O2-NEXT:    vfadd.vv v8, v8, v9
...
; SPILL-O2-VLEN128-NEXT:    addi a1, sp, 32
...
; SPILL-O2-VLEN128-NEXT:    vfadd.vv v8, v8, v9
