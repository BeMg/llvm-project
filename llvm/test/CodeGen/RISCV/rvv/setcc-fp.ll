...
; ZVFHMIN-NEXT:    vmfeq.vv v8, v12, v16
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v12, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v8, v16, v12
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v12, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v8, v12, v16
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    ret
  %vc = fcmp one <vscale x 8 x half> %va, %vb
  ret <vscale x 8 x i1> %vc
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v12, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v8, v16, v12
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    ret
  %head = insertelement <vscale x 8 x half> poison, half %b, i32 0
  %splat = shufflevector <vscale x 8 x half> %head, <vscale x 8 x half> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vmv2r.v v12, v10
; ZVFH-NEXT:    vmv2r.v v10, v8
; ZVFH-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vmfeq.vv v9, v12, v12
...
; ZVFH-NEXT:    vmv2r.v v10, v8
; ZVFH-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vmfne.vv v9, v12, v12
; ZVFH-NEXT:    vmfne.vv v8, v10, v10
; ZVFH-NEXT:    vmor.mm v0, v8, v9
; ZVFH-NEXT:    ret
;
...
; CHECK-NEXT:    vmfeq.vv v8, v16, v12
...
; CHECK-NEXT:    vmv4r.v v16, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vmfne.vv v8, v16, v12
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %vc = fcmp one <vscale x 8 x float> %va, %vb
  ret <vscale x 8 x i1> %vc
...
; CHECK-NEXT:    vmv4r.v v12, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vmfeq.vv v9, v16, v16
...
; CHECK-NEXT:    vmfeq.vf v9, v16, fa0
; CHECK-NEXT:    vmfeq.vv v8, v12, v12
; CHECK-NEXT:    vmand.mm v0, v8, v9
; CHECK-NEXT:    ret
  %head = insertelement <vscale x 8 x float> poison, float %b, i32 0
...
; CHECK-NEXT:    vmv4r.v v12, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vmfne.vv v9, v16, v16
...
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfmv.v.f v16, fa0
; CHECK-NEXT:    vmfne.vf v9, v16, fa0
; CHECK-NEXT:    vmfne.vv v8, v12, v12
; CHECK-NEXT:    vmor.mm v0, v8, v9
; CHECK-NEXT:    ret
  %head = insertelement <vscale x 8 x float> poison, float %b, i32 0
...
; CHECK-NEXT:    vmfeq.vv v8, v24, v16
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; CHECK-NEXT:    vmfne.vv v8, v24, v16
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %vc = fcmp one <vscale x 8 x double> %va, %vb
  ret <vscale x 8 x i1> %vc
...
; CHECK-NEXT:    vmv8r.v v16, v8
; CHECK-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; CHECK-NEXT:    vmfne.vf v8, v16, fa0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %splat = shufflevector <vscale x 8 x double> %head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmv8r.v v16, v8
; CHECK-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; CHECK-NEXT:    vmfeq.vv v9, v24, v24
...
; CHECK-NEXT:    vmfeq.vf v9, v24, fa0
; CHECK-NEXT:    vmfeq.vv v8, v16, v16
; CHECK-NEXT:    vmand.mm v0, v8, v9
; CHECK-NEXT:    ret
  %head = insertelement <vscale x 8 x double> poison, double %b, i32 0
...
; CHECK-NEXT:    vmv8r.v v16, v8
; CHECK-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; CHECK-NEXT:    vmfne.vv v9, v24, v24
...
; CHECK-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; CHECK-NEXT:    vfmv.v.f v24, fa0
; CHECK-NEXT:    vmfne.vf v9, v24, fa0
; CHECK-NEXT:    vmfne.vv v8, v16, v16
; CHECK-NEXT:    vmor.mm v0, v8, v9
; CHECK-NEXT:    ret
  %head = insertelement <vscale x 8 x double> poison, double %b, i32 0
...
; ZVFHMIN32-NEXT:    vslideup.vx v8, v9, a0
; ZVFHMIN32-NEXT:    vmv1r.v v0, v8
; ZVFHMIN32-NEXT:    ret
;
; ZVFHMIN64-LABEL: fcmp_oeq_vf_nx16f64:
; ZVFHMIN64:       # %bb.0:
; ZVFHMIN64-NEXT:    vmv8r.v v24, v16
; ZVFHMIN64-NEXT:    vmv8r.v v16, v8
; ZVFHMIN64-NEXT:    fmv.d.x fa5, zero
; ZVFHMIN64-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; ZVFHMIN64-NEXT:    vmfeq.vf v9, v24, fa5
; ZVFHMIN64-NEXT:    vmfeq.vf v8, v16, fa5
...
; ZVFHMIN64-NEXT:    vslideup.vx v8, v9, a0
; ZVFHMIN64-NEXT:    vmv1r.v v0, v8
; ZVFHMIN64-NEXT:    ret
