...
; RV32-NEXT:    vor.vv v11, v8, v10
; RV32-NEXT:    vsll.vx v9, v13, a1
; RV32-NEXT:    vand.vx v8, v13, a3
...
; RV64-NEXT:    li a1, 56
; RV64-NEXT:    vsrl.vx v9, v12, a1
; RV64-NEXT:    li a2, 40
; RV64-NEXT:    vsrl.vx v8, v12, a2
; RV64-NEXT:    lui a3, 16
...
; RV64-NEXT:    vand.vx v8, v12, a5
; RV64-NEXT:    vsll.vi v9, v8, 8
; RV64-NEXT:    vand.vx v8, v12, a4
; RV64-NEXT:    vsll.vi v8, v8, 24
; RV64-NEXT:    vor.vv v10, v8, v9
; RV64-NEXT:    vsll.vx v9, v12, a1
; RV64-NEXT:    vand.vx v8, v12, a3
; RV64-NEXT:    vsll.vx v8, v8, a2
; RV64-NEXT:    vor.vv v8, v9, v8
; RV64-NEXT:    vor.vv v8, v8, v10
; RV64-NEXT:    vor.vv v10, v8, v11
; RV64-NEXT:    vsrl.vi v8, v10, 4
; RV64-NEXT:    lui a1, 61681
...
; LMULMAX2-RV32-NEXT:    vor.vv v12, v8, v10
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v12, 4
; LMULMAX2-RV32-NEXT:    lui a1, 1
; LMULMAX2-RV32-NEXT:    addi a1, a1, -241
; LMULMAX2-RV32-NEXT:    vand.vx v10, v8, a1
; LMULMAX2-RV32-NEXT:    vand.vx v8, v12, a1
; LMULMAX2-RV32-NEXT:    vsll.vi v8, v8, 4
; LMULMAX2-RV32-NEXT:    vor.vv v12, v10, v8
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v12, 2
...
; LMULMAX2-RV32-NEXT:    vor.vv v12, v10, v8
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v12, 1
...
; LMULMAX2-RV64-NEXT:    vor.vv v12, v8, v10
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v12, 4
; LMULMAX2-RV64-NEXT:    lui a1, 1
; LMULMAX2-RV64-NEXT:    addi a1, a1, -241
; LMULMAX2-RV64-NEXT:    vand.vx v10, v8, a1
; LMULMAX2-RV64-NEXT:    vand.vx v8, v12, a1
; LMULMAX2-RV64-NEXT:    vsll.vi v8, v8, 4
; LMULMAX2-RV64-NEXT:    vor.vv v12, v10, v8
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v12, 2
...
; LMULMAX2-RV64-NEXT:    vor.vv v12, v10, v8
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v12, 1
...
; LMULMAX2-RV32-NEXT:    vand.vx v12, v10, a1
...
; LMULMAX2-RV64-NEXT:    vand.vx v12, v10, a1
...
; LMULMAX1-RV32-NEXT:    vle32.v v12, (a0)
; LMULMAX1-RV32-NEXT:    vsrl.vi v9, v8, 8
; LMULMAX1-RV32-NEXT:    lui a2, 16
; LMULMAX1-RV32-NEXT:    addi a2, a2, -256
; LMULMAX1-RV32-NEXT:    vand.vx v10, v9, a2
; LMULMAX1-RV32-NEXT:    vsrl.vi v9, v8, 24
; LMULMAX1-RV32-NEXT:    vor.vv v10, v10, v9
; LMULMAX1-RV32-NEXT:    vand.vx v9, v8, a2
; LMULMAX1-RV32-NEXT:    vsll.vi v9, v9, 8
...
; LMULMAX1-RV32-NEXT:    vadd.vv v8, v8, v8
; LMULMAX1-RV32-NEXT:    vor.vv v11, v9, v8
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v12, 8
; LMULMAX1-RV32-NEXT:    vand.vx v9, v8, a2
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v12, 24
; LMULMAX1-RV32-NEXT:    vor.vv v10, v9, v8
; LMULMAX1-RV32-NEXT:    vand.vx v8, v12, a2
; LMULMAX1-RV32-NEXT:    vsll.vi v9, v8, 8
; LMULMAX1-RV32-NEXT:    vsll.vi v8, v12, 24
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v10
; LMULMAX1-RV32-NEXT:    vsrl.vi v9, v8, 4
; LMULMAX1-RV32-NEXT:    vand.vx v9, v9, a3
...
; LMULMAX1-RV32-NEXT:    vse32.v v11, (a1)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle32.v v12, (a0)
...
; LMULMAX1-RV64-NEXT:    vsrl.vi v9, v8, 24
; LMULMAX1-RV64-NEXT:    vor.vv v10, v10, v9
...
; LMULMAX1-RV64-NEXT:    vadd.vv v8, v8, v8
; LMULMAX1-RV64-NEXT:    vor.vv v11, v9, v8
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v12, 8
; LMULMAX1-RV64-NEXT:    vand.vx v9, v8, a2
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v12, 24
; LMULMAX1-RV64-NEXT:    vor.vv v10, v9, v8
; LMULMAX1-RV64-NEXT:    vand.vx v8, v12, a2
; LMULMAX1-RV64-NEXT:    vsll.vi v9, v8, 8
; LMULMAX1-RV64-NEXT:    vsll.vi v8, v12, 24
; LMULMAX1-RV64-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV64-NEXT:    vor.vv v8, v8, v10
; LMULMAX1-RV64-NEXT:    vsrl.vi v9, v8, 4
; LMULMAX1-RV64-NEXT:    vand.vx v9, v9, a3
...
; LMULMAX1-RV64-NEXT:    vse32.v v11, (a1)
; LMULMAX1-RV64-NEXT:    ret
;
...
; LMULMAX2-RV32-NEXT:    vle64.v v18, (a0)
...
; LMULMAX2-RV32-NEXT:    vsrl.vx v10, v18, a1
; LMULMAX2-RV32-NEXT:    li a2, 40
; LMULMAX2-RV32-NEXT:    vsrl.vx v8, v18, a2
; LMULMAX2-RV32-NEXT:    lui a3, 16
; LMULMAX2-RV32-NEXT:    addi a3, a3, -256
; LMULMAX2-RV32-NEXT:    vand.vx v8, v8, a3
; LMULMAX2-RV32-NEXT:    vor.vv v12, v8, v10
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v18, 24
; LMULMAX2-RV32-NEXT:    addi a4, sp, 8
; LMULMAX2-RV32-NEXT:    vlse64.v v16, (a4), zero
; LMULMAX2-RV32-NEXT:    lui a4, 4080
; LMULMAX2-RV32-NEXT:    vand.vx v10, v8, a4
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v18, 8
; LMULMAX2-RV32-NEXT:    vand.vv v8, v8, v16
; LMULMAX2-RV32-NEXT:    vor.vv v8, v8, v10
; LMULMAX2-RV32-NEXT:    vor.vv v14, v8, v12
; LMULMAX2-RV32-NEXT:    vsll.vx v10, v18, a1
; LMULMAX2-RV32-NEXT:    vand.vx v8, v18, a3
; LMULMAX2-RV32-NEXT:    vsll.vx v8, v8, a2
; LMULMAX2-RV32-NEXT:    vor.vv v12, v10, v8
; LMULMAX2-RV32-NEXT:    vand.vx v8, v18, a4
; LMULMAX2-RV32-NEXT:    vsll.vi v10, v8, 24
; LMULMAX2-RV32-NEXT:    vand.vv v8, v18, v16
; LMULMAX2-RV32-NEXT:    vsll.vi v8, v8, 8
; LMULMAX2-RV32-NEXT:    vor.vv v8, v10, v8
; LMULMAX2-RV32-NEXT:    vor.vv v8, v12, v8
; LMULMAX2-RV32-NEXT:    vor.vv v12, v8, v14
; LMULMAX2-RV32-NEXT:    vsrl.vi v10, v12, 4
; LMULMAX2-RV32-NEXT:    lui a1, 61681
; LMULMAX2-RV32-NEXT:    addi a1, a1, -241
...
; LMULMAX2-RV32-NEXT:    vand.vv v8, v12, v8
; LMULMAX2-RV32-NEXT:    vsll.vi v8, v8, 4
; LMULMAX2-RV32-NEXT:    vor.vv v12, v10, v8
; LMULMAX2-RV32-NEXT:    vsrl.vi v10, v12, 2
; LMULMAX2-RV32-NEXT:    lui a1, 209715
; LMULMAX2-RV32-NEXT:    addi a1, a1, 819
; LMULMAX2-RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.x v8, a1
...
; LMULMAX2-RV32-NEXT:    vsll.vi v8, v8, 2
; LMULMAX2-RV32-NEXT:    vor.vv v12, v10, v8
; LMULMAX2-RV32-NEXT:    vsrl.vi v10, v12, 1
; LMULMAX2-RV32-NEXT:    lui a1, 349525
; LMULMAX2-RV32-NEXT:    addi a1, a1, 1365
; LMULMAX2-RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.x v8, a1
...
; LMULMAX2-RV64-NEXT:    vle64.v v16, (a0)
; LMULMAX2-RV64-NEXT:    li a1, 56
; LMULMAX2-RV64-NEXT:    vsrl.vx v10, v16, a1
; LMULMAX2-RV64-NEXT:    li a2, 40
; LMULMAX2-RV64-NEXT:    vsrl.vx v8, v16, a2
; LMULMAX2-RV64-NEXT:    lui a3, 16
; LMULMAX2-RV64-NEXT:    addiw a3, a3, -256
; LMULMAX2-RV64-NEXT:    vand.vx v8, v8, a3
; LMULMAX2-RV64-NEXT:    vor.vv v12, v8, v10
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v16, 24
; LMULMAX2-RV64-NEXT:    lui a4, 4080
; LMULMAX2-RV64-NEXT:    vand.vx v10, v8, a4
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v16, 8
...
; LMULMAX2-RV64-NEXT:    vor.vv v14, v8, v12
; LMULMAX2-RV64-NEXT:    vand.vx v8, v16, a5
; LMULMAX2-RV64-NEXT:    vsll.vi v10, v8, 8
; LMULMAX2-RV64-NEXT:    vand.vx v8, v16, a4
; LMULMAX2-RV64-NEXT:    vsll.vi v8, v8, 24
; LMULMAX2-RV64-NEXT:    vor.vv v12, v8, v10
; LMULMAX2-RV64-NEXT:    vsll.vx v10, v16, a1
; LMULMAX2-RV64-NEXT:    vand.vx v8, v16, a3
; LMULMAX2-RV64-NEXT:    vsll.vx v8, v8, a2
; LMULMAX2-RV64-NEXT:    vor.vv v8, v10, v8
; LMULMAX2-RV64-NEXT:    vor.vv v8, v8, v12
; LMULMAX2-RV64-NEXT:    vor.vv v12, v8, v14
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v12, 4
; LMULMAX2-RV64-NEXT:    lui a1, 61681
...
; LMULMAX1-RV32-NEXT:    vle64.v v17, (a0)
; LMULMAX1-RV32-NEXT:    addi a1, a0, 16
...
; LMULMAX1-RV32-NEXT:    vsrl.vx v8, v12, a3
; LMULMAX1-RV32-NEXT:    lui a4, 16
; LMULMAX1-RV32-NEXT:    addi a4, a4, -256
; LMULMAX1-RV32-NEXT:    vand.vx v8, v8, a4
; LMULMAX1-RV32-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v12, 24
; LMULMAX1-RV32-NEXT:    addi a5, sp, 8
; LMULMAX1-RV32-NEXT:    vlse64.v v16, (a5), zero
; LMULMAX1-RV32-NEXT:    lui a5, 4080
; LMULMAX1-RV32-NEXT:    vand.vx v9, v8, a5
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v12, 8
; LMULMAX1-RV32-NEXT:    vand.vv v8, v8, v16
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vor.vv v11, v8, v10
; LMULMAX1-RV32-NEXT:    vand.vv v8, v12, v16
; LMULMAX1-RV32-NEXT:    vsll.vi v9, v8, 8
; LMULMAX1-RV32-NEXT:    vand.vx v8, v12, a5
; LMULMAX1-RV32-NEXT:    vsll.vi v8, v8, 24
; LMULMAX1-RV32-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV32-NEXT:    vsll.vx v9, v12, a2
; LMULMAX1-RV32-NEXT:    vand.vx v8, v12, a4
; LMULMAX1-RV32-NEXT:    vsll.vx v8, v8, a3
; LMULMAX1-RV32-NEXT:    vor.vv v8, v9, v8
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v10
; LMULMAX1-RV32-NEXT:    vor.vv v10, v8, v11
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v10, 4
...
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vand.vv v9, v8, v15
; LMULMAX1-RV32-NEXT:    vand.vv v8, v10, v15
; LMULMAX1-RV32-NEXT:    vsll.vi v8, v8, 4
; LMULMAX1-RV32-NEXT:    vor.vv v10, v9, v8
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v10, 2
; LMULMAX1-RV32-NEXT:    lui a6, 209715
; LMULMAX1-RV32-NEXT:    addi a6, a6, 819
; LMULMAX1-RV32-NEXT:    vsetvli a7, zero, e32, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vmv.v.x v14, a6
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vand.vv v9, v8, v14
; LMULMAX1-RV32-NEXT:    vand.vv v8, v10, v14
; LMULMAX1-RV32-NEXT:    vsll.vi v8, v8, 2
; LMULMAX1-RV32-NEXT:    vor.vv v10, v9, v8
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v10, 1
; LMULMAX1-RV32-NEXT:    lui a6, 349525
; LMULMAX1-RV32-NEXT:    addi a6, a6, 1365
; LMULMAX1-RV32-NEXT:    vsetvli a7, zero, e32, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vmv.v.x v13, a6
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vand.vv v9, v8, v13
; LMULMAX1-RV32-NEXT:    vand.vv v8, v10, v13
; LMULMAX1-RV32-NEXT:    vadd.vv v8, v8, v8
; LMULMAX1-RV32-NEXT:    vor.vv v12, v9, v8
; LMULMAX1-RV32-NEXT:    vsrl.vx v9, v17, a2
; LMULMAX1-RV32-NEXT:    vsrl.vx v8, v17, a3
; LMULMAX1-RV32-NEXT:    vand.vx v8, v8, a4
; LMULMAX1-RV32-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v17, 24
; LMULMAX1-RV32-NEXT:    vand.vx v9, v8, a5
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v17, 8
; LMULMAX1-RV32-NEXT:    vand.vv v8, v8, v16
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vor.vv v11, v8, v10
; LMULMAX1-RV32-NEXT:    vsll.vx v9, v17, a2
; LMULMAX1-RV32-NEXT:    vand.vx v8, v17, a4
; LMULMAX1-RV32-NEXT:    vsll.vx v8, v8, a3
; LMULMAX1-RV32-NEXT:    vor.vv v10, v9, v8
; LMULMAX1-RV32-NEXT:    vand.vx v8, v17, a5
; LMULMAX1-RV32-NEXT:    vsll.vi v9, v8, 24
; LMULMAX1-RV32-NEXT:    vand.vv v8, v17, v16
; LMULMAX1-RV32-NEXT:    vsll.vi v8, v8, 8
; LMULMAX1-RV32-NEXT:    vor.vv v8, v9, v8
; LMULMAX1-RV32-NEXT:    vor.vv v8, v10, v8
...
; LMULMAX1-RV32-NEXT:    vsll.vi v8, v8, 2
; LMULMAX1-RV32-NEXT:    vor.vv v9, v9, v8
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v9, 1
...
; LMULMAX1-RV64-NEXT:    addi a1, a0, 16
; LMULMAX1-RV64-NEXT:    vle64.v v12, (a1)
; LMULMAX1-RV64-NEXT:    vle64.v v13, (a0)
; LMULMAX1-RV64-NEXT:    li a2, 56
; LMULMAX1-RV64-NEXT:    vsrl.vx v9, v12, a2
; LMULMAX1-RV64-NEXT:    li a3, 40
; LMULMAX1-RV64-NEXT:    vsrl.vx v8, v12, a3
; LMULMAX1-RV64-NEXT:    lui a4, 16
; LMULMAX1-RV64-NEXT:    addiw a4, a4, -256
; LMULMAX1-RV64-NEXT:    vand.vx v8, v8, a4
; LMULMAX1-RV64-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v12, 24
; LMULMAX1-RV64-NEXT:    lui a5, 4080
; LMULMAX1-RV64-NEXT:    vand.vx v9, v8, a5
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v12, 8
; LMULMAX1-RV64-NEXT:    li a6, 255
; LMULMAX1-RV64-NEXT:    slli a6, a6, 24
; LMULMAX1-RV64-NEXT:    vand.vx v8, v8, a6
; LMULMAX1-RV64-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV64-NEXT:    vor.vv v11, v8, v10
; LMULMAX1-RV64-NEXT:    vand.vx v8, v12, a6
; LMULMAX1-RV64-NEXT:    vsll.vi v9, v8, 8
; LMULMAX1-RV64-NEXT:    vand.vx v8, v12, a5
; LMULMAX1-RV64-NEXT:    vsll.vi v8, v8, 24
; LMULMAX1-RV64-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV64-NEXT:    vsll.vx v9, v12, a2
; LMULMAX1-RV64-NEXT:    vand.vx v8, v12, a4
...
; LMULMAX1-RV64-NEXT:    vadd.vv v8, v8, v8
; LMULMAX1-RV64-NEXT:    vor.vv v12, v9, v8
; LMULMAX1-RV64-NEXT:    vsrl.vx v9, v13, a2
; LMULMAX1-RV64-NEXT:    vsrl.vx v8, v13, a3
; LMULMAX1-RV64-NEXT:    vand.vx v8, v8, a4
; LMULMAX1-RV64-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v13, 24
; LMULMAX1-RV64-NEXT:    vand.vx v9, v8, a5
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v13, 8
; LMULMAX1-RV64-NEXT:    vand.vx v8, v8, a6
; LMULMAX1-RV64-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV64-NEXT:    vor.vv v11, v8, v10
; LMULMAX1-RV64-NEXT:    vand.vx v8, v13, a6
; LMULMAX1-RV64-NEXT:    vsll.vi v9, v8, 8
; LMULMAX1-RV64-NEXT:    vand.vx v8, v13, a5
; LMULMAX1-RV64-NEXT:    vsll.vi v8, v8, 24
; LMULMAX1-RV64-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV64-NEXT:    vsll.vx v9, v13, a2
; LMULMAX1-RV64-NEXT:    vand.vx v8, v13, a4
; LMULMAX1-RV64-NEXT:    vsll.vx v8, v8, a3
; LMULMAX1-RV64-NEXT:    vor.vv v8, v9, v8
; LMULMAX1-RV64-NEXT:    vor.vv v8, v8, v10
; LMULMAX1-RV64-NEXT:    vor.vv v8, v8, v11
...
; LMULMAX1-RV64-NEXT:    vse64.v v12, (a1)
; LMULMAX1-RV64-NEXT:    ret
;
