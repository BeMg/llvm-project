...
; RV32-BITS-UNKNOWN-NEXT:    vrsub.vx v9, v8, a0
; RV32-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v10, v9
...
; RV32-BITS-256-NEXT:    vmerge.vim v10, v8, 1, v0
...
; RV32-BITS-256-NEXT:    vrsub.vx v9, v8, a0
; RV32-BITS-256-NEXT:    vrgather.vv v8, v10, v9
...
; RV32-BITS-512-NEXT:    vmerge.vim v10, v8, 1, v0
...
; RV32-BITS-512-NEXT:    vrsub.vx v9, v8, a0
; RV32-BITS-512-NEXT:    vrgather.vv v8, v10, v9
...
; RV64-BITS-UNKNOWN-NEXT:    vrsub.vx v9, v8, a0
; RV64-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v10, v9
...
; RV64-BITS-256-NEXT:    vmerge.vim v10, v8, 1, v0
...
; RV64-BITS-256-NEXT:    vrsub.vx v9, v8, a0
; RV64-BITS-256-NEXT:    vrgather.vv v8, v10, v9
...
; RV64-BITS-512-NEXT:    vmerge.vim v10, v8, 1, v0
...
; RV64-BITS-512-NEXT:    vrsub.vx v9, v8, a0
; RV64-BITS-512-NEXT:    vrgather.vv v8, v10, v9
...
; RV32-BITS-UNKNOWN-NEXT:    vmv.v.i v8, 0
; RV32-BITS-UNKNOWN-NEXT:    vmerge.vim v9, v8, 1, v0
; RV32-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV32-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
...
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v9, v10
; RV32-BITS-UNKNOWN-NEXT:    vand.vi v8, v8, 1
; RV32-BITS-UNKNOWN-NEXT:    vmsne.vi v0, v8, 0
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-UNKNOWN-NEXT:    vmv.v.i v8, 0
; RV64-BITS-UNKNOWN-NEXT:    vmerge.vim v9, v8, 1, v0
; RV64-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV64-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
...
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v9, v10
; RV64-BITS-UNKNOWN-NEXT:    vand.vi v8, v8, 1
; RV64-BITS-UNKNOWN-NEXT:    vmsne.vi v0, v8, 0
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v10, v12
; RV32-BITS-UNKNOWN-NEXT:    vand.vi v10, v8, 1
; RV32-BITS-UNKNOWN-NEXT:    vmsne.vi v8, v10, 0
; RV32-BITS-UNKNOWN-NEXT:    vmv1r.v v0, v8
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-256-NEXT:    addi a0, a0, -1
; RV32-BITS-256-NEXT:    vid.v v8
; RV32-BITS-256-NEXT:    vrsub.vx v10, v8, a0
; RV32-BITS-256-NEXT:    vrgather.vv v8, v12, v10
; RV32-BITS-256-NEXT:    vand.vi v10, v8, 1
; RV32-BITS-256-NEXT:    vmsne.vi v8, v10, 0
; RV32-BITS-256-NEXT:    vmv1r.v v0, v8
; RV32-BITS-256-NEXT:    ret
;
...
; RV32-BITS-512-NEXT:    addi a0, a0, -1
; RV32-BITS-512-NEXT:    vid.v v8
; RV32-BITS-512-NEXT:    vrsub.vx v10, v8, a0
; RV32-BITS-512-NEXT:    vrgather.vv v8, v12, v10
; RV32-BITS-512-NEXT:    vand.vi v10, v8, 1
; RV32-BITS-512-NEXT:    vmsne.vi v8, v10, 0
; RV32-BITS-512-NEXT:    vmv1r.v v0, v8
; RV32-BITS-512-NEXT:    ret
;
...
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v10, v12
; RV64-BITS-UNKNOWN-NEXT:    vand.vi v10, v8, 1
; RV64-BITS-UNKNOWN-NEXT:    vmsne.vi v8, v10, 0
; RV64-BITS-UNKNOWN-NEXT:    vmv1r.v v0, v8
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-256-NEXT:    addi a0, a0, -1
; RV64-BITS-256-NEXT:    vid.v v8
; RV64-BITS-256-NEXT:    vrsub.vx v10, v8, a0
; RV64-BITS-256-NEXT:    vrgather.vv v8, v12, v10
; RV64-BITS-256-NEXT:    vand.vi v10, v8, 1
; RV64-BITS-256-NEXT:    vmsne.vi v8, v10, 0
; RV64-BITS-256-NEXT:    vmv1r.v v0, v8
; RV64-BITS-256-NEXT:    ret
;
...
; RV64-BITS-512-NEXT:    addi a0, a0, -1
; RV64-BITS-512-NEXT:    vid.v v8
; RV64-BITS-512-NEXT:    vrsub.vx v10, v8, a0
; RV64-BITS-512-NEXT:    vrgather.vv v8, v12, v10
; RV64-BITS-512-NEXT:    vand.vi v10, v8, 1
; RV64-BITS-512-NEXT:    vmsne.vi v8, v10, 0
; RV64-BITS-512-NEXT:    vmv1r.v v0, v8
; RV64-BITS-512-NEXT:    ret
...
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v12, v16
; RV32-BITS-UNKNOWN-NEXT:    vand.vi v12, v8, 1
; RV32-BITS-UNKNOWN-NEXT:    vmsne.vi v8, v12, 0
; RV32-BITS-UNKNOWN-NEXT:    vmv1r.v v0, v8
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-256-NEXT:    vrgather.vv v8, v16, v12
; RV32-BITS-256-NEXT:    vand.vi v12, v8, 1
; RV32-BITS-256-NEXT:    vmsne.vi v8, v12, 0
; RV32-BITS-256-NEXT:    vmv1r.v v0, v8
; RV32-BITS-256-NEXT:    ret
;
...
; RV32-BITS-512-NEXT:    vrgather.vv v8, v16, v12
; RV32-BITS-512-NEXT:    vand.vi v12, v8, 1
; RV32-BITS-512-NEXT:    vmsne.vi v8, v12, 0
; RV32-BITS-512-NEXT:    vmv1r.v v0, v8
; RV32-BITS-512-NEXT:    ret
;
...
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v12, v16
; RV64-BITS-UNKNOWN-NEXT:    vand.vi v12, v8, 1
; RV64-BITS-UNKNOWN-NEXT:    vmsne.vi v8, v12, 0
; RV64-BITS-UNKNOWN-NEXT:    vmv1r.v v0, v8
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-256-NEXT:    vrgather.vv v8, v16, v12
; RV64-BITS-256-NEXT:    vand.vi v12, v8, 1
; RV64-BITS-256-NEXT:    vmsne.vi v8, v12, 0
; RV64-BITS-256-NEXT:    vmv1r.v v0, v8
; RV64-BITS-256-NEXT:    ret
;
...
; RV64-BITS-512-NEXT:    vrgather.vv v8, v16, v12
; RV64-BITS-512-NEXT:    vand.vi v12, v8, 1
; RV64-BITS-512-NEXT:    vmsne.vi v8, v12, 0
; RV64-BITS-512-NEXT:    vmv1r.v v0, v8
; RV64-BITS-512-NEXT:    ret
...
; RV32-BITS-UNKNOWN-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v12, v16, v24
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v20, v24
; RV32-BITS-UNKNOWN-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; RV32-BITS-UNKNOWN-NEXT:    vand.vi v16, v8, 1
; RV32-BITS-UNKNOWN-NEXT:    vmsne.vi v8, v16, 0
; RV32-BITS-UNKNOWN-NEXT:    vmv1r.v v0, v8
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-256-NEXT:    vmv.v.i v8, 0
; RV32-BITS-256-NEXT:    vmerge.vim v24, v8, 1, v0
; RV32-BITS-256-NEXT:    csrr a0, vlenb
; RV32-BITS-256-NEXT:    slli a0, a0, 3
; RV32-BITS-256-NEXT:    addi a0, a0, -1
; RV32-BITS-256-NEXT:    vid.v v8
; RV32-BITS-256-NEXT:    vrsub.vx v16, v8, a0
; RV32-BITS-256-NEXT:    vrgather.vv v8, v24, v16
; RV32-BITS-256-NEXT:    vand.vi v16, v8, 1
; RV32-BITS-256-NEXT:    vmsne.vi v8, v16, 0
; RV32-BITS-256-NEXT:    vmv1r.v v0, v8
; RV32-BITS-256-NEXT:    ret
;
...
; RV32-BITS-512-NEXT:    vmerge.vim v16, v8, 1, v0
; RV32-BITS-512-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; RV32-BITS-512-NEXT:    vrgather.vv v12, v16, v24
; RV32-BITS-512-NEXT:    vrgather.vv v8, v20, v24
; RV32-BITS-512-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; RV32-BITS-512-NEXT:    vand.vi v16, v8, 1
; RV32-BITS-512-NEXT:    vmsne.vi v8, v16, 0
; RV32-BITS-512-NEXT:    vmv1r.v v0, v8
; RV32-BITS-512-NEXT:    ret
;
...
; RV64-BITS-UNKNOWN-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v12, v16, v24
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v20, v24
; RV64-BITS-UNKNOWN-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vand.vi v16, v8, 1
; RV64-BITS-UNKNOWN-NEXT:    vmsne.vi v8, v16, 0
; RV64-BITS-UNKNOWN-NEXT:    vmv1r.v v0, v8
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-256-NEXT:    vmv.v.i v8, 0
; RV64-BITS-256-NEXT:    vmerge.vim v24, v8, 1, v0
; RV64-BITS-256-NEXT:    csrr a0, vlenb
; RV64-BITS-256-NEXT:    slli a0, a0, 3
; RV64-BITS-256-NEXT:    addi a0, a0, -1
; RV64-BITS-256-NEXT:    vid.v v8
; RV64-BITS-256-NEXT:    vrsub.vx v16, v8, a0
; RV64-BITS-256-NEXT:    vrgather.vv v8, v24, v16
; RV64-BITS-256-NEXT:    vand.vi v16, v8, 1
; RV64-BITS-256-NEXT:    vmsne.vi v8, v16, 0
; RV64-BITS-256-NEXT:    vmv1r.v v0, v8
; RV64-BITS-256-NEXT:    ret
;
...
; RV64-BITS-512-NEXT:    vmerge.vim v16, v8, 1, v0
; RV64-BITS-512-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; RV64-BITS-512-NEXT:    vrgather.vv v12, v16, v24
; RV64-BITS-512-NEXT:    vrgather.vv v8, v20, v24
; RV64-BITS-512-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; RV64-BITS-512-NEXT:    vand.vi v16, v8, 1
; RV64-BITS-512-NEXT:    vmsne.vi v8, v16, 0
; RV64-BITS-512-NEXT:    vmv1r.v v0, v8
; RV64-BITS-512-NEXT:    ret
...
; RV32-BITS-UNKNOWN:       # %bb.0:
; RV32-BITS-UNKNOWN-NEXT:    vmv1r.v v10, v8
; RV32-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
...
; RV32-BITS-256:       # %bb.0:
; RV32-BITS-256-NEXT:    vmv1r.v v10, v8
; RV32-BITS-256-NEXT:    csrr a0, vlenb
...
; RV32-BITS-512:       # %bb.0:
; RV32-BITS-512-NEXT:    vmv1r.v v10, v8
; RV32-BITS-512-NEXT:    csrr a0, vlenb
...
; RV64-BITS-UNKNOWN:       # %bb.0:
; RV64-BITS-UNKNOWN-NEXT:    vmv1r.v v10, v8
; RV64-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
...
; RV64-BITS-256:       # %bb.0:
; RV64-BITS-256-NEXT:    vmv1r.v v10, v8
; RV64-BITS-256-NEXT:    csrr a0, vlenb
...
; RV64-BITS-512:       # %bb.0:
; RV64-BITS-512-NEXT:    vmv1r.v v10, v8
; RV64-BITS-512-NEXT:    csrr a0, vlenb
...
; RV32-BITS-UNKNOWN:       # %bb.0:
; RV32-BITS-UNKNOWN-NEXT:    vmv1r.v v9, v8
; RV32-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV32-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
...
; RV64-BITS-UNKNOWN:       # %bb.0:
; RV64-BITS-UNKNOWN-NEXT:    vmv1r.v v9, v8
; RV64-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV64-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
...
; RV32-BITS-UNKNOWN:       # %bb.0:
; RV32-BITS-UNKNOWN-NEXT:    vmv2r.v v10, v8
; RV32-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV32-BITS-UNKNOWN-NEXT:    slli a0, a0, 1
; RV32-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
...
; RV32-BITS-256:       # %bb.0:
; RV32-BITS-256-NEXT:    vmv2r.v v12, v8
; RV32-BITS-256-NEXT:    csrr a0, vlenb
; RV32-BITS-256-NEXT:    slli a0, a0, 1
; RV32-BITS-256-NEXT:    addi a0, a0, -1
...
; RV32-BITS-512:       # %bb.0:
; RV32-BITS-512-NEXT:    vmv2r.v v12, v8
; RV32-BITS-512-NEXT:    csrr a0, vlenb
; RV32-BITS-512-NEXT:    slli a0, a0, 1
; RV32-BITS-512-NEXT:    addi a0, a0, -1
...
; RV64-BITS-UNKNOWN:       # %bb.0:
; RV64-BITS-UNKNOWN-NEXT:    vmv2r.v v10, v8
; RV64-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV64-BITS-UNKNOWN-NEXT:    slli a0, a0, 1
; RV64-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
...
; RV64-BITS-256:       # %bb.0:
; RV64-BITS-256-NEXT:    vmv2r.v v12, v8
; RV64-BITS-256-NEXT:    csrr a0, vlenb
; RV64-BITS-256-NEXT:    slli a0, a0, 1
; RV64-BITS-256-NEXT:    addi a0, a0, -1
...
; RV64-BITS-512:       # %bb.0:
; RV64-BITS-512-NEXT:    vmv2r.v v12, v8
; RV64-BITS-512-NEXT:    csrr a0, vlenb
; RV64-BITS-512-NEXT:    slli a0, a0, 1
; RV64-BITS-512-NEXT:    addi a0, a0, -1
...
; RV32-BITS-UNKNOWN:       # %bb.0:
; RV32-BITS-UNKNOWN-NEXT:    vmv4r.v v12, v8
; RV32-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV32-BITS-UNKNOWN-NEXT:    slli a0, a0, 2
; RV32-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
; RV32-BITS-UNKNOWN-NEXT:    vsetvli a1, zero, e16, m8, ta, ma
...
; RV32-BITS-256:       # %bb.0:
; RV32-BITS-256-NEXT:    vmv4r.v v16, v8
; RV32-BITS-256-NEXT:    csrr a0, vlenb
; RV32-BITS-256-NEXT:    slli a0, a0, 2
; RV32-BITS-256-NEXT:    addi a0, a0, -1
...
; RV32-BITS-512:       # %bb.0:
; RV32-BITS-512-NEXT:    vmv4r.v v16, v8
; RV32-BITS-512-NEXT:    csrr a0, vlenb
; RV32-BITS-512-NEXT:    slli a0, a0, 2
; RV32-BITS-512-NEXT:    addi a0, a0, -1
; RV32-BITS-512-NEXT:    vsetvli a1, zero, e8, m4, ta, ma
...
; RV64-BITS-UNKNOWN:       # %bb.0:
; RV64-BITS-UNKNOWN-NEXT:    vmv4r.v v12, v8
; RV64-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV64-BITS-UNKNOWN-NEXT:    slli a0, a0, 2
; RV64-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
; RV64-BITS-UNKNOWN-NEXT:    vsetvli a1, zero, e16, m8, ta, ma
...
; RV64-BITS-256:       # %bb.0:
; RV64-BITS-256-NEXT:    vmv4r.v v16, v8
; RV64-BITS-256-NEXT:    csrr a0, vlenb
; RV64-BITS-256-NEXT:    slli a0, a0, 2
; RV64-BITS-256-NEXT:    addi a0, a0, -1
...
; RV64-BITS-512:       # %bb.0:
; RV64-BITS-512-NEXT:    vmv4r.v v16, v8
; RV64-BITS-512-NEXT:    csrr a0, vlenb
; RV64-BITS-512-NEXT:    slli a0, a0, 2
; RV64-BITS-512-NEXT:    addi a0, a0, -1
; RV64-BITS-512-NEXT:    vsetvli a1, zero, e8, m4, ta, ma
...
; RV32-BITS-UNKNOWN:       # %bb.0:
; RV32-BITS-UNKNOWN-NEXT:    vmv8r.v v24, v8
; RV32-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV32-BITS-UNKNOWN-NEXT:    slli a0, a0, 2
; RV32-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
; RV32-BITS-UNKNOWN-NEXT:    vsetvli a1, zero, e16, m8, ta, ma
...
; RV32-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e8, m4, ta, ma
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v12, v24, v16
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v28, v16
; RV32-BITS-UNKNOWN-NEXT:    ret
;
; RV32-BITS-256-LABEL: reverse_nxv64i8:
; RV32-BITS-256:       # %bb.0:
; RV32-BITS-256-NEXT:    vmv8r.v v24, v8
; RV32-BITS-256-NEXT:    csrr a0, vlenb
; RV32-BITS-256-NEXT:    slli a0, a0, 3
; RV32-BITS-256-NEXT:    addi a0, a0, -1
...
; RV32-BITS-512:       # %bb.0:
; RV32-BITS-512-NEXT:    vmv8r.v v24, v8
; RV32-BITS-512-NEXT:    csrr a0, vlenb
; RV32-BITS-512-NEXT:    slli a0, a0, 2
; RV32-BITS-512-NEXT:    addi a0, a0, -1
; RV32-BITS-512-NEXT:    vsetvli a1, zero, e8, m4, ta, ma
...
; RV32-BITS-512-NEXT:    vrgather.vv v12, v24, v16
; RV32-BITS-512-NEXT:    vrgather.vv v8, v28, v16
; RV32-BITS-512-NEXT:    ret
;
; RV64-BITS-UNKNOWN-LABEL: reverse_nxv64i8:
; RV64-BITS-UNKNOWN:       # %bb.0:
; RV64-BITS-UNKNOWN-NEXT:    vmv8r.v v24, v8
; RV64-BITS-UNKNOWN-NEXT:    csrr a0, vlenb
; RV64-BITS-UNKNOWN-NEXT:    slli a0, a0, 2
; RV64-BITS-UNKNOWN-NEXT:    addi a0, a0, -1
; RV64-BITS-UNKNOWN-NEXT:    vsetvli a1, zero, e16, m8, ta, ma
...
; RV64-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e8, m4, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v12, v24, v16
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v28, v16
; RV64-BITS-UNKNOWN-NEXT:    ret
;
; RV64-BITS-256-LABEL: reverse_nxv64i8:
; RV64-BITS-256:       # %bb.0:
; RV64-BITS-256-NEXT:    vmv8r.v v24, v8
; RV64-BITS-256-NEXT:    csrr a0, vlenb
; RV64-BITS-256-NEXT:    slli a0, a0, 3
; RV64-BITS-256-NEXT:    addi a0, a0, -1
...
; RV64-BITS-512:       # %bb.0:
; RV64-BITS-512-NEXT:    vmv8r.v v24, v8
; RV64-BITS-512-NEXT:    csrr a0, vlenb
; RV64-BITS-512-NEXT:    slli a0, a0, 2
; RV64-BITS-512-NEXT:    addi a0, a0, -1
; RV64-BITS-512-NEXT:    vsetvli a1, zero, e8, m4, ta, ma
...
; RV64-BITS-512-NEXT:    vrgather.vv v12, v24, v16
; RV64-BITS-512-NEXT:    vrgather.vv v8, v28, v16
; RV64-BITS-512-NEXT:    ret
...
; CHECK-NEXT:    vrgather.vv v12, v16, v8
