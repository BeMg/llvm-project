...
; LMULMAX2-RV32-NEXT:    vle64.v v9, (a0)
...
; LMULMAX2-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v9, 1
; LMULMAX2-RV32-NEXT:    vand.vv v8, v8, v10
; LMULMAX2-RV32-NEXT:    vsub.vv v8, v9, v8
...
; LMULMAX2-RV32-NEXT:    vand.vv v8, v8, v10
; LMULMAX2-RV32-NEXT:    vadd.vv v9, v9, v8
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v9, 4
; LMULMAX2-RV32-NEXT:    vadd.vv v9, v9, v8
...
; LMULMAX2-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX2-RV32-NEXT:    vand.vv v9, v9, v8
; LMULMAX2-RV32-NEXT:    lui a1, 4112
; LMULMAX2-RV32-NEXT:    addi a1, a1, 257
; LMULMAX2-RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.x v8, a1
; LMULMAX2-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX2-RV32-NEXT:    vmul.vv v8, v9, v8
...
; LMULMAX2-RV64-NEXT:    vle64.v v9, (a0)
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v9, 1
...
; LMULMAX2-RV64-NEXT:    vsub.vv v8, v9, v8
...
; LMULMAX2-RV64-NEXT:    vand.vx v8, v8, a1
; LMULMAX2-RV64-NEXT:    vadd.vv v9, v9, v8
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v9, 4
...
; LMULMAX1-RV32-NEXT:    vsub.vv v8, v9, v8
...
; LMULMAX1-RV32-NEXT:    vand.vv v8, v8, v10
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v9, v8
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v9, 4
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v9, v8
...
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vand.vv v9, v9, v8
; LMULMAX1-RV32-NEXT:    lui a1, 4112
; LMULMAX1-RV32-NEXT:    addi a1, a1, 257
; LMULMAX1-RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vmv.v.x v8, a1
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vmul.vv v8, v9, v8
...
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v9, 1
...
; LMULMAX1-RV64-NEXT:    vsub.vv v8, v9, v8
...
; LMULMAX1-RV64-NEXT:    vand.vx v8, v8, a1
; LMULMAX1-RV64-NEXT:    vadd.vv v9, v9, v8
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v9, 4
...
; LMULMAX1-NEXT:    vmul.vx v8, v8, a5
; LMULMAX1-NEXT:    vsrl.vi v9, v8, 24
; LMULMAX1-NEXT:    vsrl.vi v8, v10, 1
; LMULMAX1-NEXT:    vand.vx v8, v8, a2
; LMULMAX1-NEXT:    vsub.vv v8, v10, v8
; LMULMAX1-NEXT:    vand.vx v10, v8, a3
...
; LMULMAX2-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-NEXT:    vle32.v v10, (a0)
; LMULMAX2-NEXT:    vadd.vi v8, v10, -1
; LMULMAX2-NEXT:    vand.vv v10, v10, v8
; LMULMAX2-NEXT:    vmseq.vi v8, v10, 0
...
; LMULMAX1-NEXT:    vle32.v v10, (a0)
; LMULMAX1-NEXT:    vadd.vi v8, v9, -1
; LMULMAX1-NEXT:    vand.vv v8, v9, v8
...
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vadd.vi v9, v10, -1
; LMULMAX1-NEXT:    vand.vv v9, v10, v9
...
; ZVBB-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; ZVBB-NEXT:    vle32.v v8, (a0)
; ZVBB-NEXT:    vcpop.v v10, v8
; ZVBB-NEXT:    vmsleu.vi v8, v10, 1
...
; LMULMAX2-NEXT:    vadd.vi v8, v10, -1
; LMULMAX2-NEXT:    vand.vv v10, v10, v8
; LMULMAX2-NEXT:    vmsne.vi v8, v10, 0
; LMULMAX2-NEXT:    vmv1r.v v0, v8
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX2-NEXT:    vxor.vv v10, v8, v12
; LMULMAX2-NEXT:    vmsltu.vv v8, v12, v10
; LMULMAX2-NEXT:    vmv1r.v v0, v8
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX2-NEXT:    vadd.vi v12, v8, -1
; LMULMAX2-NEXT:    vxor.vv v10, v8, v12
; LMULMAX2-NEXT:    vmsleu.vv v8, v10, v12
; LMULMAX2-NEXT:    vmv1r.v v0, v8
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v10, 1
; LMULMAX2-RV32-NEXT:    vand.vv v8, v8, v12
; LMULMAX2-RV32-NEXT:    vsub.vv v8, v10, v8
; LMULMAX2-RV32-NEXT:    lui a1, 209715
; LMULMAX2-RV32-NEXT:    addi a1, a1, 819
; LMULMAX2-RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.x v12, a1
...
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v8, 2
; LMULMAX2-RV32-NEXT:    vand.vv v8, v8, v12
; LMULMAX2-RV32-NEXT:    vadd.vv v10, v10, v8
; LMULMAX2-RV32-NEXT:    vsrl.vi v8, v10, 4
; LMULMAX2-RV32-NEXT:    vadd.vv v10, v10, v8
; LMULMAX2-RV32-NEXT:    lui a1, 61681
; LMULMAX2-RV32-NEXT:    addi a1, a1, -241
; LMULMAX2-RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
...
; LMULMAX2-RV32-NEXT:    vmv.v.x v8, a1
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmul.vv v8, v10, v8
; LMULMAX2-RV32-NEXT:    li a1, 56
; LMULMAX2-RV32-NEXT:    vsrl.vx v8, v8, a1
; LMULMAX2-RV32-NEXT:    vse64.v v8, (a0)
; LMULMAX2-RV32-NEXT:    ret
...
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v10, 1
; LMULMAX2-RV64-NEXT:    lui a1, 349525
; LMULMAX2-RV64-NEXT:    addiw a1, a1, 1365
; LMULMAX2-RV64-NEXT:    slli a2, a1, 32
; LMULMAX2-RV64-NEXT:    add a1, a1, a2
; LMULMAX2-RV64-NEXT:    vand.vx v8, v8, a1
; LMULMAX2-RV64-NEXT:    vsub.vv v8, v10, v8
; LMULMAX2-RV64-NEXT:    lui a1, 209715
; LMULMAX2-RV64-NEXT:    addiw a1, a1, 819
; LMULMAX2-RV64-NEXT:    slli a2, a1, 32
; LMULMAX2-RV64-NEXT:    add a1, a1, a2
...
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v8, 2
; LMULMAX2-RV64-NEXT:    vand.vx v8, v8, a1
; LMULMAX2-RV64-NEXT:    vadd.vv v10, v10, v8
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v10, 4
...
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v15, 1
; LMULMAX1-RV32-NEXT:    vand.vv v8, v8, v14
; LMULMAX1-RV32-NEXT:    vsub.vv v8, v15, v8
; LMULMAX1-RV32-NEXT:    vand.vv v9, v8, v13
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v8, 2
; LMULMAX1-RV32-NEXT:    vand.vv v8, v8, v13
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v9, v8
...
; LMULMAX1-RV64-NEXT:    vle64.v v10, (a0)
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v9, 1
...
; LMULMAX1-RV64-NEXT:    vand.vx v9, v8, a3
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v8, 2
...
; LMULMAX1-RV64-NEXT:    vsrl.vx v9, v8, a6
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v10, 1
; LMULMAX1-RV64-NEXT:    vand.vx v8, v8, a2
; LMULMAX1-RV64-NEXT:    vsub.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vand.vx v10, v8, a3
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v8, 2
; LMULMAX1-RV64-NEXT:    vand.vx v8, v8, a3
; LMULMAX1-RV64-NEXT:    vadd.vv v10, v10, v8
; LMULMAX1-RV64-NEXT:    vsrl.vi v8, v10, 4
...
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vadd.vv v8, v9, v11
; LMULMAX1-RV32-NEXT:    vand.vv v8, v9, v8
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
...
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v12, v11
; LMULMAX1-RV32-NEXT:    vand.vv v9, v12, v9
...
; LMULMAX1-RV64-NEXT:    vle64.v v10, (a0)
; LMULMAX1-RV64-NEXT:    vadd.vi v8, v9, -1
; LMULMAX1-RV64-NEXT:    vand.vv v8, v9, v8
...
; LMULMAX1-RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV64-NEXT:    vadd.vi v9, v10, -1
...
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v8, v10
; LMULMAX1-RV32-NEXT:    vxor.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vmsltu.vv v0, v9, v8
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; LMULMAX1-RV32-NEXT:    vmv.v.i v8, 0
; LMULMAX1-RV32-NEXT:    vmerge.vim v8, v8, 1, v0
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v11, v10
; LMULMAX1-RV32-NEXT:    vxor.vv v10, v11, v9
; LMULMAX1-RV32-NEXT:    vmsltu.vv v0, v9, v10
; LMULMAX1-RV32-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; LMULMAX1-RV32-NEXT:    vmv.v.i v9, 0
; LMULMAX1-RV32-NEXT:    vmerge.vim v9, v9, 1, v0
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
...
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v8, v10
; LMULMAX1-RV32-NEXT:    vxor.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vmsleu.vv v0, v8, v9
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; LMULMAX1-RV32-NEXT:    vmv.v.i v8, 0
; LMULMAX1-RV32-NEXT:    vmerge.vim v8, v8, 1, v0
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v11, v10
; LMULMAX1-RV32-NEXT:    vxor.vv v10, v11, v9
; LMULMAX1-RV32-NEXT:    vmsleu.vv v0, v10, v9
; LMULMAX1-RV32-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; LMULMAX1-RV32-NEXT:    vmv.v.i v9, 0
; LMULMAX1-RV32-NEXT:    vmerge.vim v9, v9, 1, v0
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
