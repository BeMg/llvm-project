...
; RV32-NEXT:    vand.vx v9, v8, a3
; RV32-NEXT:    vsrl.vi v8, v13, 8
; RV32-NEXT:    vand.vv v8, v8, v12
; RV32-NEXT:    vor.vv v8, v8, v9
; RV32-NEXT:    vor.vv v11, v8, v10
; RV32-NEXT:    vsll.vx v9, v13, a0
; RV32-NEXT:    vand.vx v8, v13, a2
...
; RV64-NEXT:    vsll.vx v9, v12, a0
; RV64-NEXT:    vand.vx v8, v12, a2
...
; RV32-NEXT:    vor.vv v14, v8, v12
; RV32-NEXT:    vsll.vx v10, v18, a0
; RV32-NEXT:    vand.vx v8, v18, a2
; RV32-NEXT:    vsll.vx v8, v8, a1
; RV32-NEXT:    vor.vv v12, v10, v8
; RV32-NEXT:    vand.vx v8, v18, a3
; RV32-NEXT:    vsll.vi v10, v8, 24
; RV32-NEXT:    vand.vv v8, v18, v16
; RV32-NEXT:    vsll.vi v8, v8, 8
; RV32-NEXT:    vor.vv v8, v10, v8
; RV32-NEXT:    vor.vv v8, v12, v8
; RV32-NEXT:    vor.vv v12, v8, v14
...
; RV64-NEXT:    vand.vx v8, v16, a4
; RV64-NEXT:    vsll.vi v8, v8, 8
; RV64-NEXT:    vor.vv v12, v10, v8
; RV64-NEXT:    vsll.vx v10, v16, a0
; RV64-NEXT:    vand.vx v8, v16, a2
; RV64-NEXT:    vsll.vx v8, v8, a1
; RV64-NEXT:    vor.vv v8, v10, v8
; RV64-NEXT:    vor.vv v8, v8, v12
; RV64-NEXT:    vor.vv v12, v8, v14
...
; RV32-NEXT:    vor.vv v20, v8, v16
; RV32-NEXT:    vsll.vx v12, v28, a0
; RV32-NEXT:    vand.vx v8, v28, a2
; RV32-NEXT:    vsll.vx v8, v8, a1
; RV32-NEXT:    vor.vv v16, v12, v8
; RV32-NEXT:    vand.vx v8, v28, a3
; RV32-NEXT:    vsll.vi v12, v8, 24
; RV32-NEXT:    vand.vv v8, v28, v24
; RV32-NEXT:    vsll.vi v8, v8, 8
; RV32-NEXT:    vor.vv v8, v12, v8
; RV32-NEXT:    vor.vv v8, v16, v8
; RV32-NEXT:    vor.vv v16, v8, v20
...
; RV64-NEXT:    vand.vx v8, v24, a4
; RV64-NEXT:    vsll.vi v8, v8, 8
; RV64-NEXT:    vor.vv v16, v12, v8
; RV64-NEXT:    vsll.vx v12, v24, a0
; RV64-NEXT:    vand.vx v8, v24, a2
; RV64-NEXT:    vsll.vx v8, v8, a1
; RV64-NEXT:    vor.vv v8, v12, v8
; RV64-NEXT:    vor.vv v8, v8, v16
; RV64-NEXT:    vor.vv v16, v8, v20
...
; RV32-NEXT:    vand.vx v8, v0, a2
; RV32-NEXT:    vsll.vx v8, v8, a1
; RV32-NEXT:    vsll.vx v16, v0, a0
; RV32-NEXT:    vor.vv v8, v16, v8
