...
; CHECK-NEXT:    vsll.vi v9, v8, 1, v0.t
; CHECK-NEXT:    vnot.v v8, v10, v0.t
; CHECK-NEXT:    vand.vi v8, v8, 7, v0.t
; CHECK-NEXT:    vsll.vv v8, v9, v8, v0.t
; CHECK-NEXT:    vand.vi v9, v10, 7, v0.t
; CHECK-NEXT:    vsrl.vv v9, v12, v9, v0.t
...
; CHECK-NEXT:    vnot.v v8, v10, v0.t
; CHECK-NEXT:    vand.vi v8, v8, 7, v0.t
; CHECK-NEXT:    vsrl.vv v8, v9, v8, v0.t
; CHECK-NEXT:    vand.vi v9, v10, 7, v0.t
; CHECK-NEXT:    vsll.vv v9, v12, v9, v0.t
...
; CHECK-NEXT:    vsll.vi v10, v8, 1, v0.t
; CHECK-NEXT:    vnot.v v8, v12, v0.t
; CHECK-NEXT:    vand.vi v8, v8, 7, v0.t
; CHECK-NEXT:    vsll.vv v8, v10, v8, v0.t
; CHECK-NEXT:    vand.vi v10, v12, 7, v0.t
; CHECK-NEXT:    vsrl.vv v10, v16, v10, v0.t
...
; CHECK-NEXT:    vnot.v v8, v12, v0.t
; CHECK-NEXT:    vand.vi v8, v8, 7, v0.t
; CHECK-NEXT:    vsrl.vv v8, v10, v8, v0.t
; CHECK-NEXT:    vand.vi v10, v12, 7, v0.t
; CHECK-NEXT:    vsll.vv v10, v16, v10, v0.t
...
; CHECK-NEXT:    vsll.vi v12, v8, 1, v0.t
; CHECK-NEXT:    vnot.v v8, v16, v0.t
; CHECK-NEXT:    vand.vi v8, v8, 7, v0.t
; CHECK-NEXT:    vsll.vv v8, v12, v8, v0.t
; CHECK-NEXT:    vand.vi v12, v16, 7, v0.t
; CHECK-NEXT:    vsrl.vv v12, v20, v12, v0.t
...
; CHECK-NEXT:    vand.vi v12, v16, 7, v0.t
; CHECK-NEXT:    vsll.vv v12, v20, v12, v0.t
...
; CHECK-NEXT:    vsll.vv v8, v9, v8, v0.t
; CHECK-NEXT:    vand.vi v9, v10, 15, v0.t
; CHECK-NEXT:    vsrl.vv v9, v12, v9, v0.t
; CHECK-NEXT:    vor.vv v8, v8, v9, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vand.vi v8, v8, 15, v0.t
; CHECK-NEXT:    vsll.vv v8, v10, v8, v0.t
; CHECK-NEXT:    vand.vi v10, v12, 15, v0.t
; CHECK-NEXT:    vsrl.vv v10, v16, v10, v0.t
; CHECK-NEXT:    vor.vv v8, v8, v10, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vand.vx v8, v10, a1, v0.t
; CHECK-NEXT:    vsrl.vv v10, v9, v8, v0.t
; CHECK-NEXT:    vnot.v v8, v12, v0.t
; CHECK-NEXT:    vand.vx v9, v8, a1, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
; CHECK-NEXT:    vand.vx v8, v10, a1, v0.t
; CHECK-NEXT:    vsll.vv v10, v9, v8, v0.t
; CHECK-NEXT:    vnot.v v8, v12, v0.t
; CHECK-NEXT:    vand.vx v9, v8, a1, v0.t
; CHECK-NEXT:    vsrl.vi v8, v13, 1, v0.t
...
; CHECK-NEXT:    vand.vx v8, v12, a1, v0.t
; CHECK-NEXT:    vsrl.vv v12, v10, v8, v0.t
; CHECK-NEXT:    vnot.v v8, v16, v0.t
; CHECK-NEXT:    vand.vx v10, v8, a1, v0.t
; CHECK-NEXT:    vsll.vi v8, v18, 1, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m2, ta, ma
; CHECK-NEXT:    vand.vx v8, v12, a1, v0.t
; CHECK-NEXT:    vsll.vv v12, v10, v8, v0.t
; CHECK-NEXT:    vnot.v v8, v16, v0.t
; CHECK-NEXT:    vand.vx v10, v8, a1, v0.t
; CHECK-NEXT:    vsrl.vi v8, v18, 1, v0.t
...
; CHECK-NEXT:    vsrl.vv v16, v12, v8, v0.t
; CHECK-NEXT:    vnot.v v8, v24, v0.t
; CHECK-NEXT:    vand.vx v12, v8, a1, v0.t
; CHECK-NEXT:    vsll.vi v8, v28, 1, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; CHECK-NEXT:    vand.vx v8, v16, a1, v0.t
; CHECK-NEXT:    vsll.vv v16, v12, v8, v0.t
; CHECK-NEXT:    vnot.v v8, v28, v0.t
; CHECK-NEXT:    vand.vx v12, v8, a1, v0.t
...
; CHECK-NEXT:    vsrl.vv v10, v10, v9, v0.t
; CHECK-NEXT:    vsll.vi v9, v12, 1, v0.t
; CHECK-NEXT:    vnot.v v8, v8, v0.t
; CHECK-NEXT:    vand.vi v8, v8, 15, v0.t
; CHECK-NEXT:    vsll.vv v8, v9, v8, v0.t
; CHECK-NEXT:    vor.vv v8, v8, v10, v0.t
...
; CHECK-NEXT:    vsrl.vi v10, v9, 1, v0.t
; CHECK-NEXT:    li a0, 9
; CHECK-NEXT:    vremu.vx v9, v8, a0, v0.t
; CHECK-NEXT:    vnot.v v8, v9, v0.t
; CHECK-NEXT:    vand.vi v8, v8, 15, v0.t
; CHECK-NEXT:    vsrl.vv v8, v10, v8, v0.t
