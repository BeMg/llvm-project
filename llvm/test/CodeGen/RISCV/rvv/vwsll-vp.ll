...
; CHECK-RV32:       # %bb.0:
; CHECK-RV32-NEXT:    vmv1r.v v11, v8
; CHECK-RV32-NEXT:    vsetvli a1, zero, e64, m2, ta, ma
; CHECK-RV32-NEXT:    vzext.vf2 v8, v11
...
; CHECK-RV64:       # %bb.0:
; CHECK-RV64-NEXT:    vmv1r.v v11, v8
; CHECK-RV64-NEXT:    vsetvli a2, zero, e64, m2, ta, ma
; CHECK-RV64-NEXT:    vzext.vf2 v8, v11
...
; CHECK-ZVBB32:       # %bb.0:
; CHECK-ZVBB32-NEXT:    vmv1r.v v9, v0
...
; CHECK-ZVBB64:       # %bb.0:
; CHECK-ZVBB64-NEXT:    vmv1r.v v9, v0
