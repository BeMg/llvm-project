...
; RV32-NEXT:    lui a0, 307200
; RV32-NEXT:    fmv.w.x fa5, a0
; RV32-NEXT:    vmflt.vf v12, v8, fa5
; RV32-NEXT:    vmv1r.v v0, v12
; RV32-NEXT:    vfcvt.rtz.x.f.v v8, v10, v0.t
; RV32-NEXT:    vfcvt.f.x.v v8, v8, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV32-NEXT:    vfsgnj.vv v10, v8, v10, v0.t
; RV32-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; RV32-NEXT:    vfncvt.rtz.x.f.w v8, v10
...
; RV64-NEXT:    lui a0, 307200
; RV64-NEXT:    fmv.w.x fa5, a0
; RV64-NEXT:    vmflt.vf v12, v8, fa5
; RV64-NEXT:    vmv1r.v v0, v12
; RV64-NEXT:    vfcvt.rtz.x.f.v v8, v10, v0.t
; RV64-NEXT:    vfcvt.f.x.v v8, v8, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV64-NEXT:    vfsgnj.vv v10, v8, v10, v0.t
; RV64-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; RV64-NEXT:    vfncvt.rtz.x.f.w v8, v10
...
; RV32-NEXT:    vfsgnj.vv v10, v8, v10, v0.t
; RV32-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; RV32-NEXT:    vfncvt.rtz.xu.f.w v8, v10
; RV32-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; RV32-NEXT:    vnsrl.wi v8, v8, 0
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vfsgnj.vv v10, v8, v10, v0.t
; RV64-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; RV64-NEXT:    vfncvt.rtz.xu.f.w v8, v10
; RV64-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; RV64-NEXT:    vnsrl.wi v8, v8, 0
; RV64-NEXT:    ret
  %a = call <vscale x 4 x float> @llvm.trunc.nxv4f32(<vscale x 4 x float> %x)
...
; RV32-NEXT:    fsrmi a0, 3
; RV32-NEXT:    vmv1r.v v0, v12
; RV32-NEXT:    vfcvt.x.f.v v8, v10, v0.t
; RV32-NEXT:    fsrm a0
; RV32-NEXT:    vfcvt.f.x.v v8, v8, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV32-NEXT:    vfsgnj.vv v10, v8, v10, v0.t
...
; RV64-NEXT:    fsrmi a0, 3
; RV64-NEXT:    vmv1r.v v0, v12
; RV64-NEXT:    vfcvt.x.f.v v8, v10, v0.t
; RV64-NEXT:    fsrm a0
; RV64-NEXT:    vfcvt.f.x.v v8, v8, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV64-NEXT:    vfsgnj.vv v10, v8, v10, v0.t
...
; RV32-NEXT:    vsetvli a0, zero, e16, m1, ta, ma
; RV32-NEXT:    fsrmi a0, 3
; RV32-NEXT:    vfncvt.xu.f.w v8, v10
; RV32-NEXT:    fsrm a0
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsetvli a0, zero, e16, m1, ta, ma
; RV64-NEXT:    fsrmi a0, 3
; RV64-NEXT:    vfncvt.xu.f.w v8, v10
; RV64-NEXT:    fsrm a0
; RV64-NEXT:    ret
  %a = call <vscale x 4 x float> @llvm.ceil.nxv4f32(<vscale x 4 x float> %x)
  %b = fptoui <vscale x 4 x float> %a to <vscale x 4 x i16>
