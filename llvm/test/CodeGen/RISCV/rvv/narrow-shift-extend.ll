...
; CHECK-NEXT:    vsetvli a2, zero, e64, m4, ta, ma
; CHECK-NEXT:    vzext.vf8 v8, v13
; CHECK-NEXT:    vsll.vi v8, v8, 4
; CHECK-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; CHECK-NEXT:    vsoxei64.v v14, (a0), v8, v0.t
; CHECK-NEXT:    ret
entry:
  %offset.ext = zext <vscale x 4 x i8> %offset to <vscale x 4 x i64>
  %shamt = insertelement <vscale x 4 x i64> undef, i64 4, i32 0
...
; CHECK-NEXT:    vsll.vi v8, v8, 4
; CHECK-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; CHECK-NEXT:    vsuxei64.v v14, (a0), v8, v0.t
; CHECK-NEXT:    ret
entry:
  %offset.ext = zext <vscale x 4 x i8> %offset to <vscale x 4 x i64>
  %shamt = insertelement <vscale x 4 x i64> undef, i64 4, i32 0
