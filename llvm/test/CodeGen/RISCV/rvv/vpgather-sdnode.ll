...
; RV64-NEXT:    vmv2r.v v12, v8
; RV64-NEXT:    vsetvli zero, a0, e8, mf4, ta, ma
; RV64-NEXT:    vluxei64.v v9, (zero), v12, v0.t
...
; RV32-NEXT:    vslidedown.vx v8, v0, a3
...
; RV64-NEXT:    vslidedown.vx v25, v24, a4
; RV64-NEXT:    vsetvli a4, zero, e64, m8, ta, ma
; RV64-NEXT:    vsext.vf8 v16, v13
...
; RV64:       # %bb.0:
; RV64-NEXT:    vmv1r.v v16, v8
; RV64-NEXT:    vsetvli a2, zero, e64, m8, ta, ma
; RV64-NEXT:    vsext.vf8 v8, v16
; RV64-NEXT:    vadd.vv v16, v8, v8
...
; RV64-NEXT:    vwaddu.vv v8, v11, v11
; RV64-NEXT:    vsetvli zero, a1, e16, m2, ta, ma
...
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    vluxei32.v v16, (zero), v28, v0.t
...
; RV32-NEXT:    vluxei32.v v8, (zero), v24, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vslidedown.vx v16, v0, a3
...
; RV32-NEXT:    vslidedown.vx v8, v0, a4
...
; RV64-NEXT:    srli a4, a2, 3
; RV64-NEXT:    vsetvli a5, zero, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vx v8, v0, a4
