...
; LMULMAX1-NEXT:    vfcvt.rtz.x.f.v v9, v8
; LMULMAX1-NEXT:    vfcvt.rtz.x.f.v v8, v10
...
; LMULMAX1-NEXT:    vle32.v v8, (a2)
; LMULMAX1-NEXT:    vle32.v v10, (a0)
; LMULMAX1-NEXT:    vfcvt.rtz.xu.f.v v9, v8
; LMULMAX1-NEXT:    vfcvt.rtz.xu.f.v v8, v10
; LMULMAX1-NEXT:    vse32.v v8, (a1)
; LMULMAX1-NEXT:    addi a1, a1, 16
; LMULMAX1-NEXT:    vse32.v v9, (a1)
; LMULMAX1-NEXT:    ret
...
; LMULMAX8:       # %bb.0:
; LMULMAX8-NEXT:    vmv2r.v v10, v8
; LMULMAX8-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; LMULMAX8-NEXT:    vfncvt.rtz.x.f.w v8, v10
...
; LMULMAX1-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.x.f.w v9, v10
...
; LMULMAX8-NEXT:    vmv2r.v v10, v8
; LMULMAX8-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; LMULMAX8-NEXT:    vfncvt.rtz.xu.f.w v8, v10
; LMULMAX8-NEXT:    vand.vi v8, v8, 1
; LMULMAX8-NEXT:    vmsne.vi v0, v8, 0
; LMULMAX8-NEXT:    ret
;
...
; LMULMAX1-NEXT:    vmv1r.v v9, v8
; LMULMAX1-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.xu.f.w v8, v9
; LMULMAX1-NEXT:    vand.vi v8, v8, 1
; LMULMAX1-NEXT:    vmsne.vi v0, v8, 0
; LMULMAX1-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vmv.v.i v8, 0
; LMULMAX1-NEXT:    vmerge.vim v8, v8, 1, v0
; LMULMAX1-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.xu.f.w v9, v10
; LMULMAX1-NEXT:    vand.vi v9, v9, 1
; LMULMAX1-NEXT:    vmsne.vi v0, v9, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; LMULMAX1-NEXT:    vmv.v.i v9, 0
...
; LMULMAX8-NEXT:    vfwcvt.rtz.x.f.v v8, v12
...
; LMULMAX8-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX8-NEXT:    vle32.v v12, (a0)
; LMULMAX8-NEXT:    vfwcvt.rtz.xu.f.v v8, v12
; LMULMAX8-NEXT:    vse64.v v8, (a1)
; LMULMAX8-NEXT:    ret
;
...
; LMULMAX8RV32ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX8RV32ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX8RV32ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v9
...
; LMULMAX8RV64ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX8RV64ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX8RV64ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v9
...
; LMULMAX1RV32ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX1RV32ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX1RV32ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v9
...
; LMULMAX1RV64ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX1RV64ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX1RV64ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v9
...
; LMULMAX8RV32ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX8RV32ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX8RV32ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v9
; LMULMAX8RV32ZVFH-NEXT:    vand.vi v8, v8, 1
; LMULMAX8RV32ZVFH-NEXT:    vmsne.vi v0, v8, 0
; LMULMAX8RV32ZVFH-NEXT:    ret
;
...
; LMULMAX8RV64ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX8RV64ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX8RV64ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v9
; LMULMAX8RV64ZVFH-NEXT:    vand.vi v8, v8, 1
; LMULMAX8RV64ZVFH-NEXT:    vmsne.vi v0, v8, 0
; LMULMAX8RV64ZVFH-NEXT:    ret
;
...
; LMULMAX1RV32ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX1RV32ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX1RV32ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v9
; LMULMAX1RV32ZVFH-NEXT:    vand.vi v8, v8, 1
; LMULMAX1RV32ZVFH-NEXT:    vmsne.vi v0, v8, 0
; LMULMAX1RV32ZVFH-NEXT:    ret
;
...
; LMULMAX1RV64ZVFH-NEXT:    vmv1r.v v9, v8
; LMULMAX1RV64ZVFH-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; LMULMAX1RV64ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v9
; LMULMAX1RV64ZVFH-NEXT:    vand.vi v8, v8, 1
; LMULMAX1RV64ZVFH-NEXT:    vmsne.vi v0, v8, 0
; LMULMAX1RV64ZVFH-NEXT:    ret
;
...
; LMULMAX8-NEXT:    vfncvt.rtz.x.f.w v10, v12
...
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.x.f.w v9, v11
; LMULMAX1-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
...
; LMULMAX1-NEXT:    vslideup.vi v8, v9, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.x.f.w v9, v12
; LMULMAX1-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
...
; LMULMAX8-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX8-NEXT:    vle64.v v12, (a0)
; LMULMAX8-NEXT:    vfncvt.rtz.xu.f.w v10, v12
; LMULMAX8-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; LMULMAX8-NEXT:    vnsrl.wi v8, v10, 0
; LMULMAX8-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; LMULMAX8-NEXT:    vnsrl.wi v8, v8, 0
...
; LMULMAX1-NEXT:    vslideup.vi v8, v9, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.xu.f.w v9, v11
; LMULMAX1-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
...
; LMULMAX1-NEXT:    vslideup.vi v8, v9, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.xu.f.w v9, v12
; LMULMAX1-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
...
; LMULMAX8:       # %bb.0:
; LMULMAX8-NEXT:    vmv4r.v v12, v8
; LMULMAX8-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX8-NEXT:    vfncvt.rtz.x.f.w v8, v12
; LMULMAX8-NEXT:    vand.vi v10, v8, 1
; LMULMAX8-NEXT:    vmsne.vi v8, v10, 0
; LMULMAX8-NEXT:    vmv1r.v v0, v8
; LMULMAX8-NEXT:    ret
;
; LMULMAX1-LABEL: fp2si_v8f64_v8i1:
; LMULMAX1:       # %bb.0:
; LMULMAX1-NEXT:    vmv1r.v v12, v9
; LMULMAX1-NEXT:    vmv1r.v v9, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.x.f.w v8, v9
; LMULMAX1-NEXT:    vand.vi v8, v8, 1
...
; LMULMAX1-NEXT:    vmerge.vim v8, v13, 1, v0
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vfncvt.rtz.x.f.w v9, v12
; LMULMAX1-NEXT:    vand.vi v9, v9, 1
; LMULMAX1-NEXT:    vmsne.vi v0, v9, 0
...
; LMULMAX8-NEXT:    vmv4r.v v12, v8
; LMULMAX8-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX8-NEXT:    vfncvt.rtz.xu.f.w v8, v12
; LMULMAX8-NEXT:    vand.vi v10, v8, 1
; LMULMAX8-NEXT:    vmsne.vi v8, v10, 0
; LMULMAX8-NEXT:    vmv1r.v v0, v8
; LMULMAX8-NEXT:    ret
