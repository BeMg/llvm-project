...
; CHECK-NEXT:    vmulh.vv v14, v8, v10
; CHECK-NEXT:    vmul.vv v12, v8, v10
; CHECK-NEXT:    vsra.vi v10, v12, 7
; CHECK-NEXT:    vmsne.vv v8, v14, v10
...
; CHECK-NEXT:    vmulh.vv v20, v8, v12
; CHECK-NEXT:    vmul.vv v16, v8, v12
; CHECK-NEXT:    vsra.vi v12, v16, 7
; CHECK-NEXT:    vmsne.vv v8, v20, v12
; CHECK-NEXT:    vmv1r.v v0, v8
...
; CHECK-NEXT:    vmulh.vv v0, v8, v16
; CHECK-NEXT:    vmul.vv v24, v8, v16
; CHECK-NEXT:    vsra.vi v16, v24, 7
; CHECK-NEXT:    vmsne.vv v8, v0, v16
; CHECK-NEXT:    vmv1r.v v0, v8
