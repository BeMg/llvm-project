...
; CHECK-RV32-NEXT:    vmv.v.i v8, 1
; CHECK-RV32-NEXT:    vrsub.vi v8, v8, 0
; CHECK-RV32-NEXT:    li a0, 63
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsll.vv v9, v10, v8
; CHECK-RV32-NEXT:    vmv.s.x v8, a0
; CHECK-RV32-NEXT:    vand.vi v8, v8, 1
...
; CHECK-RV32-NEXT:    li a0, 63
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsrl.vv v9, v10, v8
; CHECK-RV32-NEXT:    vmv.s.x v8, a0
; CHECK-RV32-NEXT:    vand.vi v8, v8, 1
...
; CHECK-RV32-NEXT:    li a0, 63
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsll.vv v10, v12, v8
; CHECK-RV32-NEXT:    vmv.v.x v8, a0
; CHECK-RV32-NEXT:    vand.vi v8, v8, 1
...
; CHECK-RV32-NEXT:    li a0, 63
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsrl.vv v10, v12, v8
; CHECK-RV32-NEXT:    vmv.v.x v8, a0
; CHECK-RV32-NEXT:    vand.vi v8, v8, 1
...
; CHECK-RV32-NEXT:    li a0, 63
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsll.vv v12, v16, v8
; CHECK-RV32-NEXT:    vmv.v.x v8, a0
; CHECK-RV32-NEXT:    vand.vi v8, v8, 1
...
; CHECK-RV32-NEXT:    li a0, 63
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsrl.vv v12, v16, v8
; CHECK-RV32-NEXT:    vmv.v.x v8, a0
; CHECK-RV32-NEXT:    vand.vi v8, v8, 1
