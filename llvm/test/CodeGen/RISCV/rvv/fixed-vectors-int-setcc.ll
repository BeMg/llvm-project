...
; CHECK-NEXT:    vle8.v v8, (a1)
; CHECK-NEXT:    vmsne.vv v10, v12, v8
; CHECK-NEXT:    vmv.v.i v8, 0
...
; CHECK-NEXT:    vsetvli zero, a3, e8, m8, ta, ma
; CHECK-NEXT:    vle8.v v16, (a0)
; CHECK-NEXT:    vmsleu.vx v8, v16, a1
; CHECK-NEXT:    vsm.v v8, (a2)
; CHECK-NEXT:    ret
  %a = load <128 x i8>, ptr %x
  %b = insertelement <128 x i8> poison, i8 %y, i32 0
...
; CHECK-NEXT:    vle16.v v8, (a1)
; CHECK-NEXT:    vmslt.vv v10, v12, v8
; CHECK-NEXT:    vmv.v.i v8, 0
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmerge.vim v8, v8, 1, v0
; CHECK-NEXT:    vse16.v v8, (a0)
...
; CHECK-NEXT:    vle32.v v8, (a1)
; CHECK-NEXT:    vmsltu.vv v10, v8, v12
; CHECK-NEXT:    vmv.v.i v8, 0
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmerge.vim v8, v8, 1, v0
; CHECK-NEXT:    vse32.v v8, (a0)
...
; CHECK-NEXT:    vle64.v v8, (a1)
; CHECK-NEXT:    vmsltu.vv v10, v12, v8
; CHECK-NEXT:    vmv.v.i v8, 0
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmerge.vim v8, v8, 1, v0
; CHECK-NEXT:    vse64.v v8, (a0)
