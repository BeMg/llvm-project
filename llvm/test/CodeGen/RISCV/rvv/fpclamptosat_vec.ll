...
; CHECK-V:       # %bb.0: # %entry
; CHECK-V-NEXT:    vmv1r.v v10, v8
; CHECK-V-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-V-NEXT:    vfwcvt.rtz.x.f.v v8, v10
; CHECK-V-NEXT:    lui a0, 524288
; CHECK-V-NEXT:    addiw a1, a0, -1
...
; CHECK-V-NEXT:    vmv1r.v v10, v8
; CHECK-V-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-V-NEXT:    vfwcvt.rtz.xu.f.v v8, v10
; CHECK-V-NEXT:    li a0, -1
; CHECK-V-NEXT:    srli a0, a0, 32
; CHECK-V-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
...
; CHECK-V-NEXT:    lui a0, 524288
; CHECK-V-NEXT:    addiw a1, a0, -1
; CHECK-V-NEXT:    csrr a2, vlenb
; CHECK-V-NEXT:    slli a2, a2, 1
; CHECK-V-NEXT:    add a2, sp, a2
; CHECK-V-NEXT:    addi a2, a2, 16
; CHECK-V-NEXT:    vl2r.v v8, (a2) # Unknown-size Folded Reload
; CHECK-V-NEXT:    vmin.vx v8, v8, a1
; CHECK-V-NEXT:    vmax.vx v10, v8, a0
; CHECK-V-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; CHECK-V-NEXT:    vnsrl.wi v8, v10, 0
...
; CHECK-V:       # %bb.0: # %entry
; CHECK-V-NEXT:    vmv1r.v v9, v8
; CHECK-V-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; CHECK-V-NEXT:    vfncvt.rtz.x.f.w v8, v9
...
; CHECK-V-NEXT:    vmv1r.v v9, v8
; CHECK-V-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; CHECK-V-NEXT:    vfncvt.rtz.xu.f.w v8, v9
