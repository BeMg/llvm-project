...
; CHECK-NEXT:    vor.vv v10, v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 2, v0.t
; CHECK-NEXT:    vor.vv v10, v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 4, v0.t
; CHECK-NEXT:    vor.vv v8, v10, v8, v0.t
; CHECK-NEXT:    vnot.v v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 1, v0.t
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vsub.vv v8, v10, v8, v0.t
; CHECK-NEXT:    li a0, 51
; CHECK-NEXT:    vand.vx v10, v8, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v8, 2, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vadd.vv v10, v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 4, v0.t
...
; CHECK-NEXT:    vor.vv v9, v9, v8
; CHECK-NEXT:    vsrl.vi v8, v9, 2
; CHECK-NEXT:    vor.vv v9, v9, v8
...
; CHECK-NEXT:    vsrl.vi v8, v10, 4, v0.t
; CHECK-NEXT:    vor.vv v10, v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 8, v0.t
; CHECK-NEXT:    vor.vv v8, v10, v8, v0.t
; CHECK-NEXT:    vnot.v v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 1, v0.t
; CHECK-NEXT:    lui a0, 5
...
; CHECK-NEXT:    vsrl.vi v8, v8, 1, v0.t
; CHECK-NEXT:    vor.vv v12, v12, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v12, 2, v0.t
; CHECK-NEXT:    vor.vv v12, v12, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v12, 4, v0.t
; CHECK-NEXT:    vor.vv v12, v12, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v12, 8, v0.t
; CHECK-NEXT:    vor.vv v8, v12, v8, v0.t
; CHECK-NEXT:    vnot.v v12, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v12, 1, v0.t
; CHECK-NEXT:    lui a0, 5
; CHECK-NEXT:    addi a0, a0, 1365
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vsub.vv v8, v12, v8, v0.t
; CHECK-NEXT:    lui a0, 3
; CHECK-NEXT:    addi a0, a0, 819
; CHECK-NEXT:    vand.vx v12, v8, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v8, 2, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vadd.vv v12, v12, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v12, 4, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; CHECK-NEXT:    vsrl.vi v8, v8, 1
; CHECK-NEXT:    vor.vv v10, v10, v8
; CHECK-NEXT:    vsrl.vi v8, v10, 2
; CHECK-NEXT:    vor.vv v10, v10, v8
; CHECK-NEXT:    vsrl.vi v8, v10, 4
; CHECK-NEXT:    vor.vv v10, v10, v8
; CHECK-NEXT:    vsrl.vi v8, v10, 8
...
; CHECK-NEXT:    vsrl.vi v8, v10, 8, v0.t
; CHECK-NEXT:    vor.vv v10, v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 16, v0.t
; CHECK-NEXT:    vor.vv v8, v10, v8, v0.t
; CHECK-NEXT:    vnot.v v10, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v10, 1, v0.t
...
; CHECK-NEXT:    vsrl.vi v8, v12, 8, v0.t
; CHECK-NEXT:    vor.vv v12, v12, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v12, 16, v0.t
; CHECK-NEXT:    vor.vv v8, v12, v8, v0.t
; CHECK-NEXT:    vnot.v v12, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v12, 1, v0.t
; CHECK-NEXT:    lui a0, 349525
...
; CHECK-NEXT:    vor.vv v16, v16, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v16, 16, v0.t
...
; CHECK-NEXT:    addi a0, a0, 1365
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vsub.vv v8, v16, v8, v0.t
; CHECK-NEXT:    lui a0, 209715
; CHECK-NEXT:    addi a0, a0, 819
; CHECK-NEXT:    vand.vx v16, v8, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v8, 2, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vadd.vv v16, v16, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v16, 4, v0.t
...
; CHECK-NEXT:    vor.vv v12, v12, v8
; CHECK-NEXT:    vsrl.vi v8, v12, 8
; CHECK-NEXT:    vor.vv v12, v12, v8
; CHECK-NEXT:    vsrl.vi v8, v12, 16
...
; RV32-NEXT:    vor.vv v9, v9, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v9, 2, v0.t
; RV32-NEXT:    vor.vv v9, v9, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v9, 4, v0.t
; RV32-NEXT:    vor.vv v9, v9, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v9, 8, v0.t
; RV32-NEXT:    vor.vv v9, v9, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v9, 16, v0.t
; RV32-NEXT:    vor.vv v9, v9, v8, v0.t
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v9, a1, v0.t
; RV32-NEXT:    vor.vv v8, v9, v8, v0.t
; RV32-NEXT:    vnot.v v10, v8, v0.t
; RV32-NEXT:    vsrl.vi v9, v10, 1, v0.t
...
; RV32-NEXT:    vadd.vv v9, v9, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v9, 4, v0.t
; RV32-NEXT:    vadd.vv v9, v9, v8, v0.t
...
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vand.vv v9, v9, v8, v0.t
; RV32-NEXT:    lui a1, 4112
; RV32-NEXT:    addi a1, a1, 257
; RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vmul.vv v8, v9, v8, v0.t
; RV32-NEXT:    li a0, 56
...
; RV64-NEXT:    vor.vv v10, v10, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v10, 2, v0.t
; RV64-NEXT:    vor.vv v10, v10, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v10, 4, v0.t
; RV64-NEXT:    vor.vv v10, v10, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v10, 8, v0.t
; RV64-NEXT:    vor.vv v10, v10, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v10, 16, v0.t
; RV64-NEXT:    vor.vv v10, v10, v8, v0.t
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v10, a0, v0.t
; RV64-NEXT:    vor.vv v8, v10, v8, v0.t
; RV64-NEXT:    vnot.v v10, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v10, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vsub.vv v8, v10, v8, v0.t
...
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vadd.vv v10, v10, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v10, 4, v0.t
...
; RV32-NEXT:    vor.vv v9, v9, v8
; RV32-NEXT:    vsrl.vi v8, v9, 2
; RV32-NEXT:    vor.vv v9, v9, v8
; RV32-NEXT:    vsrl.vi v8, v9, 4
; RV32-NEXT:    vor.vv v9, v9, v8
; RV32-NEXT:    vsrl.vi v8, v9, 8
; RV32-NEXT:    vor.vv v9, v9, v8
; RV32-NEXT:    vsrl.vi v8, v9, 16
; RV32-NEXT:    vor.vv v9, v9, v8
; RV32-NEXT:    li a1, 32
...
; RV64-NEXT:    vor.vv v9, v9, v8
; RV64-NEXT:    vsrl.vi v8, v9, 2
; RV64-NEXT:    vor.vv v9, v9, v8
; RV64-NEXT:    vsrl.vi v8, v9, 4
; RV64-NEXT:    vor.vv v9, v9, v8
; RV64-NEXT:    vsrl.vi v8, v9, 8
; RV64-NEXT:    vor.vv v9, v9, v8
; RV64-NEXT:    vsrl.vi v8, v9, 16
; RV64-NEXT:    vor.vv v9, v9, v8
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v9, a0
; RV64-NEXT:    vor.vv v8, v9, v8
; RV64-NEXT:    vnot.v v9, v8
; RV64-NEXT:    vsrl.vi v8, v9, 1
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV32-NEXT:    vsrl.vi v8, v8, 1, v0.t
; RV32-NEXT:    vor.vv v10, v10, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v10, 2, v0.t
; RV32-NEXT:    vor.vv v10, v10, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v10, 4, v0.t
; RV32-NEXT:    vor.vv v10, v10, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v10, 8, v0.t
; RV32-NEXT:    vor.vv v10, v10, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v10, 16, v0.t
; RV32-NEXT:    vor.vv v10, v10, v8, v0.t
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v10, a1, v0.t
; RV32-NEXT:    vor.vv v8, v10, v8, v0.t
; RV32-NEXT:    vnot.v v12, v8, v0.t
; RV32-NEXT:    vsrl.vi v10, v12, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
...
; RV32-NEXT:    vadd.vv v10, v10, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v10, 4, v0.t
; RV32-NEXT:    vadd.vv v10, v10, v8, v0.t
; RV32-NEXT:    lui a1, 61681
; RV32-NEXT:    addi a1, a1, -241
...
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vand.vv v10, v10, v8, v0.t
; RV32-NEXT:    lui a1, 4112
; RV32-NEXT:    addi a1, a1, 257
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vmul.vv v8, v10, v8, v0.t
; RV32-NEXT:    li a0, 56
; RV32-NEXT:    vsrl.vx v8, v8, a0, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsrl.vi v8, v8, 1, v0.t
; RV64-NEXT:    vor.vv v12, v12, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v12, 2, v0.t
; RV64-NEXT:    vor.vv v12, v12, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v12, 4, v0.t
; RV64-NEXT:    vor.vv v12, v12, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v12, 8, v0.t
; RV64-NEXT:    vor.vv v12, v12, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v12, 16, v0.t
; RV64-NEXT:    vor.vv v12, v12, v8, v0.t
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v12, a0, v0.t
; RV64-NEXT:    vor.vv v8, v12, v8, v0.t
; RV64-NEXT:    vnot.v v12, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v12, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vsub.vv v8, v12, v8, v0.t
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV64-NEXT:    vsrl.vi v8, v8, 2, v0.t
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vadd.vv v12, v12, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v12, 4, v0.t
...
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vsrl.vi v8, v8, 1
; RV32-NEXT:    vor.vv v10, v10, v8
; RV32-NEXT:    vsrl.vi v8, v10, 2
; RV32-NEXT:    vor.vv v10, v10, v8
; RV32-NEXT:    vsrl.vi v8, v10, 4
; RV32-NEXT:    vor.vv v10, v10, v8
; RV32-NEXT:    vsrl.vi v8, v10, 8
; RV32-NEXT:    vor.vv v10, v10, v8
; RV32-NEXT:    vsrl.vi v8, v10, 16
; RV32-NEXT:    vor.vv v10, v10, v8
; RV32-NEXT:    li a1, 32
...
; RV64-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV64-NEXT:    vsrl.vi v8, v8, 1
; RV64-NEXT:    vor.vv v10, v10, v8
; RV64-NEXT:    vsrl.vi v8, v10, 2
; RV64-NEXT:    vor.vv v10, v10, v8
; RV64-NEXT:    vsrl.vi v8, v10, 4
; RV64-NEXT:    vor.vv v10, v10, v8
; RV64-NEXT:    vsrl.vi v8, v10, 8
; RV64-NEXT:    vor.vv v10, v10, v8
; RV64-NEXT:    vsrl.vi v8, v10, 16
; RV64-NEXT:    vor.vv v10, v10, v8
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v10, a0
...
; RV32-NEXT:    vsrl.vi v8, v8, 1, v0.t
; RV32-NEXT:    vor.vv v12, v12, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v12, 2, v0.t
; RV32-NEXT:    vor.vv v12, v12, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v12, 4, v0.t
; RV32-NEXT:    vor.vv v12, v12, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v12, 8, v0.t
; RV32-NEXT:    vor.vv v12, v12, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v12, 16, v0.t
; RV32-NEXT:    vor.vv v12, v12, v8, v0.t
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v12, a1, v0.t
; RV32-NEXT:    vor.vv v8, v12, v8, v0.t
; RV32-NEXT:    vnot.v v16, v8, v0.t
; RV32-NEXT:    vsrl.vi v12, v16, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
...
; RV32-NEXT:    vadd.vv v12, v12, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v12, 4, v0.t
; RV32-NEXT:    vadd.vv v12, v12, v8, v0.t
; RV32-NEXT:    lui a1, 61681
; RV32-NEXT:    addi a1, a1, -241
...
; RV64-NEXT:    vor.vv v16, v16, v8, v0.t
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v16, a0, v0.t
...
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vsrl.vi v8, v8, 1
; RV32-NEXT:    vor.vv v12, v12, v8
; RV32-NEXT:    vsrl.vi v8, v12, 2
; RV32-NEXT:    vor.vv v12, v12, v8
; RV32-NEXT:    vsrl.vi v8, v12, 4
; RV32-NEXT:    vor.vv v12, v12, v8
; RV32-NEXT:    vsrl.vi v8, v12, 8
; RV32-NEXT:    vor.vv v12, v12, v8
; RV32-NEXT:    vsrl.vi v8, v12, 16
; RV32-NEXT:    vor.vv v12, v12, v8
; RV32-NEXT:    li a1, 32
...
; RV64-NEXT:    vor.vv v12, v12, v8
; RV64-NEXT:    vsrl.vi v8, v12, 16
; RV64-NEXT:    vor.vv v12, v12, v8
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v12, a0
; RV64-NEXT:    vor.vv v8, v12, v8
; RV64-NEXT:    vnot.v v12, v8
...
; RV64-NEXT:    vsrl.vi v8, v24, 2, v0.t
; RV64-NEXT:    vor.vv v24, v24, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v24, 4, v0.t
; RV64-NEXT:    vor.vv v24, v24, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v24, 8, v0.t
; RV64-NEXT:    vor.vv v24, v24, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v24, 16, v0.t
; RV64-NEXT:    vor.vv v24, v24, v8, v0.t
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v24, a0, v0.t
; RV64-NEXT:    vor.vv v8, v24, v8, v0.t
; RV64-NEXT:    vnot.v v24, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v24, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vsub.vv v8, v24, v8, v0.t
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV32-NEXT:    vsrl.vi v8, v16, 2
; RV32-NEXT:    vor.vv v16, v16, v8
; RV32-NEXT:    vsrl.vi v8, v16, 4
; RV32-NEXT:    vor.vv v16, v16, v8
; RV32-NEXT:    vsrl.vi v8, v16, 8
; RV32-NEXT:    vor.vv v16, v16, v8
...
; RV64-NEXT:    vor.vv v16, v16, v8
; RV64-NEXT:    vsrl.vi v8, v16, 16
; RV64-NEXT:    vor.vv v16, v16, v8
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v16, a0
...
; RV32-NEXT:    vslidedown.vi v25, v0, 2
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
...
; RV64-NEXT:    vsrl.vi v8, v16, 16, v0.t
; RV64-NEXT:    vor.vv v16, v16, v8, v0.t
; RV64-NEXT:    vsrl.vx v8, v16, a1, v0.t
; RV64-NEXT:    vor.vv v8, v16, v8, v0.t
; RV64-NEXT:    vnot.v v16, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v16, 1, v0.t
...
; RV64-NEXT:    vor.vv v24, v24, v8
; RV64-NEXT:    vsrl.vi v8, v24, 16
; RV64-NEXT:    vor.vv v24, v24, v8
; RV64-NEXT:    li a1, 32
; RV64-NEXT:    vsrl.vx v8, v24, a1
