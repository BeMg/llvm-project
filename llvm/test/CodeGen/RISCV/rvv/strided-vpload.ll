...
; CHECK-RV32-NEXT:    vslidedown.vx v9, v8, t2
; CHECK-RV32-NEXT:    vsetvli zero, t0, e64, m8, ta, ma
; CHECK-RV32-NEXT:    vmv1r.v v0, v9
; CHECK-RV32-NEXT:    vlse64.v v24, (t1), a1, v0.t
...
; CHECK-RV32-NEXT:    vslidedown.vx v9, v8, a2
; CHECK-RV32-NEXT:    vsetvli zero, a3, e64, m8, ta, ma
; CHECK-RV32-NEXT:    vmv1r.v v0, v9
; CHECK-RV32-NEXT:    vlse64.v v16, (a6), a1, v0.t
; CHECK-RV32-NEXT:    vsetvli zero, a5, e64, m8, ta, ma
; CHECK-RV32-NEXT:    vmv1r.v v0, v8
; CHECK-RV32-NEXT:    vlse64.v v8, (a0), a1, v0.t
; CHECK-RV32-NEXT:    vs1r.v v16, (a4)
; CHECK-RV32-NEXT:    vmv8r.v v16, v24
; CHECK-RV32-NEXT:    ret
;
...
; CHECK-RV64-NEXT:    vslidedown.vx v9, v8, t2
; CHECK-RV64-NEXT:    vsetvli zero, t0, e64, m8, ta, ma
; CHECK-RV64-NEXT:    vmv1r.v v0, v9
; CHECK-RV64-NEXT:    vlse64.v v24, (t1), a1, v0.t
...
; CHECK-RV64-NEXT:    vslidedown.vx v9, v8, a4
; CHECK-RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; CHECK-RV64-NEXT:    vmv1r.v v0, v9
; CHECK-RV64-NEXT:    vlse64.v v16, (a6), a1, v0.t
; CHECK-RV64-NEXT:    vsetvli zero, a5, e64, m8, ta, ma
; CHECK-RV64-NEXT:    vmv1r.v v0, v8
; CHECK-RV64-NEXT:    vlse64.v v8, (a0), a1, v0.t
; CHECK-RV64-NEXT:    vs1r.v v16, (a3)
; CHECK-RV64-NEXT:    vmv8r.v v16, v24
; CHECK-RV64-NEXT:    ret
