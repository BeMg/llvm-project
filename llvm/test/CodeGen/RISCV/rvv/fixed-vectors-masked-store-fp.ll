...
; RV32-NEXT:    vle64.v v9, (a2)
; RV32-NEXT:    vle64.v v8, (a0)
; RV32-NEXT:    fcvt.d.w fa5, zero
; RV32-NEXT:    vmfeq.vf v0, v9, fa5
...
; RV64-NEXT:    vle64.v v9, (a2)
; RV64-NEXT:    vle64.v v8, (a0)
; RV64-NEXT:    fmv.d.x fa5, zero
; RV64-NEXT:    vmfeq.vf v0, v9, fa5
...
; CHECK-NEXT:    vle32.v v8, (a0)
; CHECK-NEXT:    fmv.w.x fa5, zero
; CHECK-NEXT:    vmfeq.vf v12, v16, fa5
...
; RV32-NEXT:    vle64.v v8, (a0)
; RV32-NEXT:    fcvt.d.w fa5, zero
; RV32-NEXT:    vmfeq.vf v16, v24, fa5
...
; RV64-NEXT:    vle64.v v8, (a0)
; RV64-NEXT:    fmv.d.x fa5, zero
; RV64-NEXT:    vmfeq.vf v16, v24, fa5
...
; CHECK-NEXT:    vle32.v v8, (a0)
; CHECK-NEXT:    fmv.w.x fa5, zero
; CHECK-NEXT:    vmfeq.vf v16, v24, fa5
...
; RV32-NEXT:    fcvt.d.w fa5, zero
; RV32-NEXT:    vmfeq.vf v24, v8, fa5
; RV32-NEXT:    vle64.v v8, (a0)
; RV32-NEXT:    addi a0, a0, 128
; RV32-NEXT:    vle64.v v16, (a0)
; RV32-NEXT:    vmfeq.vf v25, v0, fa5
...
; RV64-NEXT:    vle64.v v0, (a2)
; RV64-NEXT:    fmv.d.x fa5, zero
; RV64-NEXT:    vmfeq.vf v24, v8, fa5
; RV64-NEXT:    vle64.v v8, (a0)
; RV64-NEXT:    addi a0, a0, 128
; RV64-NEXT:    vle64.v v16, (a0)
; RV64-NEXT:    vmfeq.vf v25, v0, fa5
...
; CHECK-NEXT:    fmv.w.x fa5, zero
; CHECK-NEXT:    vmfeq.vf v24, v8, fa5
; CHECK-NEXT:    vle32.v v8, (a0)
; CHECK-NEXT:    addi a0, a0, 128
; CHECK-NEXT:    vle32.v v16, (a0)
; CHECK-NEXT:    vmfeq.vf v25, v0, fa5
