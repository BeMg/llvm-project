...
; CHECK-NEXT:    sf.vfnrclip.xu.f.qf v8, v9, fa0
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    sf.vfnrclip.xu.f.qf v8, v10, fa0
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    sf.vfnrclip.xu.f.qf v8, v12, fa0
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    sf.vfnrclip.xu.f.qf v8, v16, fa0
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
