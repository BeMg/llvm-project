...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFH-NEXT:    vmfeq.vf v8, v8, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v8, v9, v8, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    ret
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vmv1r.v v11, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFH-NEXT:    vmflt.vv v8, v8, v9, v0.t
; ZVFH-NEXT:    vmflt.vv v9, v9, v11, v0.t
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vmv1r.v v11, v8
; ZVFHMIN-NEXT:    vsetvli a1, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v9
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v9, v8, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a1, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v11
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFH-NEXT:    vmfne.vv v8, v8, v9, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v12
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v8, v8, v9, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    ret
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFH-NEXT:    vmfne.vf v8, v8, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v10
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v8, v9, v8, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    ret
  %elt.head = insertelement <vscale x 1 x half> poison, half %b, i32 0
  %vb = shufflevector <vscale x 1 x half> %elt.head, <vscale x 1 x half> poison, <vscale x 1 x i32> zeroinitializer
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v9
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v9, v8, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a1, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v11
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, mf2, ta, ma
...
; ZVFH-NEXT:    vmfeq.vv v8, v12, v10, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vmfeq.vv v16, v8, v12, v0.t
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfeq.vf v8, v12, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: fcmp_oeq_vf_nxv8f16:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vmv2r.v v20, v8
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa0
; ZVFHMIN-NEXT:    vsetvli a1, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vfmv.v.f v8, fa5
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v16, v8
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v12, v20
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v16
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v16, v12, v8, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v16
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmflt.vv v8, v10, v12, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfgt.vf v8, v12, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmflt.vf v8, v12, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfle.vv v8, v10, v12, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v18
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfle.vv v16, v8, v12, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v16
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfge.vf v8, v12, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfle.vf v8, v12, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v16
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfle.vv v16, v12, v8, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v16
; ZVFHMIN-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x half> poison, half %b, i32 0
  %vb = shufflevector <vscale x 8 x half> %elt.head, <vscale x 8 x half> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmflt.vv v8, v12, v10, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfle.vv v8, v12, v10, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vmv2r.v v14, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmflt.vv v9, v14, v10, v0.t
; ZVFH-NEXT:    vmflt.vv v8, v10, v14, v0.t
; ZVFH-NEXT:    vmor.mm v0, v8, v9
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmflt.vf v9, v10, fa0, v0.t
; ZVFH-NEXT:    vmfgt.vf v8, v10, fa0, v0.t
; ZVFH-NEXT:    vmor.mm v0, v8, v9
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv2r.v v10, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfgt.vf v9, v10, fa0, v0.t
; ZVFH-NEXT:    vmflt.vf v8, v10, fa0, v0.t
; ZVFH-NEXT:    vmor.mm v0, v8, v9
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv2r.v v14, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfeq.vv v8, v10, v10, v0.t
; ZVFH-NEXT:    vmfeq.vv v9, v14, v14, v0.t
; ZVFH-NEXT:    vmand.mm v0, v9, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vmv2r.v v14, v10
; ZVFHMIN-NEXT:    vmv2r.v v16, v8
; ZVFHMIN-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v14
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v12, v8, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v16
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v13, v8, v8, v0.t
; ZVFHMIN-NEXT:    vmand.mm v0, v13, v12
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfeq.vf v8, v10, fa0, v0.t
; ZVFH-NEXT:    vmfeq.vv v9, v14, v14, v0.t
; ZVFH-NEXT:    vmand.mm v0, v9, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v13, v8, v8, v0.t
; ZVFHMIN-NEXT:    vmand.mm v0, v12, v13
; ZVFHMIN-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x half> poison, half %b, i32 0
  %vb = shufflevector <vscale x 8 x half> %elt.head, <vscale x 8 x half> poison, <vscale x 8 x i32> zeroinitializer
  %v = call <vscale x 8 x i1> @llvm.vp.fcmp.nxv8f16(<vscale x 8 x half> %va, <vscale x 8 x half> %vb, metadata !"ord", <vscale x 8 x i1> %m, i32 %evl)
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfne.vv v8, v12, v10, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v18
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v16, v8, v12, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v16
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vmv2r.v v12, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfne.vf v8, v12, fa0, v0.t
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v16
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v16, v12, v8, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v16
; ZVFHMIN-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x half> poison, half %b, i32 0
  %vb = shufflevector <vscale x 8 x half> %elt.head, <vscale x 8 x half> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFH-NEXT:    vmv2r.v v14, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfne.vv v8, v10, v10, v0.t
; ZVFH-NEXT:    vmfne.vv v9, v14, v14, v0.t
; ZVFH-NEXT:    vmor.mm v0, v9, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v14
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v12, v8, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v16
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vmfne.vv v13, v8, v8, v0.t
...
; ZVFH-NEXT:    vfmv.v.f v10, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; ZVFH-NEXT:    vmfne.vf v8, v10, fa0, v0.t
; ZVFH-NEXT:    vmfne.vv v9, v14, v14, v0.t
; ZVFH-NEXT:    vmor.mm v0, v9, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmfeq.vv v2, v24, v16, v0.t
...
; ZVFH-NEXT:    vslideup.vx v24, v2, a1
...
; ZVFHMIN-NEXT:    vmfeq.vv v2, v8, v16, v0.t
...
; ZVFHMIN-NEXT:    vslideup.vx v1, v2, a3
...
; ZVFHMIN-NEXT:    vsetvli zero, a0, e8, mf2, tu, ma
; ZVFHMIN-NEXT:    vslideup.vx v8, v2, a3
; ZVFHMIN-NEXT:    add a0, a1, a1
; ZVFHMIN-NEXT:    vsetvli zero, a0, e8, m1, tu, ma
; ZVFHMIN-NEXT:    vslideup.vx v8, v1, a1
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    csrr a0, vlenb
...
; CHECK-NEXT:    vmfeq.vv v8, v8, v9, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; CHECK-NEXT:    vmflt.vv v8, v8, v9, v0.t
; CHECK-NEXT:    vmflt.vv v9, v9, v11, v0.t
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; CHECK-NEXT:    vmfne.vv v8, v8, v9, v0.t
; CHECK-NEXT:    vmv.v.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfeq.vf v8, v24, fa0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmflt.vv v8, v16, v24, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfgt.vf v8, v24, fa0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %vb = shufflevector <vscale x 8 x double> %elt.head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmflt.vf v8, v24, fa0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %vb = shufflevector <vscale x 8 x double> %elt.head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfle.vv v8, v16, v24, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfge.vf v8, v24, fa0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %vb = shufflevector <vscale x 8 x double> %elt.head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfle.vf v8, v24, fa0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %vb = shufflevector <vscale x 8 x double> %elt.head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmflt.vv v8, v24, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfle.vv v8, v24, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmfgt.vf v8, v16, fa0, v0.t
; CHECK-NEXT:    vmor.mm v0, v8, v9
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %vb = shufflevector <vscale x 8 x double> %elt.head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmflt.vf v8, v16, fa0, v0.t
; CHECK-NEXT:    vmor.mm v0, v8, v9
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %vb = shufflevector <vscale x 8 x double> %elt.head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfne.vv v8, v24, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmfne.vf v8, v24, fa0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x double> poison, double %b, i32 0
  %vb = shufflevector <vscale x 8 x double> %elt.head, <vscale x 8 x double> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vslidedown.vx v27, v25, a1
...
; CHECK-NEXT:    vslideup.vx v24, v26, a1
; CHECK-NEXT:    mv a2, a0
...
; CHECK-NEXT:    vl8r.v v8, (a2) # Unknown-size Folded Reload
; CHECK-NEXT:    vmfeq.vv v25, v8, v16, v0.t
; CHECK-NEXT:    add a2, a4, a1
; CHECK-NEXT:    vsetvli zero, a2, e8, mf2, tu, ma
; CHECK-NEXT:    vslideup.vx v24, v25, a4
...
; CHECK-NEXT:    vslideup.vx v24, v25, a0
; CHECK-NEXT:    vmv1r.v v0, v24
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    li a1, 48
