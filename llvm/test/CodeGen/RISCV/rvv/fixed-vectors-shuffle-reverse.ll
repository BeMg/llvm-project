...
; NO-ZVBB-NEXT:    vmerge.vim v9, v8, 1, v0
...
; NO-ZVBB-NEXT:    vmv.v.i v8, 0
; NO-ZVBB-NEXT:    vmerge.vim v10, v8, 1, v0
; NO-ZVBB-NEXT:    vid.v v8
; NO-ZVBB-NEXT:    vrsub.vi v9, v8, 3
; NO-ZVBB-NEXT:    vrgather.vv v8, v10, v9
; NO-ZVBB-NEXT:    vmsne.vi v0, v8, 0
; NO-ZVBB-NEXT:    ret
;
...
; NO-ZVBB-NEXT:    vmerge.vim v10, v8, 1, v0
; NO-ZVBB-NEXT:    vid.v v8
; NO-ZVBB-NEXT:    vrsub.vi v9, v8, 15
; NO-ZVBB-NEXT:    vrgather.vv v8, v10, v9
; NO-ZVBB-NEXT:    vmsne.vi v0, v8, 0
; NO-ZVBB-NEXT:    ret
;
...
; NO-ZVBB-NEXT:    vmerge.vim v12, v10, 1, v0
; NO-ZVBB-NEXT:    vrgather.vv v10, v12, v8
; NO-ZVBB-NEXT:    vmsne.vi v8, v10, 0
; NO-ZVBB-NEXT:    vmv1r.v v0, v8
; NO-ZVBB-NEXT:    ret
;
...
; NO-ZVBB-NEXT:    vmerge.vim v16, v12, 1, v0
; NO-ZVBB-NEXT:    vrgather.vv v12, v16, v8
; NO-ZVBB-NEXT:    vmsne.vi v8, v12, 0
; NO-ZVBB-NEXT:    vmv1r.v v0, v8
; NO-ZVBB-NEXT:    ret
;
...
; NO-ZVBB:       # %bb.0:
; NO-ZVBB-NEXT:    vmv1r.v v9, v8
; NO-ZVBB-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; NO-ZVBB-NEXT:    vslidedown.vi v8, v8, 1
; NO-ZVBB-NEXT:    vslideup.vi v8, v9, 1
; NO-ZVBB-NEXT:    ret
;
...
; RV32-BITS-UNKNOWN-NEXT:    vle16.v v10, (a0)
; RV32-BITS-UNKNOWN-NEXT:    vmv2r.v v12, v8
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v12, v10
...
; RV32-BITS-256-NEXT:    vle16.v v10, (a0)
; RV32-BITS-256-NEXT:    vmv2r.v v12, v8
; RV32-BITS-256-NEXT:    vrgatherei16.vv v8, v12, v10
...
; RV64-BITS-256-NEXT:    vrsub.vi v10, v8, 2
; RV64-BITS-256-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; RV64-BITS-256-NEXT:    vrgatherei16.vv v8, v12, v10
...
; RV64-BITS-512-NEXT:    vrsub.vi v10, v8, 2
; RV64-BITS-512-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; RV64-BITS-512-NEXT:    vrgatherei16.vv v8, v12, v10
...
; RV32-ZVBB-NEXT:    vle16.v v10, (a0)
; RV32-ZVBB-NEXT:    vmv2r.v v12, v8
; RV32-ZVBB-NEXT:    vrgatherei16.vv v8, v12, v10
; RV32-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v3i64:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vmv2r.v v12, v8
; RV64-ZVBB-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; RV64-ZVBB-NEXT:    vid.v v8
; RV64-ZVBB-NEXT:    vrsub.vi v10, v8, 2
; RV64-ZVBB-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; RV64-ZVBB-NEXT:    vrgatherei16.vv v8, v12, v10
; RV64-ZVBB-NEXT:    ret
...
; RV32-BITS-UNKNOWN-NEXT:    vmv4r.v v16, v8
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v16, v12
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-256-NEXT:    vrgatherei16.vv v8, v16, v12
; RV32-BITS-256-NEXT:    ret
;
...
; RV32-BITS-512-NEXT:    vrgatherei16.vv v8, v16, v12
; RV32-BITS-512-NEXT:    ret
;
; RV64-BITS-UNKNOWN-LABEL: reverse_v6i64:
; RV64-BITS-UNKNOWN:       # %bb.0:
; RV64-BITS-UNKNOWN-NEXT:    vmv4r.v v16, v8
; RV64-BITS-UNKNOWN-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vid.v v8
; RV64-BITS-UNKNOWN-NEXT:    vrsub.vi v12, v8, 5
; RV64-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v16, v12
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-256-NEXT:    vid.v v8
; RV64-BITS-256-NEXT:    vrsub.vi v12, v8, 5
; RV64-BITS-256-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV64-BITS-256-NEXT:    vrgatherei16.vv v8, v16, v12
; RV64-BITS-256-NEXT:    ret
;
...
; RV64-BITS-512-NEXT:    vid.v v8
; RV64-BITS-512-NEXT:    vrsub.vi v12, v8, 5
; RV64-BITS-512-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV64-BITS-512-NEXT:    vrgatherei16.vv v8, v16, v12
; RV64-BITS-512-NEXT:    ret
;
...
; RV32-ZVBB-NEXT:    vmv4r.v v16, v8
; RV32-ZVBB-NEXT:    vrgatherei16.vv v8, v16, v12
; RV32-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v6i64:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vmv4r.v v16, v8
; RV64-ZVBB-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; RV64-ZVBB-NEXT:    vid.v v8
; RV64-ZVBB-NEXT:    vrsub.vi v12, v8, 5
; RV64-ZVBB-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV64-ZVBB-NEXT:    vrgatherei16.vv v8, v16, v12
; RV64-ZVBB-NEXT:    ret
...
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v24, v16
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-256-NEXT:    vrgatherei16.vv v8, v24, v16
; RV32-BITS-256-NEXT:    ret
;
...
; RV32-BITS-512-NEXT:    vrgatherei16.vv v8, v24, v16
; RV32-BITS-512-NEXT:    ret
;
...
; RV64-BITS-UNKNOWN-NEXT:    vid.v v8
; RV64-BITS-UNKNOWN-NEXT:    vrsub.vi v16, v8, 11
; RV64-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v24, v16
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-256-NEXT:    vid.v v8
; RV64-BITS-256-NEXT:    vrsub.vi v16, v8, 11
; RV64-BITS-256-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-BITS-256-NEXT:    vrgatherei16.vv v8, v24, v16
; RV64-BITS-256-NEXT:    ret
;
...
; RV64-BITS-512-NEXT:    vid.v v8
; RV64-BITS-512-NEXT:    vrsub.vi v16, v8, 11
; RV64-BITS-512-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-BITS-512-NEXT:    vrgatherei16.vv v8, v24, v16
; RV64-BITS-512-NEXT:    ret
;
...
; RV32-ZVBB-NEXT:    vmv8r.v v24, v8
; RV32-ZVBB-NEXT:    vrgatherei16.vv v8, v24, v16
; RV32-ZVBB-NEXT:    ret
;
; RV64-ZVBB-LABEL: reverse_v12i64:
; RV64-ZVBB:       # %bb.0:
; RV64-ZVBB-NEXT:    vmv8r.v v24, v8
; RV64-ZVBB-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-ZVBB-NEXT:    vid.v v8
; RV64-ZVBB-NEXT:    vrsub.vi v16, v8, 11
; RV64-ZVBB-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-ZVBB-NEXT:    vrgatherei16.vv v8, v24, v16
; RV64-ZVBB-NEXT:    ret
