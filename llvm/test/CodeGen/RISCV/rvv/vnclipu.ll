...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v8, v12, v10
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v8, v16, v12
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v8, v24, v16
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v8, v10, a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v8, v12, a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v8, v16, a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m1, ta, ma
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wi v8, v10, 9
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.vnclipu.nxv8i8.nxv8i16(
    <vscale x 8 x i8> undef,
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, ma
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wi v8, v12, 9
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.vnclipu.nxv16i8.nxv16i16(
    <vscale x 16 x i8> undef,
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wi v8, v16, 9
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.vnclipu.nxv32i8.nxv32i16(
    <vscale x 32 x i8> undef,
