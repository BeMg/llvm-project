...
; CHECK-NEXT:    vslidedown.vi v8, v11, 4
; CHECK-NEXT:    vsetivli zero, 2, e16, mf4, ta, ma
; CHECK-NEXT:    vdiv.vv v8, v8, v9
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; CHECK-NEXT:    vdiv.vv v9, v11, v10
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
...
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; CHECK-NEXT:    vdivu.vv v9, v11, v10
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; CHECK-NEXT:    vslideup.vi v9, v8, 4
; CHECK-NEXT:    vsetivli zero, 6, e16, m1, ta, ma
; CHECK-NEXT:    vse16.v v9, (a0)
...
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; CHECK-NEXT:    vremu.vv v9, v11, v10
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; CHECK-NEXT:    vslideup.vi v9, v8, 4
; CHECK-NEXT:    vsetivli zero, 6, e16, m1, ta, ma
; CHECK-NEXT:    vse16.v v9, (a0)
...
; CHECK-NEXT:    vmerge.vxm v10, v11, a1, v0
; CHECK-NEXT:    lui a1, 1
...
; CHECK-NEXT:    vsrl.vv v9, v12, v9
; CHECK-NEXT:    vmulhu.vv v8, v9, v8
; CHECK-NEXT:    vsub.vv v9, v12, v8
...
; CHECK-NEXT:    vle16.v v8, (a1)
; CHECK-NEXT:    vsrl.vv v9, v12, v9
; CHECK-NEXT:    vmulhu.vv v9, v9, v8
; CHECK-NEXT:    vsub.vv v8, v12, v9
...
; RV64-NEXT:    vmulhu.vv v9, v9, v8
; RV64-NEXT:    vid.v v8
; RV64-NEXT:    vadd.vi v8, v8, 1
; RV64-NEXT:    vsrl.vv v8, v9, v8
...
; RV32-NEXT:    vmerge.vxm v8, v10, a1, v0
...
; RV64-NEXT:    vsra.vi v9, v8, 1
; RV64-NEXT:    vsrl.vi v8, v9, 31
...
; RV32-NEXT:    li a1, 63
; RV32-NEXT:    vsrl.vx v10, v11, a1
; RV32-NEXT:    lui a1, 16
; RV32-NEXT:    vmv.s.x v9, a1
; RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32-NEXT:    vsext.vf4 v8, v9
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vsra.vv v8, v11, v8
...
; RV64-NEXT:    vle64.v v11, (a0)
; RV64-NEXT:    vmv.v.x v8, a1
; RV64-NEXT:    vsetvli zero, zero, e64, m1, tu, ma
; RV64-NEXT:    vmv.s.x v8, a2
; RV64-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; RV64-NEXT:    vmulh.vv v10, v11, v8
; RV64-NEXT:    vid.v v9
; RV64-NEXT:    vrsub.vi v8, v9, 0
; RV64-NEXT:    vmadd.vv v8, v11, v10
; RV64-NEXT:    li a1, 63
...
; LMULMAX1-RV32-NEXT:    vle8.v v11, (a0)
; LMULMAX1-RV32-NEXT:    addi a2, a0, 16
; LMULMAX1-RV32-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV32-NEXT:    addi a3, a1, 16
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
...
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
...
; LMULMAX1-RV64-NEXT:    vse16.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
...
; LMULMAX1-RV32-NEXT:    vle32.v v11, (a0)
; LMULMAX1-RV32-NEXT:    addi a2, a0, 16
; LMULMAX1-RV32-NEXT:    vle32.v v10, (a2)
; LMULMAX1-RV32-NEXT:    addi a3, a1, 16
; LMULMAX1-RV32-NEXT:    vle32.v v8, (a3)
...
; LMULMAX1-RV64-NEXT:    vle32.v v11, (a0)
; LMULMAX1-RV64-NEXT:    addi a2, a1, 16
; LMULMAX1-RV64-NEXT:    vle32.v v8, (a2)
; LMULMAX1-RV64-NEXT:    addi a2, a0, 16
...
; LMULMAX1-RV64-NEXT:    vse32.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
...
; LMULMAX1-RV32-NEXT:    vadd.vv v8, v11, v9
; LMULMAX1-RV32-NEXT:    vse32.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle64.v v11, (a0)
; LMULMAX1-RV32-NEXT:    addi a2, a0, 16
; LMULMAX1-RV32-NEXT:    vle64.v v10, (a2)
; LMULMAX1-RV32-NEXT:    addi a3, a1, 16
; LMULMAX1-RV32-NEXT:    vle64.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle64.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vadd.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse64.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse64.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
; LMULMAX1-RV64-LABEL: add_v4i64:
; LMULMAX1-RV64:       # %bb.0:
; LMULMAX1-RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV64-NEXT:    vle64.v v11, (a0)
; LMULMAX1-RV64-NEXT:    addi a2, a1, 16
; LMULMAX1-RV64-NEXT:    vle64.v v8, (a2)
; LMULMAX1-RV64-NEXT:    addi a2, a0, 16
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vsub.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vsub.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vsub.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vsub.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vsub.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vmul.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vmul.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vmul.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vmul.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vmul.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vand.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vand.vv v8, v10, v8
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vand.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vand.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vor.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vxor.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vxor.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vxor.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vxor.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vxor.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vsrl.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vsrl.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vsrl.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vsrl.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vsra.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vsra.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vsra.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vsra.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vsra.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vsll.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vsll.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vsll.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vsll.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vsll.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vdiv.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vdiv.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vdiv.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vdiv.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vdiv.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vrem.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vrem.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vrem.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vrem.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vrem.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vdivu.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vdivu.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vdivu.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vdivu.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vdivu.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vremu.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vremu.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vremu.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vremu.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vremu.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX1-NEXT:    vadd.vv v9, v11, v9
...
; LMULMAX2-NEXT:    vmerge.vxm v12, v14, a1, v0
; LMULMAX2-NEXT:    lui a1, 66049
; LMULMAX2-NEXT:    addi a1, a1, 32
; LMULMAX2-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; LMULMAX2-NEXT:    vmv.s.x v10, a1
; LMULMAX2-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; LMULMAX2-NEXT:    lui a1, %hi(.LCPI181_0)
; LMULMAX2-NEXT:    addi a1, a1, %lo(.LCPI181_0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vmv1r.v v0, v10
; LMULMAX2-NEXT:    vmerge.vim v10, v14, 1, v0
; LMULMAX2-NEXT:    vsrl.vv v10, v16, v10
; LMULMAX2-NEXT:    vmulhu.vv v8, v10, v8
; LMULMAX2-NEXT:    vsub.vv v10, v16, v8
; LMULMAX2-NEXT:    vmulhu.vv v10, v10, v12
; LMULMAX2-NEXT:    vadd.vv v10, v10, v8
; LMULMAX2-NEXT:    vmv.v.i v12, 4
...
; LMULMAX2-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; LMULMAX2-NEXT:    vmv1r.v v0, v8
; LMULMAX2-NEXT:    vmerge.vim v12, v12, 1, v0
...
; LMULMAX1-NEXT:    vdivu.vv v9, v9, v8
; LMULMAX1-NEXT:    vdivu.vv v8, v10, v8
...
; LMULMAX2-RV32-NEXT:    vle16.v v16, (a0)
; LMULMAX2-RV32-NEXT:    li a1, 257
; LMULMAX2-RV32-NEXT:    vmv.s.x v10, a1
; LMULMAX2-RV32-NEXT:    vmv.v.i v8, 0
; LMULMAX2-RV32-NEXT:    lui a1, 1048568
; LMULMAX2-RV32-NEXT:    vmv1r.v v0, v10
; LMULMAX2-RV32-NEXT:    vmerge.vxm v14, v8, a1, v0
; LMULMAX2-RV32-NEXT:    lui a1, 4
; LMULMAX2-RV32-NEXT:    addi a1, a1, 64
; LMULMAX2-RV32-NEXT:    vmv.s.x v13, a1
; LMULMAX2-RV32-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.i v8, 0
; LMULMAX2-RV32-NEXT:    vmv1r.v v0, v13
; LMULMAX2-RV32-NEXT:    vmerge.vim v12, v8, 1, v0
...
; LMULMAX2-RV32-NEXT:    vsext.vf2 v10, v12
; LMULMAX2-RV32-NEXT:    vsrl.vv v10, v16, v10
; LMULMAX2-RV32-NEXT:    vmulhu.vv v10, v10, v8
; LMULMAX2-RV32-NEXT:    vsub.vv v8, v16, v10
; LMULMAX2-RV32-NEXT:    vmulhu.vv v8, v8, v14
; LMULMAX2-RV32-NEXT:    vadd.vv v10, v8, v10
; LMULMAX2-RV32-NEXT:    lui a1, 2
; LMULMAX2-RV32-NEXT:    addi a1, a1, 289
; LMULMAX2-RV32-NEXT:    vmv.s.x v9, a1
; LMULMAX2-RV32-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.i v8, 3
; LMULMAX2-RV32-NEXT:    vmv1r.v v0, v9
; LMULMAX2-RV32-NEXT:    vmerge.vim v8, v8, 2, v0
; LMULMAX2-RV32-NEXT:    vmv1r.v v0, v13
; LMULMAX2-RV32-NEXT:    vmerge.vim v12, v8, 1, v0
; LMULMAX2-RV32-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vsext.vf2 v8, v12
...
; LMULMAX2-RV64-NEXT:    vle16.v v16, (a0)
...
; LMULMAX2-RV64-NEXT:    vmv1r.v v0, v10
; LMULMAX2-RV64-NEXT:    vmerge.vxm v14, v8, a1, v0
...
; LMULMAX2-RV64-NEXT:    vsext.vf2 v10, v12
; LMULMAX2-RV64-NEXT:    vsrl.vv v10, v16, v10
; LMULMAX2-RV64-NEXT:    vmulhu.vv v8, v10, v8
; LMULMAX2-RV64-NEXT:    vsub.vv v10, v16, v8
; LMULMAX2-RV64-NEXT:    vmulhu.vv v10, v10, v14
; LMULMAX2-RV64-NEXT:    vadd.vv v12, v10, v8
; LMULMAX2-RV64-NEXT:    lui a1, %hi(.LCPI182_1)
; LMULMAX2-RV64-NEXT:    addi a1, a1, %lo(.LCPI182_1)
; LMULMAX2-RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX2-RV64-NEXT:    vlse64.v v10, (a1), zero
; LMULMAX2-RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; LMULMAX2-RV64-NEXT:    vsext.vf2 v8, v10
; LMULMAX2-RV64-NEXT:    vsrl.vv v8, v12, v8
...
; LMULMAX2-NEXT:    vmv1r.v v0, v12
; LMULMAX2-NEXT:    vmerge.vxm v10, v10, a1, v0
; LMULMAX2-NEXT:    vmulhu.vv v8, v14, v8
; LMULMAX2-NEXT:    vsub.vv v12, v14, v8
; LMULMAX2-NEXT:    vmulhu.vv v10, v12, v10
; LMULMAX2-NEXT:    vadd.vv v12, v10, v8
...
; LMULMAX2-NEXT:    vsrl.vv v8, v12, v8
; LMULMAX2-NEXT:    vse32.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32:       # %bb.0:
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vle32.v v14, (a0)
; LMULMAX1-RV32-NEXT:    addi a1, a0, 16
; LMULMAX1-RV32-NEXT:    vle32.v v8, (a1)
; LMULMAX1-RV32-NEXT:    lui a2, 524288
; LMULMAX1-RV32-NEXT:    vmv.s.x v9, a2
; LMULMAX1-RV32-NEXT:    vmv.v.i v13, 0
; LMULMAX1-RV32-NEXT:    vsetivli zero, 3, e32, m1, tu, ma
; LMULMAX1-RV32-NEXT:    vslideup.vi v13, v9, 2
; LMULMAX1-RV32-NEXT:    lui a2, %hi(.LCPI183_0)
; LMULMAX1-RV32-NEXT:    addi a2, a2, %lo(.LCPI183_0)
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vle32.v v12, (a2)
; LMULMAX1-RV32-NEXT:    vmulhu.vv v9, v8, v12
; LMULMAX1-RV32-NEXT:    vsub.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vmulhu.vv v8, v8, v13
; LMULMAX1-RV32-NEXT:    vadd.vv v9, v8, v9
; LMULMAX1-RV32-NEXT:    lui a2, 4128
; LMULMAX1-RV32-NEXT:    addi a2, a2, 514
; LMULMAX1-RV32-NEXT:    vmv.s.x v8, a2
; LMULMAX1-RV32-NEXT:    vsext.vf4 v11, v8
; LMULMAX1-RV32-NEXT:    vsrl.vv v10, v9, v11
; LMULMAX1-RV32-NEXT:    vmulhu.vv v9, v14, v12
; LMULMAX1-RV32-NEXT:    vsub.vv v8, v14, v9
; LMULMAX1-RV32-NEXT:    vmulhu.vv v8, v8, v13
; LMULMAX1-RV32-NEXT:    vadd.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vsrl.vv v8, v8, v11
; LMULMAX1-RV32-NEXT:    vse32.v v8, (a0)
; LMULMAX1-RV32-NEXT:    vse32.v v10, (a1)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle32.v v10, (a1)
; LMULMAX1-RV64-NEXT:    lui a2, 36976
; LMULMAX1-RV64-NEXT:    addi a2, a2, 1541
; LMULMAX1-RV64-NEXT:    vmv.s.x v9, a2
; LMULMAX1-RV64-NEXT:    vsext.vf4 v8, v9
; LMULMAX1-RV64-NEXT:    vdivu.vv v9, v10, v8
; LMULMAX1-RV64-NEXT:    vdivu.vv v8, v11, v8
...
; LMULMAX2-RV32-NEXT:    vle64.v v10, (a0)
...
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmulhu.vv v14, v10, v8
; LMULMAX2-RV32-NEXT:    vsub.vv v12, v10, v14
; LMULMAX2-RV32-NEXT:    lui a1, 524288
; LMULMAX2-RV32-NEXT:    vmv.s.x v10, a1
; LMULMAX2-RV32-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.i v8, 0
; LMULMAX2-RV32-NEXT:    vsetivli zero, 6, e32, m2, tu, ma
; LMULMAX2-RV32-NEXT:    vslideup.vi v8, v10, 5
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmulhu.vv v8, v12, v8
; LMULMAX2-RV32-NEXT:    vadd.vv v12, v8, v14
; LMULMAX2-RV32-NEXT:    lui a1, %hi(.LCPI184_1)
; LMULMAX2-RV32-NEXT:    addi a1, a1, %lo(.LCPI184_1)
; LMULMAX2-RV32-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vle8.v v10, (a1)
; LMULMAX2-RV32-NEXT:    vsext.vf4 v8, v10
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vsrl.vv v8, v12, v8
...
; LMULMAX2-RV64-NEXT:    vadd.vv v12, v8, v10
; LMULMAX2-RV64-NEXT:    lui a1, 12320
; LMULMAX2-RV64-NEXT:    addi a1, a1, 513
; LMULMAX2-RV64-NEXT:    vmv.s.x v10, a1
; LMULMAX2-RV64-NEXT:    vsext.vf8 v8, v10
; LMULMAX2-RV64-NEXT:    vsrl.vv v8, v12, v8
...
; LMULMAX1-RV32-NEXT:    vmv.s.x v9, a2
; LMULMAX1-RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vsext.vf4 v8, v9
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vdivu.vv v10, v10, v8
...
; LMULMAX1-RV32-NEXT:    vsext.vf4 v8, v9
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vdivu.vv v8, v11, v8
...
; LMULMAX1-RV64-NEXT:    vlse64.v v9, (a2), zero
; LMULMAX1-RV64-NEXT:    lui a2, %hi(.LCPI184_1)
; LMULMAX1-RV64-NEXT:    ld a2, %lo(.LCPI184_1)(a2)
; LMULMAX1-RV64-NEXT:    vsetvli zero, zero, e64, m1, tu, ma
; LMULMAX1-RV64-NEXT:    vmv.s.x v9, a2
; LMULMAX1-RV64-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; LMULMAX1-RV64-NEXT:    vmulhu.vv v9, v8, v9
; LMULMAX1-RV64-NEXT:    vsub.vv v8, v8, v9
; LMULMAX1-RV64-NEXT:    vmulhu.vv v8, v8, v10
; LMULMAX1-RV64-NEXT:    vadd.vv v9, v8, v9
; LMULMAX1-RV64-NEXT:    vid.v v10
; LMULMAX1-RV64-NEXT:    vadd.vi v8, v10, 2
; LMULMAX1-RV64-NEXT:    vsrl.vv v9, v9, v8
...
; LMULMAX1-RV64-NEXT:    vmv.v.x v8, a2
; LMULMAX1-RV64-NEXT:    lui a2, 699051
; LMULMAX1-RV64-NEXT:    addiw a2, a2, -1365
; LMULMAX1-RV64-NEXT:    slli a3, a2, 32
; LMULMAX1-RV64-NEXT:    add a2, a2, a3
; LMULMAX1-RV64-NEXT:    vsetvli zero, zero, e64, m1, tu, ma
; LMULMAX1-RV64-NEXT:    vmv.s.x v8, a2
; LMULMAX1-RV64-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; LMULMAX1-RV64-NEXT:    vmulhu.vv v8, v11, v8
...
; LMULMAX2-NEXT:    li a1, 32
; LMULMAX2-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; LMULMAX2-NEXT:    vle8.v v14, (a0)
; LMULMAX2-NEXT:    vmv.v.i v8, 7
...
; LMULMAX2-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; LMULMAX2-NEXT:    vmv1r.v v0, v12
; LMULMAX2-NEXT:    vmerge.vim v10, v8, 1, v0
; LMULMAX2-NEXT:    li a1, -123
; LMULMAX2-NEXT:    vmv.v.x v8, a1
; LMULMAX2-NEXT:    li a1, 57
; LMULMAX2-NEXT:    vmerge.vxm v8, v8, a1, v0
; LMULMAX2-NEXT:    vmulhu.vv v8, v14, v8
...
; LMULMAX1-NEXT:    vle8.v v11, (a0)
; LMULMAX1-NEXT:    addi a1, a0, 16
; LMULMAX1-NEXT:    vle8.v v10, (a1)
; LMULMAX1-NEXT:    lui a2, 5
; LMULMAX1-NEXT:    addi a2, a2, -1452
; LMULMAX1-NEXT:    vmv.s.x v9, a2
; LMULMAX1-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; LMULMAX1-NEXT:    vmv.v.i v8, -9
; LMULMAX1-NEXT:    vmv1r.v v0, v9
; LMULMAX1-NEXT:    vmerge.vim v8, v8, 9, v0
; LMULMAX1-NEXT:    vdivu.vv v9, v10, v8
; LMULMAX1-NEXT:    vdivu.vv v8, v11, v8
; LMULMAX1-NEXT:    vse8.v v8, (a0)
; LMULMAX1-NEXT:    vse8.v v9, (a1)
; LMULMAX1-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    addi a1, a1, 1755
; LMULMAX2-NEXT:    vmv1r.v v0, v8
; LMULMAX2-NEXT:    vmerge.vxm v8, v12, a1, v0
; LMULMAX2-NEXT:    vmulh.vv v8, v10, v8
; LMULMAX2-NEXT:    vsra.vi v10, v8, 1
; LMULMAX2-NEXT:    vsrl.vi v8, v10, 15
; LMULMAX2-NEXT:    vadd.vv v8, v10, v8
; LMULMAX2-NEXT:    vse16.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-NEXT:    vmv.s.x v9, a2
; LMULMAX1-NEXT:    vmv.v.i v8, 7
; LMULMAX1-NEXT:    vmv.v.v v0, v9
; LMULMAX1-NEXT:    vmerge.vim v8, v8, -7, v0
; LMULMAX1-NEXT:    vdiv.vv v9, v10, v8
; LMULMAX1-NEXT:    vdiv.vv v8, v11, v8
; LMULMAX1-NEXT:    vse16.v v8, (a0)
; LMULMAX1-NEXT:    vse16.v v9, (a1)
; LMULMAX1-NEXT:    ret
  %a = load <16 x i16>, ptr %x
...
; LMULMAX2-RV32:       # %bb.0:
; LMULMAX2-RV32-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vle32.v v10, (a0)
...
; LMULMAX2-RV32-NEXT:    vmerge.vxm v8, v12, a1, v0
; LMULMAX2-RV32-NEXT:    vmulh.vv v8, v10, v8
...
; LMULMAX2-RV64-NEXT:    vle32.v v10, (a0)
...
; LMULMAX2-RV64-NEXT:    vsra.vi v10, v8, 1
; LMULMAX2-RV64-NEXT:    vsrl.vi v8, v10, 31
...
; LMULMAX1-RV32-NEXT:    vmv.v.i v8, 5
; LMULMAX1-RV32-NEXT:    lui a2, 629146
; LMULMAX1-RV32-NEXT:    addi a2, a2, -1639
; LMULMAX1-RV32-NEXT:    vmv.v.v v0, v8
; LMULMAX1-RV32-NEXT:    vmerge.vxm v10, v10, a2, v0
; LMULMAX1-RV32-NEXT:    vmulh.vv v8, v9, v10
; LMULMAX1-RV32-NEXT:    vsrl.vi v9, v8, 31
; LMULMAX1-RV32-NEXT:    vsra.vi v8, v8, 1
; LMULMAX1-RV32-NEXT:    vadd.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vmulh.vv v9, v11, v10
; LMULMAX1-RV32-NEXT:    vsrl.vi v10, v9, 31
...
; LMULMAX1-RV64-NEXT:    vmv.v.x v8, a2
; LMULMAX1-RV64-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-RV64-NEXT:    vdiv.vv v9, v9, v8
; LMULMAX1-RV64-NEXT:    vdiv.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vse32.v v8, (a0)
; LMULMAX1-RV64-NEXT:    vse32.v v9, (a1)
; LMULMAX1-RV64-NEXT:    ret
...
; LMULMAX2-RV32-NEXT:    vmv.s.x v8, a2
; LMULMAX2-RV32-NEXT:    addi a1, a1, 1366
; LMULMAX2-RV32-NEXT:    vmv1r.v v0, v8
; LMULMAX2-RV32-NEXT:    vmerge.vxm v8, v10, a1, v0
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmulh.vv v10, v12, v8
; LMULMAX2-RV32-NEXT:    lui a1, 1048560
; LMULMAX2-RV32-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX2-RV32-NEXT:    vmv.v.x v8, a1
; LMULMAX2-RV32-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vsext.vf4 v14, v8
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vmadd.vv v14, v12, v10
; LMULMAX2-RV32-NEXT:    li a1, 63
; LMULMAX2-RV32-NEXT:    vsrl.vx v12, v14, a1
...
; LMULMAX2-RV32-NEXT:    vsext.vf4 v8, v10
; LMULMAX2-RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV32-NEXT:    vsra.vv v8, v14, v8
...
; LMULMAX2-RV64:       # %bb.0:
; LMULMAX2-RV64-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV64-NEXT:    vle64.v v12, (a0)
...
; LMULMAX2-RV64-NEXT:    vmv.v.i v8, 5
; LMULMAX2-RV64-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; LMULMAX2-RV64-NEXT:    vmv1r.v v0, v8
; LMULMAX2-RV64-NEXT:    vmerge.vxm v8, v10, a1, v0
; LMULMAX2-RV64-NEXT:    vmulh.vv v10, v12, v8
; LMULMAX2-RV64-NEXT:    lui a1, 1044496
; LMULMAX2-RV64-NEXT:    addi a1, a1, -256
; LMULMAX2-RV64-NEXT:    vmv.s.x v8, a1
; LMULMAX2-RV64-NEXT:    vsext.vf8 v14, v8
; LMULMAX2-RV64-NEXT:    vmadd.vv v14, v12, v10
; LMULMAX2-RV64-NEXT:    li a1, 63
; LMULMAX2-RV64-NEXT:    vsrl.vx v12, v14, a1
; LMULMAX2-RV64-NEXT:    lui a1, 4096
; LMULMAX2-RV64-NEXT:    addi a1, a1, 256
; LMULMAX2-RV64-NEXT:    vmv.s.x v10, a1
; LMULMAX2-RV64-NEXT:    vsext.vf8 v8, v10
; LMULMAX2-RV64-NEXT:    vsra.vv v8, v14, v8
...
; LMULMAX1-RV32-NEXT:    vsext.vf4 v8, v9
; LMULMAX1-RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV32-NEXT:    vdiv.vv v9, v10, v8
; LMULMAX1-RV32-NEXT:    vdiv.vv v8, v11, v8
; LMULMAX1-RV32-NEXT:    vse64.v v8, (a0)
...
; LMULMAX1-RV64:       # %bb.0:
; LMULMAX1-RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-RV64-NEXT:    vle64.v v13, (a0)
; LMULMAX1-RV64-NEXT:    addi a1, a0, 16
...
; LMULMAX1-RV64-NEXT:    vle64.v v10, (a1)
; LMULMAX1-RV64-NEXT:    vmv.v.x v12, a2
; LMULMAX1-RV64-NEXT:    vsetvli zero, zero, e64, m1, tu, ma
; LMULMAX1-RV64-NEXT:    vmv.s.x v12, a3
; LMULMAX1-RV64-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; LMULMAX1-RV64-NEXT:    vmulh.vv v9, v10, v12
; LMULMAX1-RV64-NEXT:    vid.v v11
; LMULMAX1-RV64-NEXT:    vrsub.vi v8, v11, 0
; LMULMAX1-RV64-NEXT:    vmacc.vv v9, v8, v10
; LMULMAX1-RV64-NEXT:    li a2, 63
; LMULMAX1-RV64-NEXT:    vsrl.vx v10, v9, a2
; LMULMAX1-RV64-NEXT:    vsra.vv v9, v9, v11
; LMULMAX1-RV64-NEXT:    vadd.vv v10, v9, v10
; LMULMAX1-RV64-NEXT:    vmulh.vv v9, v13, v12
; LMULMAX1-RV64-NEXT:    vmacc.vv v9, v13, v8
; LMULMAX1-RV64-NEXT:    vsrl.vx v8, v9, a2
; LMULMAX1-RV64-NEXT:    vsra.vv v9, v9, v11
; LMULMAX1-RV64-NEXT:    vadd.vv v8, v9, v8
; LMULMAX1-RV64-NEXT:    vse64.v v8, (a0)
; LMULMAX1-RV64-NEXT:    vse64.v v10, (a1)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <4 x i64>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vmin.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vmin.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vmin.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vmin.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vmin.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vmax.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vmax.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vmax.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vmax.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vmax.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vminu.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vminu.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vminu.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vminu.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vminu.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; LMULMAX2-NEXT:    vle8.v v10, (a0)
; LMULMAX2-NEXT:    vle8.v v8, (a1)
; LMULMAX2-NEXT:    vmaxu.vv v8, v10, v8
; LMULMAX2-NEXT:    vse8.v v8, (a0)
; LMULMAX2-NEXT:    ret
;
...
; LMULMAX1-RV32-NEXT:    vle8.v v8, (a3)
; LMULMAX1-RV32-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV32-NEXT:    vmaxu.vv v8, v10, v8
; LMULMAX1-RV32-NEXT:    vmaxu.vv v9, v11, v9
; LMULMAX1-RV32-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV32-NEXT:    ret
;
...
; LMULMAX1-RV64-NEXT:    vle8.v v10, (a2)
; LMULMAX1-RV64-NEXT:    vle8.v v9, (a1)
; LMULMAX1-RV64-NEXT:    vmaxu.vv v8, v10, v8
; LMULMAX1-RV64-NEXT:    vmaxu.vv v9, v11, v9
; LMULMAX1-RV64-NEXT:    vse8.v v9, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v8, (a2)
; LMULMAX1-RV64-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; RV64-NEXT:    vmulh.vx v9, v8, a1
; RV64-NEXT:    li a1, 63
; RV64-NEXT:    vsrl.vx v8, v9, a1
; RV64-NEXT:    vadd.vv v8, v9, v8
; RV64-NEXT:    vse64.v v8, (a0)
; RV64-NEXT:    ret
  %a = load <2 x i64>, ptr %x
