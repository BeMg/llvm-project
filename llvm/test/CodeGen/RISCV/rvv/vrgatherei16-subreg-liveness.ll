...
; NOSUBREG-NEXT:    vmv1r.v v14, v12
; NOSUBREG-NEXT:    vmv1r.v v8, v10
; NOSUBREG-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; NOSUBREG-NEXT:    vmv.v.i v12, 0
; NOSUBREG-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; NOSUBREG-NEXT:    vmv.v.i v11, 0
; NOSUBREG-NEXT:    vsetivli zero, 4, e8, m1, tu, ma
; NOSUBREG-NEXT:    vmv1r.v v10, v11
; NOSUBREG-NEXT:    vrgatherei16.vv v10, v11, v12
; NOSUBREG-NEXT:  .LBB0_1: # %loopIR3.i.i
; NOSUBREG-NEXT:    # =>This Inner Loop Header: Depth=1
; NOSUBREG-NEXT:    vl1r.v v12, (zero)
; NOSUBREG-NEXT:    vsetivli zero, 4, e8, m1, tu, ma
; NOSUBREG-NEXT:    vmv1r.v v11, v14
; NOSUBREG-NEXT:    vrgatherei16.vv v11, v12, v8
; NOSUBREG-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; NOSUBREG-NEXT:    vand.vv v11, v10, v11
; NOSUBREG-NEXT:    vs1r.v v11, (zero)
; NOSUBREG-NEXT:    j .LBB0_1
;
; SUBREG-LABEL: foo:
; SUBREG:       # %bb.0: # %loopIR.preheader.i.i
; SUBREG-NEXT:    vmv1r.v v14, v12
; SUBREG-NEXT:    vmv1r.v v8, v10
; SUBREG-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; SUBREG-NEXT:    vmv.v.i v12, 0
; SUBREG-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; SUBREG-NEXT:    vmv.v.i v11, 0
; SUBREG-NEXT:    vsetivli zero, 4, e8, m1, tu, ma
; SUBREG-NEXT:    vmv1r.v v10, v11
; SUBREG-NEXT:    vrgatherei16.vv v10, v11, v12
; SUBREG-NEXT:  .LBB0_1: # %loopIR3.i.i
; SUBREG-NEXT:    # =>This Inner Loop Header: Depth=1
; SUBREG-NEXT:    vl1r.v v12, (zero)
; SUBREG-NEXT:    vsetivli zero, 4, e8, m1, tu, ma
; SUBREG-NEXT:    vmv1r.v v11, v14
; SUBREG-NEXT:    vrgatherei16.vv v11, v12, v8
; SUBREG-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; SUBREG-NEXT:    vand.vv v11, v10, v11
; SUBREG-NEXT:    vs1r.v v11, (zero)
