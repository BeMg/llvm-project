...
; CHECK-NEXT:    vwredsum.vs v8, v10, v8
; CHECK-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <32 x i8>, ptr %x
...
; CHECK-NEXT:    vwredsum.vs v8, v12, v8
; CHECK-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; CHECK-NEXT:    vwadd.vv v16, v24, v8
...
; CHECK-NEXT:    vslidedown.vx v8, v24, a0
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; CHECK-NEXT:    vwaddu.vv v16, v24, v8
; CHECK-NEXT:    vsetvli zero, zero, e16, m8, ta, ma
; CHECK-NEXT:    vmv.s.x v8, zero
; CHECK-NEXT:    vredsum.vs v8, v16, v8
; CHECK-NEXT:    vmv.x.s a0, v8
...
; RV32-NEXT:    vwredsum.vs v8, v10, v8
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV64-NEXT:    vwredsum.vs v8, v10, v8
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <8 x i32>, ptr %x
...
; RV32-NEXT:    vmv.s.x v8, zero
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV32-NEXT:    vwredsumu.vs v8, v10, v8
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV64-NEXT:    vmv.s.x v8, zero
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV64-NEXT:    vwredsumu.vs v8, v10, v8
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <8 x i32>, ptr %x
...
; RV32-NEXT:    vmv.s.x v8, zero
; RV32-NEXT:    vredsum.vs v8, v16, v8
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV64-NEXT:    vmv.s.x v8, zero
; RV64-NEXT:    vredsum.vs v8, v16, v8
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV32-NEXT:    vwredsum.vs v8, v12, v8
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV64-NEXT:    vwredsum.vs v8, v12, v8
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <16 x i32>, ptr %x
...
; RV32-NEXT:    vmv.s.x v8, zero
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV32-NEXT:    vwredsumu.vs v8, v12, v8
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV64-NEXT:    vmv.s.x v8, zero
; RV64-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV64-NEXT:    vwredsumu.vs v8, v12, v8
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <16 x i32>, ptr %x
...
; RV64-NEXT:    vslidedown.vi v8, v24, 16
; RV64-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV64-NEXT:    vwaddu.vv v16, v24, v8
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    vmv.s.x v8, zero
; RV64-NEXT:    vredsum.vs v8, v16, v8
; RV64-NEXT:    vmv.x.s a0, v8
...
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vs8r.v v8, (a0) # Unknown-size Folded Spill
; RV64-NEXT:    vslidedown.vi v8, v0, 16
; RV64-NEXT:    csrr a0, vlenb
...
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vl8r.v v16, (a0) # Unknown-size Folded Reload
; RV64-NEXT:    vwaddu.vv v8, v24, v16
; RV64-NEXT:    addi a0, sp, 16
; RV64-NEXT:    vs8r.v v8, (a0) # Unknown-size Folded Spill
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    li a1, 24
...
; CHECK-NEXT:    vle8.v v12, (a0)
; CHECK-NEXT:    vmv.s.x v8, zero
; CHECK-NEXT:    vredxor.vs v8, v12, v8
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; CHECK-NEXT:    vle8.v v16, (a0)
; CHECK-NEXT:    vmv.s.x v8, zero
; CHECK-NEXT:    vredxor.vs v8, v16, v8
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <128 x i8>, ptr %x
...
; RV32-NEXT:    vle64.v v16, (a0)
; RV32-NEXT:    vmv.s.x v8, zero
; RV32-NEXT:    vredxor.vs v8, v16, v8
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vle64.v v8, (a0)
; RV32-NEXT:    vredminu.vs v9, v8, v8
; RV32-NEXT:    li a0, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v8, v9, a0
; RV32-NEXT:    vmv.x.s a1, v8
...
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vle64.v v8, (a0)
; RV32-NEXT:    vredmaxu.vs v9, v8, v8
; RV32-NEXT:    li a0, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v8, v9, a0
; RV32-NEXT:    vmv.x.s a1, v8
...
; CHECK-NEXT:    vmul.vv v9, v9, v8
; CHECK-NEXT:    vrgather.vi v8, v9, 1
...
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vle8.v v10, (a0)
; CHECK-NEXT:    vslidedown.vi v8, v10, 16
; CHECK-NEXT:    vmul.vv v10, v10, v8
...
; CHECK-NEXT:    vmul.vv v10, v10, v8
; CHECK-NEXT:    vrgather.vi v8, v10, 1
...
; CHECK-NEXT:    vmul.vv v12, v12, v8
; CHECK-NEXT:    vslidedown.vi v8, v12, 16
; CHECK-NEXT:    vmul.vv v12, v12, v8
; CHECK-NEXT:    vslidedown.vi v8, v12, 8
; CHECK-NEXT:    vmul.vv v12, v12, v8
; CHECK-NEXT:    vslidedown.vi v8, v12, 4
; CHECK-NEXT:    vmul.vv v12, v12, v8
; CHECK-NEXT:    vslidedown.vi v8, v12, 2
; CHECK-NEXT:    vmul.vv v12, v12, v8
; CHECK-NEXT:    vrgather.vi v8, v12, 1
...
; CHECK-NEXT:    vmul.vv v16, v16, v8
; CHECK-NEXT:    vslidedown.vi v8, v16, 8
; CHECK-NEXT:    vmul.vv v16, v16, v8
; CHECK-NEXT:    vslidedown.vi v8, v16, 4
; CHECK-NEXT:    vmul.vv v16, v16, v8
; CHECK-NEXT:    vslidedown.vi v8, v16, 2
; CHECK-NEXT:    vmul.vv v16, v16, v8
; CHECK-NEXT:    vrgather.vi v8, v16, 1
...
; RV32-NEXT:    vmul.vv v16, v16, v8
; RV32-NEXT:    vrgather.vi v8, v16, 1
