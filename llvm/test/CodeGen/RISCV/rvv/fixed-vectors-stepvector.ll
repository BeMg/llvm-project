...
; RV32LMULMAX1-NEXT:    lui a0, 16
; RV32LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v10, v8
; RV32LMULMAX1-NEXT:    lui a0, 48
; RV32LMULMAX1-NEXT:    addi a0, a0, 2
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v9, v8
; RV32LMULMAX1-NEXT:    vmv.v.v v8, v10
; RV32LMULMAX1-NEXT:    ret
;
...
; RV32LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v12, v8
; RV32LMULMAX1-NEXT:    lui a0, 48
; RV32LMULMAX1-NEXT:    addi a0, a0, 2
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v9, v8
...
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v11, v8
; RV32LMULMAX1-NEXT:    vmv.v.v v8, v12
; RV32LMULMAX1-NEXT:    ret
;
...
; RV32LMULMAX2-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV32LMULMAX2-NEXT:    vle8.v v9, (a0)
; RV32LMULMAX2-NEXT:    lui a0, %hi(.LCPI15_1)
; RV32LMULMAX2-NEXT:    addi a0, a0, %lo(.LCPI15_1)
; RV32LMULMAX2-NEXT:    vle8.v v8, (a0)
; RV32LMULMAX2-NEXT:    vsext.vf4 v12, v9
; RV32LMULMAX2-NEXT:    vsext.vf4 v10, v8
; RV32LMULMAX2-NEXT:    vmv.v.v v8, v12
; RV32LMULMAX2-NEXT:    ret
;
...
; RV32LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v16, v8
; RV32LMULMAX1-NEXT:    lui a0, 48
; RV32LMULMAX1-NEXT:    addi a0, a0, 2
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v9, v8
...
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v13, v8
; RV32LMULMAX1-NEXT:    lui a0, 208
; RV32LMULMAX1-NEXT:    addi a0, a0, 12
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v14, v8
; RV32LMULMAX1-NEXT:    lui a0, 240
; RV32LMULMAX1-NEXT:    addi a0, a0, 14
; RV32LMULMAX1-NEXT:    vmv.s.x v8, a0
; RV32LMULMAX1-NEXT:    vsext.vf4 v15, v8
; RV32LMULMAX1-NEXT:    vmv.v.v v8, v16
; RV32LMULMAX1-NEXT:    ret
;
...
; RV32LMULMAX2-NEXT:    vle8.v v8, (a0)
; RV32LMULMAX2-NEXT:    vsext.vf4 v16, v10
; RV32LMULMAX2-NEXT:    vsext.vf4 v10, v12
; RV32LMULMAX2-NEXT:    vsext.vf4 v12, v9
; RV32LMULMAX2-NEXT:    vsext.vf4 v14, v8
; RV32LMULMAX2-NEXT:    vmv.v.v v8, v16
; RV32LMULMAX2-NEXT:    ret
;
