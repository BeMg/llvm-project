...
; CHECK-NEXT:    vmsne.vv v8, v11, v10, v0.t
...
; CHECK-NEXT:    vmsne.vv v9, v10, v14
; CHECK-NEXT:    vmv2r.v v10, v12
; CHECK-NEXT:    vmv1r.v v8, v0
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsne.vv v8, v14, v10, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsne.vv v9, v12, v20
; CHECK-NEXT:    vmv4r.v v12, v16
; CHECK-NEXT:    vmv1r.v v8, v0
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsne.vv v8, v20, v12, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsne.vx v8, v10, a0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsne.vv v8, v11, v10, v0.t
...
; RV64-NEXT:    vmsne.vx v8, v10, a0, v0.t
...
; RV32-NEXT:    vmsne.vv v8, v14, v12, v0.t
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmsne.vx v8, v12, a0, v0.t
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsne.vv v8, v20, v16, v0.t
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsne.vi v8, v10, 9, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsne.mask.nxv1i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsne.vi v8, v12, 9, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i1> @llvm.riscv.vmsne.mask.nxv16i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vmsne.vi v8, v16, 9, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i1> @llvm.riscv.vmsne.mask.nxv32i8.i8(
