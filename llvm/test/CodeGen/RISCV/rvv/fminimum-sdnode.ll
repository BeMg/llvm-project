...
; ZVFH-NEXT:    vmfeq.vv v8, v9, v9
; ZVFH-NEXT:    vmerge.vvm v9, v11, v9, v0
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    vmerge.vvm v8, v10, v11, v0
...
; ZVFHMIN-NEXT:    vmfeq.vv v8, v14, v14
; ZVFHMIN-NEXT:    vmv1r.v v0, v9
; ZVFHMIN-NEXT:    vmerge.vvm v10, v12, v14, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
...
; ZVFH-NEXT:    vmfeq.vv v9, v14, v14
; ZVFH-NEXT:    vmfeq.vv v8, v10, v10
; ZVFH-NEXT:    vmv1r.v v0, v9
; ZVFH-NEXT:    vmerge.vvm v10, v14, v10, v0
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    vmerge.vvm v8, v12, v14, v0
...
; ZVFHMIN-NEXT:    vmfeq.vv v9, v16, v16
; ZVFHMIN-NEXT:    vmfeq.vv v8, v20, v20
; ZVFHMIN-NEXT:    vmv1r.v v0, v9
; ZVFHMIN-NEXT:    vmerge.vvm v12, v16, v20, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vmv4r.v v16, v12
; ZVFH-NEXT:    vmv4r.v v20, v8
; ZVFH-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vmfeq.vv v9, v20, v20
; ZVFH-NEXT:    vmfeq.vv v8, v12, v12
; ZVFH-NEXT:    vmv1r.v v0, v9
; ZVFH-NEXT:    vmerge.vvm v12, v20, v12, v0
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    vmerge.vvm v8, v16, v20, v0
...
; CHECK-NEXT:    vmfeq.vv v9, v14, v14
...
; CHECK-NEXT:    vmfeq.vv v9, v20, v20
; CHECK-NEXT:    vmfeq.vv v8, v12, v12
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmerge.vvm v12, v20, v12, v0
; CHECK-NEXT:    vmv1r.v v0, v8
...
; ZVFH-NEXT:    vfadd.vv v8, v11, v11, v0.t
; ZVFH-NEXT:    vfmin.vv v8, v8, v9
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v10
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfadd.vv v10, v8, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v10
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v11, v9
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
...
; ZVFH-NEXT:    vsetvli a0, zero, e16, mf4, ta, mu
; ZVFH-NEXT:    vmfeq.vv v0, v8, v8
; ZVFH-NEXT:    vfadd.vv v8, v9, v9, v0.t
