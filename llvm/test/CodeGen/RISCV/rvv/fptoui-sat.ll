...
; CHECK-NEXT:    vsetvli a0, zero, e32, m1, ta, ma
; CHECK-NEXT:    vmfne.vv v0, v8, v8
; CHECK-NEXT:    vfwcvt.rtz.xu.f.v v8, v11
...
; CHECK-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; CHECK-NEXT:    vmfne.vv v12, v8, v8
; CHECK-NEXT:    vfwcvt.rtz.xu.f.v v8, v14
...
; CHECK32-NEXT:    vfmin.vf v12, v8, fa5
; CHECK32-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; CHECK32-NEXT:    vfncvt.rtz.xu.f.w v10, v12
; CHECK32-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK32-NEXT:    vnsrl.wi v8, v10, 0
; CHECK32-NEXT:    ret
;
...
; CHECK64-NEXT:    vfmin.vf v12, v8, fa5
; CHECK64-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; CHECK64-NEXT:    vfncvt.rtz.xu.f.w v10, v12
; CHECK64-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK64-NEXT:    vnsrl.wi v8, v10, 0
; CHECK64-NEXT:    ret
...
; CHECK32-NEXT:    vfmax.vf v8, v8, fa4
; CHECK32-NEXT:    vfmin.vf v16, v8, fa5
; CHECK32-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK32-NEXT:    vfncvt.rtz.xu.f.w v12, v16
...
; CHECK64-NEXT:    vfmax.vf v8, v8, fa4
; CHECK64-NEXT:    vfmin.vf v16, v8, fa5
; CHECK64-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK64-NEXT:    vfncvt.rtz.xu.f.w v12, v16
