...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vmv.v.i v24, 0
; ZVFHMIN-NEXT:    vmerge.vim v8, v24, -1, v0
; ZVFHMIN-NEXT:    vfwcvt.f.x.v v16, v8
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v16
; ZVFHMIN-NEXT:    csrr a0, vlenb
; ZVFHMIN-NEXT:    srli a0, a0, 2
; ZVFHMIN-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslidedown.vx v16, v0, a0
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vmv1r.v v0, v16
; ZVFHMIN-NEXT:    vmerge.vim v24, v24, -1, v0
...
; ZVFHMIN-NEXT:    vand.vx v9, v8, a0
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vzext.vf2 v8, v9
; ZVFHMIN-NEXT:    vfwcvt.f.xu.v v9, v8
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v9
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vmv4r.v v16, v8
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vzext.vf2 v8, v16
; ZVFHMIN-NEXT:    vfwcvt.f.xu.v v24, v8
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v24
; ZVFHMIN-NEXT:    vzext.vf2 v24, v18
; ZVFHMIN-NEXT:    vfwcvt.f.xu.v v16, v24
; ZVFHMIN-NEXT:    vfncvt.f.f.w v12, v16
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.x.v v16, v24
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v16
; ZVFHMIN-NEXT:    vfwcvt.f.x.v v16, v28
; ZVFHMIN-NEXT:    vfncvt.f.f.w v12, v16
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.xu.v v16, v24
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v16
; ZVFHMIN-NEXT:    vfwcvt.f.xu.v v16, v28
; ZVFHMIN-NEXT:    vfncvt.f.f.w v12, v16
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vmv2r.v v10, v8
; ZVFH-NEXT:    vsetvli a0, zero, e16, m1, ta, ma
; ZVFH-NEXT:    vfncvt.f.xu.w v8, v10
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv4r.v v12, v8
; ZVFH-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvt.f.xu.w v8, v12
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vmv8r.v v16, v8
; ZVFH-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vfncvt.f.xu.w v8, v16
; ZVFH-NEXT:    ret
;
...
; CHECK-NEXT:    vmv2r.v v10, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m1, ta, ma
; CHECK-NEXT:    vfncvt.f.xu.w v9, v10
; CHECK-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; CHECK-NEXT:    vfncvt.f.f.w v8, v9
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv2r.v v10, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m1, ta, ma
; CHECK-NEXT:    vfncvt.f.x.w v8, v10
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv2r.v v10, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m1, ta, ma
; CHECK-NEXT:    vfncvt.f.xu.w v8, v10
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; CHECK-NEXT:    vfncvt.f.x.w v10, v12
...
; CHECK-NEXT:    vmv4r.v v12, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; CHECK-NEXT:    vfncvt.f.xu.w v10, v12
; CHECK-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK-NEXT:    vfncvt.f.f.w v8, v10
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv4r.v v12, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; CHECK-NEXT:    vfncvt.f.x.w v8, v12
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv4r.v v12, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; CHECK-NEXT:    vfncvt.f.xu.w v8, v12
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfncvt.f.x.w v12, v16
...
; CHECK-NEXT:    vmv8r.v v16, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfncvt.f.xu.w v12, v16
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vfncvt.f.f.w v8, v12
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v16, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfncvt.f.x.w v8, v16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv8r.v v16, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfncvt.f.xu.w v8, v16
; CHECK-NEXT:    ret
