...
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    vmerge.vim v8, v9, 5, v0
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vrgather.vi v8, v11, 1, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, mu
; CHECK-NEXT:    vid.v v8
; CHECK-NEXT:    vrsub.vi v10, v8, 4
; CHECK-NEXT:    vmv.v.i v9, 12
...
; RV32-NEXT:    li a0, 5
; RV32-NEXT:    vslide1down.vx v14, v8, a0
; RV32-NEXT:    lui a0, %hi(.LCPI11_0)
; RV32-NEXT:    addi a0, a0, %lo(.LCPI11_0)
; RV32-NEXT:    vle16.v v13, (a0)
; RV32-NEXT:    vsetvli zero, zero, e64, m4, ta, mu
; RV32-NEXT:    li a0, 164
; RV32-NEXT:    vmv.s.x v12, a0
; RV32-NEXT:    vrgatherei16.vv v8, v20, v13
; RV32-NEXT:    vmv1r.v v0, v12
; RV32-NEXT:    vrgatherei16.vv v8, v16, v14, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vrgatherei16.vv v8, v20, v12
; RV64-NEXT:    li a0, 164
...
; RV32-NEXT:    vmv1r.v v0, v12
; RV32-NEXT:    vrgatherei16.vv v8, v20, v13, v0.t
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vrgatherei16.vv v8, v12, v17, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    vle16.v v13, (a0)
; RV64-NEXT:    li a0, 115
; RV64-NEXT:    vmv.s.x v12, a0
; RV64-NEXT:    vmv.v.i v8, 5
...
; CHECK-NEXT:    vrgather.vi v8, v9, 4
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    li a0, 66
; CHECK-NEXT:    vmv.s.x v9, a0
; CHECK-NEXT:    vrgather.vi v8, v11, 2
; CHECK-NEXT:    vmv1r.v v0, v9
...
; CHECK-NEXT:    vrgather.vv v8, v12, v10
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vrgather.vi v8, v11, 0, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv1r.v v9, v8
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; CHECK-NEXT:    vrgather.vi v8, v9, 2
...
; CHECK-NEXT:    li a0, 70
; CHECK-NEXT:    vmv.s.x v9, a0
; CHECK-NEXT:    vrgather.vi v8, v12, 2
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vrgather.vv v8, v11, v10, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslideup.vi v11, v8, 5
; CHECK-NEXT:    lui a0, 8256
...
; CHECK-NEXT:    li a0, 98
; CHECK-NEXT:    vmv.s.x v9, a0
; CHECK-NEXT:    vrgather.vv v8, v13, v10
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vrgather.vv v8, v12, v11, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, mu
; CHECK-NEXT:    vid.v v8
; CHECK-NEXT:    vadd.vi v11, v8, 2
; CHECK-NEXT:    lui a0, %hi(.LCPI46_0)
; CHECK-NEXT:    addi a0, a0, %lo(.LCPI46_0)
; CHECK-NEXT:    vle8.v v10, (a0)
; CHECK-NEXT:    li a0, 234
; CHECK-NEXT:    vmv.s.x v9, a0
; CHECK-NEXT:    vrgather.vv v8, v13, v11
; CHECK-NEXT:    vmv1r.v v0, v9
