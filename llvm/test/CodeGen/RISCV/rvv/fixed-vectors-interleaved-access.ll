...
; RV32-NEXT:    vmerge.vvm v12, v8, v16, v0
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a4, 88
; RV32-NEXT:    mul a1, a1, a4
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vrgatherei16.vv v16, v12, v8
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a3, 12
; RV32-NEXT:    mul a1, a1, a3
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v16, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v0, v16, v8
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl4r.v v12, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v24, v12, v8
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl4r.v v12, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v4, v12, v8
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 6
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xd5, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 85 * vlenb
...
; RV64-NEXT:    vs4r.v v24, (a3) # Unknown-size Folded Spill
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    vrgatherei16.vv v28, v16, v24, v0.t
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    vrgatherei16.vv v24, v8, v7, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a3, 57
; RV64-NEXT:    mul a1, a1, a3
; RV64-NEXT:    add a1, sp, a1
