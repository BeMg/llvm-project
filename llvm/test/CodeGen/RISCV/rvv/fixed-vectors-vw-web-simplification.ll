...
; NO_FOLDING-NEXT:    vmul.vv v9, v11, v8
; NO_FOLDING-NEXT:    vadd.vv v8, v11, v10
; NO_FOLDING-NEXT:    vsub.vv v10, v11, v10
...
; FOLDING-NEXT:    vle8.v v12, (a0)
; FOLDING-NEXT:    vle8.v v8, (a1)
; FOLDING-NEXT:    vle8.v v11, (a2)
; FOLDING-NEXT:    vwmul.vv v10, v12, v8
; FOLDING-NEXT:    vwadd.vv v9, v12, v11
; FOLDING-NEXT:    vwsub.vv v8, v12, v11
; FOLDING-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; FOLDING-NEXT:    vor.vv v9, v10, v9
