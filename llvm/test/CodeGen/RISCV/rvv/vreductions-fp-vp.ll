...
; ZVFH-NEXT:    vfredusum.vs v8, v10, v8, v0.t
...
; ZVFH-NEXT:    vfmv.s.f v8, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; ZVFH-NEXT:    vfredosum.vs v8, v10, v8, v0.t
; ZVFH-NEXT:    vfmv.f.s fa0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vslidedown.vx v9, v0, a1
...
; ZVFH-NEXT:    vfredusum.vs v8, v24, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, a1, e16, m8, ta, ma
; ZVFH-NEXT:    vmv1r.v v0, v9
; ZVFH-NEXT:    vfredusum.vs v8, v16, v8, v0.t
; ZVFH-NEXT:    vfmv.f.s fa0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vslidedown.vx v17, v0, a1
...
; ZVFHMIN-NEXT:    vslidedown.vx v18, v0, a3
...
; ZVFHMIN-NEXT:    vfmv.s.f v16, fa5
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vfredusum.vs v16, v8, v16, v0.t
...
; ZVFHMIN-NEXT:    vfredusum.vs v16, v24, v16, v0.t
; ZVFHMIN-NEXT:    vfmv.f.s fa5, v16
; ZVFHMIN-NEXT:    fcvt.h.s fa5, fa5
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa5
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m8, ta, ma
...
; ZVFHMIN-NEXT:    vslidedown.vx v17, v17, a3
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    addi a0, sp, 16
; ZVFHMIN-NEXT:    vl8r.v v8, (a0) # Unknown-size Folded Reload
...
; ZVFH-NEXT:    vfmv.s.f v8, fa0
; ZVFH-NEXT:    vsetvli zero, a0, e16, m8, ta, ma
; ZVFH-NEXT:    vfredosum.vs v8, v24, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, a1, e16, m8, ta, ma
; ZVFH-NEXT:    vmv1r.v v0, v9
; ZVFH-NEXT:    vfredosum.vs v8, v16, v8, v0.t
; ZVFH-NEXT:    vfmv.f.s fa0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfmv.s.f v16, fa5
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vfredosum.vs v16, v8, v16, v0.t
; ZVFHMIN-NEXT:    vfmv.f.s fa5, v16
; ZVFHMIN-NEXT:    fcvt.h.s fa5, fa5
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa5
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m8, ta, ma
...
; ZVFHMIN-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmv1r.v v0, v17
; ZVFHMIN-NEXT:    vfredosum.vs v16, v24, v16, v0.t
; ZVFHMIN-NEXT:    vfmv.f.s fa5, v16
; ZVFHMIN-NEXT:    fcvt.h.s fa5, fa5
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa5
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m8, ta, ma
...
; CHECK-NEXT:    vfredusum.vs v8, v12, v8, v0.t
; CHECK-NEXT:    vfmv.f.s fa0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfmv.s.f v8, fa0
; CHECK-NEXT:    vsetvli zero, a0, e32, m2, ta, ma
; CHECK-NEXT:    vfredosum.vs v8, v12, v8, v0.t
; CHECK-NEXT:    vfmv.f.s fa0, v8
; CHECK-NEXT:    ret
