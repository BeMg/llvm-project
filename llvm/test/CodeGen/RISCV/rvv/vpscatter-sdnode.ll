...
; RV32-NEXT:    vwaddu.vv v8, v10, v10
; RV32-NEXT:    vsetvli zero, a1, e16, m2, ta, ma
...
; RV64-NEXT:    vwaddu.vv v8, v10, v10
; RV64-NEXT:    vsetvli zero, a1, e16, m2, ta, ma
...
; RV64-NEXT:    vsetvli a2, zero, e64, m8, ta, ma
; RV64-NEXT:    vsext.vf4 v8, v18
; RV64-NEXT:    vadd.vv v8, v8, v8
; RV64-NEXT:    vsetvli zero, a1, e16, m2, ta, ma
; RV64-NEXT:    vsoxei64.v v20, (a0), v8, v0.t
; RV64-NEXT:    ret
...
; RV32-NEXT:    vsll.vi v8, v8, 2
; RV32-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; RV32-NEXT:    vsoxei16.v v16, (a0), v8, v0.t
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vsoxei32.v v24, (a0), v8, v0.t
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vmv8r.v v24, v8
; RV32-NEXT:    vsetvli a2, zero, e16, m2, ta, ma
; RV32-NEXT:    vzext.vf2 v8, v16
; RV32-NEXT:    vsll.vi v8, v8, 3
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vsoxei16.v v24, (a0), v8, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsll.vi v8, v8, 3
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vsoxei16.v v24, (a0), v8, v0.t
; RV64-NEXT:    ret
...
; RV64-NEXT:    vsll.vi v8, v8, 3
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vsoxei32.v v24, (a0), v8, v0.t
; RV64-NEXT:    ret
...
; RV32-NEXT:    vslidedown.vx v8, v1, a0
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
...
; RV64-NEXT:    vslidedown.vx v8, v1, a1
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
...
; RV32-NEXT:    vslidedown.vx v8, v28, a1
; RV32-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    addi a1, sp, 16
...
; RV64-NEXT:    srli a1, a1, 3
; RV64-NEXT:    vsetvli a3, zero, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vx v8, v28, a1
; RV64-NEXT:    vsetvli zero, a2, e64, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    addi a1, sp, 16
; RV64-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
