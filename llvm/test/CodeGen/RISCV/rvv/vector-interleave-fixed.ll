...
; CHECK-NEXT:    vwaddu.vv v10, v8, v12
; CHECK-NEXT:    li a1, -1
; CHECK-NEXT:    vwmaccu.vx v10, a1, v12
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, ma
...
; ZVBB-NEXT:    vslidedown.vi v8, v12, 16
; ZVBB-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; ZVBB-NEXT:    vwsll.vi v10, v8, 8
; ZVBB-NEXT:    vwaddu.wv v10, v10, v12
; ZVBB-NEXT:    vsetvli zero, a0, e8, m2, ta, ma
...
; ZVBB-NEXT:    vmv.s.x v8, a0
; ZVBB-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; ZVBB-NEXT:    vsext.vf2 v10, v8
; ZVBB-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; ZVBB-NEXT:    vrgatherei16.vv v8, v12, v10
; ZVBB-NEXT:    ret
