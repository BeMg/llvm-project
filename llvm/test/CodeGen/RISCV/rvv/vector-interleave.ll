...
; CHECK-NEXT:    vand.vi v10, v11, 1
; CHECK-NEXT:    vmsne.vi v0, v10, 0
; CHECK-NEXT:    vsrl.vi v12, v11, 1
...
; ZVBB-NEXT:    vid.v v11
; ZVBB-NEXT:    vand.vi v10, v11, 1
; ZVBB-NEXT:    vmsne.vi v0, v10, 0
; ZVBB-NEXT:    vsrl.vi v12, v11, 1
; ZVBB-NEXT:    vadd.vx v12, v12, a0, v0.t
; ZVBB-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; ZVBB-NEXT:    vmv2r.v v16, v8
; ZVBB-NEXT:    vrgatherei16.vv v8, v16, v12
; ZVBB-NEXT:    ret
...
; CHECK-NEXT:    li a0, -1
; CHECK-NEXT:    vwmaccu.vx v8, a0, v24
; CHECK-NEXT:    vsetvli a1, zero, e8, m8, ta, ma
; CHECK-NEXT:    vmsne.vi v0, v8, 0
; CHECK-NEXT:    vsetvli a1, zero, e8, m4, ta, ma
; CHECK-NEXT:    vwaddu.vv v8, v20, v28
; CHECK-NEXT:    vwmaccu.vx v8, a0, v28
; CHECK-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
...
; ZVBB-NEXT:    vmv.v.i v8, 0
; ZVBB-NEXT:    vmerge.vim v24, v8, 1, v0
...
; ZVBB-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; ZVBB-NEXT:    vwsll.vi v8, v20, 8
; ZVBB-NEXT:    vwaddu.wv v8, v8, v28
; ZVBB-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; ZVBB-NEXT:    vmsne.vi v16, v8, 0
; ZVBB-NEXT:    vmv1r.v v8, v16
; ZVBB-NEXT:    ret
...
; CHECK-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; CHECK-NEXT:    vwaddu.vv v8, v0, v24
; CHECK-NEXT:    li a0, -1
; CHECK-NEXT:    vwmaccu.vx v8, a0, v24
; CHECK-NEXT:    vwaddu.vv v16, v4, v28
...
; ZVBB-NEXT:    vwaddu.wv v8, v8, v0
; ZVBB-NEXT:    vwsll.vi v16, v28, 8
; ZVBB-NEXT:    vwaddu.wv v16, v16, v4
; ZVBB-NEXT:    ret
...
; CHECK-NEXT:    vand.vi v10, v12, 1
; CHECK-NEXT:    vmsne.vi v8, v10, 0
; CHECK-NEXT:    vsrl.vi v2, v12, 1
...
; ZVBB-NEXT:    vid.v v12
; ZVBB-NEXT:    vand.vi v10, v12, 1
; ZVBB-NEXT:    vmsne.vi v8, v10, 0
; ZVBB-NEXT:    vsrl.vi v2, v12, 1
...
; ZVBB-NEXT:    vrgatherei16.vv v8, v24, v2
