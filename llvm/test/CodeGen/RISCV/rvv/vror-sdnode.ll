...
; CHECK-NEXT:    vsrl.vv v12, v16, v12
; CHECK-NEXT:    vrsub.vi v8, v8, 0
; CHECK-NEXT:    vand.vi v8, v8, 7
; CHECK-NEXT:    vsll.vv v8, v16, v8
; CHECK-NEXT:    vor.vv v8, v12, v8
...
; CHECK-NEXT:    vsrl.vv v16, v24, v8
; CHECK-NEXT:    vrsub.vi v8, v0, 0
; CHECK-NEXT:    vand.vi v8, v8, 7
; CHECK-NEXT:    vsll.vv v8, v24, v8
...
; CHECK-NEXT:    vsrl.vv v16, v24, v16
; CHECK-NEXT:    vrsub.vi v8, v8, 0
; CHECK-NEXT:    vand.vi v8, v8, 7
; CHECK-NEXT:    vsll.vv v8, v24, v8
; CHECK-NEXT:    vor.vv v8, v16, v8
...
; CHECK-RV64-NEXT:    vsrl.vv v9, v10, v9
...
; CHECK-RV64-NEXT:    vsrl.vv v10, v12, v10
; CHECK-RV64-NEXT:    vrsub.vi v8, v8, 0
; CHECK-RV64-NEXT:    vand.vx v8, v8, a0
; CHECK-RV64-NEXT:    vsll.vv v8, v12, v8
...
; CHECK-RV64-NEXT:    vsrl.vv v12, v16, v12
; CHECK-RV64-NEXT:    vrsub.vi v8, v8, 0
; CHECK-RV64-NEXT:    vand.vx v8, v8, a0
; CHECK-RV64-NEXT:    vsll.vv v8, v16, v8
...
; CHECK-RV64-NEXT:    vsrl.vv v16, v24, v16
; CHECK-RV64-NEXT:    vrsub.vi v8, v8, 0
; CHECK-RV64-NEXT:    vand.vx v8, v8, a0
; CHECK-RV64-NEXT:    vsll.vv v8, v24, v8
...
; CHECK-RV32-NEXT:    vsrl.vv v9, v10, v9
...
; CHECK-RV32-NEXT:    vsrl.vv v10, v12, v10
; CHECK-RV32-NEXT:    vrsub.vi v8, v8, 0
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsll.vv v8, v12, v8
; CHECK-RV32-NEXT:    vor.vv v8, v10, v8
; CHECK-RV32-NEXT:    ret
;
...
; CHECK-RV32-NEXT:    vsrl.vv v12, v16, v12
; CHECK-RV32-NEXT:    vrsub.vi v8, v8, 0
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsll.vv v8, v16, v8
; CHECK-RV32-NEXT:    vor.vv v8, v12, v8
; CHECK-RV32-NEXT:    ret
;
...
; CHECK-RV32-NEXT:    vsrl.vv v16, v24, v16
; CHECK-RV32-NEXT:    vrsub.vi v8, v8, 0
; CHECK-RV32-NEXT:    vand.vx v8, v8, a0
; CHECK-RV32-NEXT:    vsll.vv v8, v24, v8
; CHECK-RV32-NEXT:    vor.vv v8, v16, v8
; CHECK-RV32-NEXT:    ret
;
