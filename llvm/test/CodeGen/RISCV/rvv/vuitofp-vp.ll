...
; ZVFHMIN-NEXT:    vand.vx v9, v8, a1
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vzext.vf2 v8, v9, v0.t
...
; ZVFH-NEXT:    vsetvli zero, a0, e8, mf4, ta, ma
; ZVFH-NEXT:    vfwcvt.f.xu.v v8, v10, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vzext.vf2 v8, v10, v0.t
; ZVFHMIN-NEXT:    vfwcvt.f.xu.v v9, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v9
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vmv1r.v v10, v8
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfncvt.f.xu.w v8, v10, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vfncvt.f.xu.w v9, v12, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; ZVFH-NEXT:    vfncvt.f.f.w v8, v9, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.xu.w v9, v12, v0.t
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v9
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFH-NEXT:    vfncvt.f.xu.w v9, v10
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
...
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.xu.w v9, v10
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v9
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vslidedown.vx v8, v0, a2
...
; ZVFH-NEXT:    vfncvt.f.xu.w v12, v16, v0.t
...
; ZVFH-NEXT:    vfncvt.f.xu.w v8, v24, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfcvt.f.xu.v v16, v24, v0.t
