...
; CHECK-NEXT:    vmsbc.vvm v8, v10, v9, v0
...
; CHECK-NEXT:    vmsbc.vvm v8, v12, v10, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vvm v8, v16, v12, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vvm v8, v24, v16, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vxm v8, v10, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vxm v8, v12, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vxm v8, v16, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vxm v8, v24, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsbc.vvm v8, v10, v9, v0
...
; RV64-NEXT:    vmsbc.vxm v8, v10, a0, v0
...
; RV32-NEXT:    vmsbc.vvm v8, v12, v10, v0
...
; RV64-NEXT:    vmsbc.vxm v8, v12, a0, v0
...
; RV32-NEXT:    vmsbc.vvm v8, v16, v12, v0
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmsbc.vxm v8, v16, a0, v0
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsbc.vvm v8, v24, v16, v0
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmsbc.vxm v8, v24, a0, v0
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    ret
entry:
