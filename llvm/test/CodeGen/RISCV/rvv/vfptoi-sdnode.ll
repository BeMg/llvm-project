...
; ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v9
...
; ZVFH-NEXT:    vmv1r.v v9, v8
; ZVFH-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v9
; ZVFH-NEXT:    vand.vi v8, v8, 1
; ZVFH-NEXT:    vmsne.vi v0, v8, 0
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v10
; ZVFH-NEXT:    vand.vi v8, v8, 1
; ZVFH-NEXT:    vmsne.vi v0, v8, 0
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vand.vi v10, v8, 1
; ZVFHMIN-NEXT:    vmsne.vi v8, v10, 0
...
; ZVFH-NEXT:    vmv2r.v v10, v8
; ZVFH-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v10
; ZVFH-NEXT:    vand.vi v8, v8, 1
; ZVFH-NEXT:    vmsne.vi v0, v8, 0
; ZVFH-NEXT:    ret
;
...
; ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v12
; ZVFH-NEXT:    vand.vi v10, v8, 1
; ZVFH-NEXT:    vmsne.vi v8, v10, 0
...
; ZVFHMIN-NEXT:    vand.vi v12, v8, 1
; ZVFHMIN-NEXT:    vmsne.vi v8, v12, 0
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vmv4r.v v12, v8
; ZVFH-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v12
; ZVFH-NEXT:    vand.vi v10, v8, 1
; ZVFH-NEXT:    vmsne.vi v8, v10, 0
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
...
; ZVFH-NEXT:    vfncvt.rtz.x.f.w v8, v16
; ZVFH-NEXT:    vand.vi v12, v8, 1
; ZVFH-NEXT:    vmsne.vi v8, v12, 0
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfncvt.rtz.x.f.w v8, v16
; ZVFHMIN-NEXT:    vand.vi v12, v8, 1
; ZVFHMIN-NEXT:    vmsne.vi v9, v12, 0
...
; ZVFH-NEXT:    vmv8r.v v16, v8
; ZVFH-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; ZVFH-NEXT:    vfncvt.rtz.xu.f.w v8, v16
; ZVFH-NEXT:    vand.vi v12, v8, 1
; ZVFH-NEXT:    vmsne.vi v8, v12, 0
; ZVFH-NEXT:    vmv1r.v v0, v8
; ZVFH-NEXT:    ret
