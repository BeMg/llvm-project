...
; LMULMAX1-RV32-NEXT:    vlse64.v v13, (a5), zero
...
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vor.vv v11, v8, v10
; LMULMAX1-RV32-NEXT:    vand.vv v8, v12, v13
; LMULMAX1-RV32-NEXT:    vsll.vi v9, v8, 8
...
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v10
; LMULMAX1-RV32-NEXT:    vor.vv v12, v8, v11
; LMULMAX1-RV32-NEXT:    vsrl.vx v9, v14, a2
; LMULMAX1-RV32-NEXT:    vsrl.vx v8, v14, a3
; LMULMAX1-RV32-NEXT:    vand.vx v8, v8, a4
; LMULMAX1-RV32-NEXT:    vor.vv v10, v8, v9
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v14, 24
; LMULMAX1-RV32-NEXT:    vand.vx v9, v8, a5
; LMULMAX1-RV32-NEXT:    vsrl.vi v8, v14, 8
; LMULMAX1-RV32-NEXT:    vand.vv v8, v8, v13
; LMULMAX1-RV32-NEXT:    vor.vv v8, v8, v9
; LMULMAX1-RV32-NEXT:    vor.vv v11, v8, v10
; LMULMAX1-RV32-NEXT:    vsll.vx v9, v14, a2
; LMULMAX1-RV32-NEXT:    vand.vx v8, v14, a4
; LMULMAX1-RV32-NEXT:    vsll.vx v8, v8, a3
; LMULMAX1-RV32-NEXT:    vor.vv v10, v9, v8
; LMULMAX1-RV32-NEXT:    vand.vx v8, v14, a5
; LMULMAX1-RV32-NEXT:    vsll.vi v9, v8, 24
; LMULMAX1-RV32-NEXT:    vand.vv v8, v14, v13
; LMULMAX1-RV32-NEXT:    vsll.vi v8, v8, 8
; LMULMAX1-RV32-NEXT:    vor.vv v8, v9, v8
...
; LMULMAX1-RV64-NEXT:    vor.vv v8, v8, v10
; LMULMAX1-RV64-NEXT:    vor.vv v12, v8, v11
