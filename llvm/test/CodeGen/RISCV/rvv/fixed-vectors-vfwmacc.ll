...
; CHECK-NEXT:    vfwmacc.vv v8, v10, v9
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfwcvt.f.f.v v9, v11
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vfwnmacc.vv v8, v10, v9
; CHECK-NEXT:    ret
  %vd = fpext <1 x half> %vb to <1 x double>
  %ve = fpext <1 x half> %vc to <1 x double>
  %vf = fneg <1 x double> %va
...
; CHECK-NEXT:    vfwcvt.f.f.v v9, v11
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vfwmsac.vv v8, v10, v9
; CHECK-NEXT:    ret
  %vd = fpext <1 x half> %vb to <1 x double>
  %ve = fpext <1 x half> %vc to <1 x double>
  %vf = fneg <1 x double> %va
...
; CHECK-NEXT:    vfwcvt.f.f.v v9, v11
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vfwnmsac.vv v8, v10, v9
; CHECK-NEXT:    ret
  %vd = fpext <1 x half> %vb to <1 x double>
  %ve = fpext <1 x half> %vc to <1 x double>
  %vf = fneg <1 x double> %vd
...
; CHECK-NEXT:    vfwmacc.vv v8, v11, v10
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfwcvt.f.f.v v10, v12
; CHECK-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; CHECK-NEXT:    vfwnmacc.vv v8, v11, v10
; CHECK-NEXT:    ret
  %vd = fpext <4 x half> %vb to <4 x double>
  %ve = fpext <4 x half> %vc to <4 x double>
  %vf = fneg <4 x double> %va
...
; CHECK-NEXT:    vfwcvt.f.f.v v10, v12
; CHECK-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; CHECK-NEXT:    vfwmsac.vv v8, v11, v10
; CHECK-NEXT:    ret
  %vd = fpext <4 x half> %vb to <4 x double>
  %ve = fpext <4 x half> %vc to <4 x double>
  %vf = fneg <4 x double> %va
...
; CHECK-NEXT:    vfwcvt.f.f.v v10, v12
; CHECK-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; CHECK-NEXT:    vfwnmsac.vv v8, v11, v10
; CHECK-NEXT:    ret
  %vd = fpext <4 x half> %vb to <4 x double>
  %ve = fpext <4 x half> %vc to <4 x double>
  %vf = fneg <4 x double> %vd
