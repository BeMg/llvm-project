...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vwadd.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v10, v8
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vwmul.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v10, v8
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vwmacc.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v10, v8
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    vfwadd.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v10, v8
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    vfwmul.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v10, v8
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    vfwmacc.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v10, v8
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmfeq.vv v8, v9, v10, v0.t
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
