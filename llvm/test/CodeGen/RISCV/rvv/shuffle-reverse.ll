...
; CHECK-NEXT:    vrsub.vi v9, v10, 7
; CHECK-NEXT:    vrgather.vv v8, v12, v9
; CHECK-NEXT:    vmv.v.i v9, 15
; CHECK-NEXT:    vrsub.vi v10, v10, 3
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vrgather.vv v8, v11, v10, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vrgather.vv v8, v14, v12
; CHECK-NEXT:    vid.v v12
; CHECK-NEXT:    vrsub.vi v14, v12, 15
...
; CHECK-NEXT:    vrsub.vi v12, v14, 15
; CHECK-NEXT:    vrgather.vv v8, v16, v12
; CHECK-NEXT:    vrsub.vi v14, v14, 7
; CHECK-NEXT:    li a0, 255
; CHECK-NEXT:    vmv.s.x v12, a0
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vrgather.vv v8, v10, v14, v0.t
...
; CHECK-NEXT:    vrsub.vi v20, v16, 15
; CHECK-NEXT:    lui a0, 16
; CHECK-NEXT:    addi a0, a0, -1
; CHECK-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
...
; CHECK-NEXT:    vrsub.vi v12, v13, 7
; CHECK-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v8, v14, v12
; CHECK-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK-NEXT:    vrsub.vi v13, v13, 3
; CHECK-NEXT:    vmv.v.i v12, 15
; CHECK-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vrgatherei16.vv v8, v10, v13, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vrsub.vi v16, v18, 15
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v8, v20, v16
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vrsub.vi v18, v18, 7
; CHECK-NEXT:    li a0, 255
; CHECK-NEXT:    vmv.s.x v16, a0
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v16
; CHECK-NEXT:    vrgatherei16.vv v8, v12, v18, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vrgatherei16.vv v8, v0, v24
; CHECK-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; CHECK-NEXT:    vid.v v24
; CHECK-NEXT:    vrsub.vi v28, v24, 15
; CHECK-NEXT:    lui a0, 16
; CHECK-NEXT:    addi a0, a0, -1
...
; CHECK-NEXT:    vrsub.vi v16, v17, 7
; CHECK-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v8, v20, v16
; CHECK-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK-NEXT:    vrsub.vi v17, v17, 3
; CHECK-NEXT:    vmv.v.i v16, 15
; CHECK-NEXT:    vsetvli zero, zero, e64, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v16
; CHECK-NEXT:    vrgatherei16.vv v8, v12, v17, v0.t
; CHECK-NEXT:    ret
