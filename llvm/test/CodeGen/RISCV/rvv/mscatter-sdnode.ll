...
; CHECK-NEXT:    vwaddu.vv v8, v10, v10
...
; CHECK-NEXT:    vsoxei16.v v24, (a0), v8, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsll.vi v8, v8, 3
; CHECK-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; CHECK-NEXT:    vsoxei32.v v24, (a0), v8, v0.t
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vsoxei32.v v16, (zero), v4, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vslidedown.vx v16, v0, a0
; RV64-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
