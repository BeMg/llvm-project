...
; CHECK-NEXT:    vslideup.vi v16, v8, 3
; CHECK-NEXT:    sw zero, 12(sp)
; CHECK-NEXT:    lui a0, 1044480
; CHECK-NEXT:    sw a0, 8(sp)
; CHECK-NEXT:    li a0, 56
; CHECK-NEXT:    vsetvli a1, zero, e64, m2, ta, ma
; CHECK-NEXT:    vsrl.vx v10, v16, a0
; CHECK-NEXT:    li a1, 40
; CHECK-NEXT:    vsrl.vx v8, v16, a1
; CHECK-NEXT:    lui a2, 16
; CHECK-NEXT:    addi a2, a2, -256
; CHECK-NEXT:    vand.vx v8, v8, a2
; CHECK-NEXT:    vor.vv v14, v8, v10
; CHECK-NEXT:    vsrl.vi v8, v16, 24
; CHECK-NEXT:    addi a3, sp, 8
; CHECK-NEXT:    vlse64.v v10, (a3), zero
; CHECK-NEXT:    lui a3, 4080
; CHECK-NEXT:    vand.vx v12, v8, a3
; CHECK-NEXT:    vsrl.vi v8, v16, 8
; CHECK-NEXT:    vand.vv v8, v8, v10
; CHECK-NEXT:    vor.vv v8, v8, v12
; CHECK-NEXT:    vor.vv v14, v8, v14
; CHECK-NEXT:    vand.vv v8, v16, v10
; CHECK-NEXT:    vsll.vi v10, v8, 8
; CHECK-NEXT:    vand.vx v8, v16, a3
; CHECK-NEXT:    vsll.vi v8, v8, 24
; CHECK-NEXT:    vor.vv v12, v8, v10
; CHECK-NEXT:    vsll.vx v10, v16, a0
; CHECK-NEXT:    vand.vx v8, v16, a2
; CHECK-NEXT:    vsll.vx v8, v8, a1
; CHECK-NEXT:    vor.vv v8, v10, v8
; CHECK-NEXT:    vor.vv v8, v8, v12
; CHECK-NEXT:    vor.vv v12, v8, v14
; CHECK-NEXT:    vsrl.vi v10, v12, 4
