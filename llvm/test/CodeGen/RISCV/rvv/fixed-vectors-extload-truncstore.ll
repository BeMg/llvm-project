...
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf8 v12, v9
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v9, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
...
; LMULMAX1-NEXT:    vle8.v v9, (a0)
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf8 v12, v9
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v9, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
...
; LMULMAX1-NEXT:    vle8.v v9, (a0)
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v12, v9
; LMULMAX1-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v9, 8
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
...
; LMULMAX1-NEXT:    vle8.v v9, (a0)
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf4 v12, v9
; LMULMAX1-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v9, 8
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
...
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf8 v16, v11
; LMULMAX1-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v10, v11, 8
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf8 v12, v10
; LMULMAX1-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v11, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf8 v9, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v10, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf8 v13, v8
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v10, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
...
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v11, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf8 v10, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v8, 2
...
; LMULMAX1-NEXT:    vle8.v v11, (a0)
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf8 v16, v11
; LMULMAX1-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v10, v11, 8
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf8 v12, v10
; LMULMAX1-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v11, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf8 v9, v8
...
; LMULMAX1-NEXT:    vslidedown.vi v8, v10, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf8 v13, v8
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v10, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
...
; LMULMAX1-NEXT:    vsetivli zero, 4, e16, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v9, v13, 4
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf2 v11, v9
; LMULMAX1-NEXT:    vsext.vf2 v10, v13
...
; LMULMAX1-NEXT:    vslidedown.vi v9, v13, 4
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf2 v11, v9
; LMULMAX1-NEXT:    vzext.vf2 v10, v13
; LMULMAX1-NEXT:    vmv1r.v v9, v12
; LMULMAX1-NEXT:    ret
;
...
; LMULMAX1-NEXT:    vle16.v v9, (a0)
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v17, v10
; LMULMAX1-NEXT:    vsetivli zero, 4, e16, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v10, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v16, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e16, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v11, v8
...
; LMULMAX1-NEXT:    vmv1r.v v8, v17
; LMULMAX1-NEXT:    vmv1r.v v9, v10
...
; LMULMAX1-NEXT:    vle16.v v9, (a0)
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf4 v17, v10
; LMULMAX1-NEXT:    vsetivli zero, 4, e16, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v10, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf4 v16, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e16, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf4 v11, v8
...
; LMULMAX1-NEXT:    vslidedown.vi v8, v9, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf4 v14, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e16, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
...
; LMULMAX1-NEXT:    vnsrl.wi v9, v8, 0
...
; LMULMAX1-NEXT:    vsext.vf2 v8, v9
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v9, v13, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf2 v11, v9
; LMULMAX1-NEXT:    vsext.vf2 v10, v13
; LMULMAX1-NEXT:    vmv1r.v v9, v12
...
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf2 v16, v9
; LMULMAX1-NEXT:    vsext.vf2 v9, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
...
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v17, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf2 v15, v8
; LMULMAX1-NEXT:    vsext.vf2 v10, v12
; LMULMAX1-NEXT:    vsext.vf2 v12, v14
; LMULMAX1-NEXT:    vsext.vf2 v14, v17
; LMULMAX1-NEXT:    vmv1r.v v8, v9
...
; LMULMAX1-NEXT:    vslidedown.vi v9, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; LMULMAX1-NEXT:    vzext.vf2 v16, v9
; LMULMAX1-NEXT:    vzext.vf2 v9, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v8, v12, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
...
; LMULMAX1-NEXT:    vzext.vf2 v14, v17
; LMULMAX1-NEXT:    vmv1r.v v8, v9
; LMULMAX1-NEXT:    vmv1r.v v9, v16
; LMULMAX1-NEXT:    ret
;
...
; LMULMAX1-NEXT:    vnsrl.wi v8, v8, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v16, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v9, 0
...
; LMULMAX1-NEXT:    vslideup.vi v9, v8, 4
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
...
; LMULMAX1-NEXT:    vslideup.vi v9, v8, 8
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
...
; LMULMAX1-NEXT:    vnsrl.wi v8, v8, 0
; LMULMAX1-NEXT:    vsetivli zero, 12, e8, m1, tu, ma
; LMULMAX1-NEXT:    vslideup.vi v9, v8, 10
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
...
; LMULMAX1-NEXT:    vslideup.vi v9, v8, 12
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
...
; LMULMAX1-NEXT:    vnsrl.wi v8, v8, 0
; LMULMAX1-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; LMULMAX1-NEXT:    vslideup.vi v9, v8, 14
; LMULMAX1-NEXT:    vse8.v v9, (a0)
; LMULMAX1-NEXT:    ret
;
; LMULMAX4-LABEL: truncstore_v16i64_v16i8:
; LMULMAX4:       # %bb.0:
; LMULMAX4-NEXT:    vmv4r.v v16, v12
; LMULMAX4-NEXT:    vmv4r.v v12, v8
; LMULMAX4-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX4-NEXT:    vnsrl.wi v10, v16, 0
; LMULMAX4-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; LMULMAX4-NEXT:    vnsrl.wi v8, v10, 0
; LMULMAX4-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; LMULMAX4-NEXT:    vnsrl.wi v9, v8, 0
...
; LMULMAX4-NEXT:    vnsrl.wi v8, v8, 0
; LMULMAX4-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; LMULMAX4-NEXT:    vslideup.vi v8, v9, 8
; LMULMAX4-NEXT:    vse8.v v8, (a0)
; LMULMAX4-NEXT:    ret
...
; LMULMAX1-NEXT:    vnsrl.wi v9, v10, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v10, v9, 0
; LMULMAX1-NEXT:    vsetivli zero, 4, e16, m1, tu, ma
; LMULMAX1-NEXT:    vslideup.vi v10, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v8, v16, 0
; LMULMAX1-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v8, v8, 0
; LMULMAX1-NEXT:    vsetivli zero, 6, e16, m1, tu, ma
...
; LMULMAX1:       # %bb.0:
; LMULMAX1-NEXT:    vmv1r.v v16, v12
; LMULMAX1-NEXT:    vmv1r.v v12, v8
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v8, v9, 0
; LMULMAX1-NEXT:    vnsrl.wi v12, v12, 0
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vslideup.vi v12, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v8, v11, 0
; LMULMAX1-NEXT:    vnsrl.wi v11, v10, 0
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vslideup.vi v11, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v8, v13, 0
; LMULMAX1-NEXT:    vnsrl.wi v10, v16, 0
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vslideup.vi v10, v8, 2
; LMULMAX1-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; LMULMAX1-NEXT:    vnsrl.wi v9, v15, 0
...
; LMULMAX4:       # %bb.0:
; LMULMAX4-NEXT:    vmv4r.v v20, v12
; LMULMAX4-NEXT:    vmv4r.v v16, v8
; LMULMAX4-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX4-NEXT:    vnsrl.wi v12, v20, 0
