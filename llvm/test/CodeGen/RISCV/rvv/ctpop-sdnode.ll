...
; CHECK-ZVBB:       # %bb.0:
; CHECK-ZVBB-NEXT:    vsetvli a0, zero, e32, m8, ta, ma
; CHECK-ZVBB-NEXT:    vcpop.v v16, v8
; CHECK-ZVBB-NEXT:    vmsleu.vi v8, v16, 1
; CHECK-ZVBB-NEXT:    vmv1r.v v0, v8
; CHECK-ZVBB-NEXT:    ret
  %a = call <vscale x 16 x i32> @llvm.ctpop.nxv16i32(<vscale x 16 x i32> %va)
...
; CHECK-ZVBB-NEXT:    vsetvli a0, zero, e32, m8, ta, ma
; CHECK-ZVBB-NEXT:    vcpop.v v16, v8
; CHECK-ZVBB-NEXT:    vmsgtu.vi v8, v16, 1
; CHECK-ZVBB-NEXT:    vmv1r.v v0, v8
; CHECK-ZVBB-NEXT:    ret
  %a = call <vscale x 16 x i32> @llvm.ctpop.nxv16i32(<vscale x 16 x i32> %va)
...
; CHECK-ZVBB-NEXT:    vsetvli a0, zero, e32, m8, ta, ma
; CHECK-ZVBB-NEXT:    vcpop.v v16, v8
; CHECK-ZVBB-NEXT:    vmseq.vi v8, v16, 1
; CHECK-ZVBB-NEXT:    vmv1r.v v0, v8
; CHECK-ZVBB-NEXT:    ret
  %a = call <vscale x 16 x i32> @llvm.ctpop.nxv16i32(<vscale x 16 x i32> %va)
...
; CHECK-ZVBB-NEXT:    vsetvli a0, zero, e32, m8, ta, ma
; CHECK-ZVBB-NEXT:    vcpop.v v16, v8
; CHECK-ZVBB-NEXT:    vmsne.vi v8, v16, 1
; CHECK-ZVBB-NEXT:    vmv1r.v v0, v8
; CHECK-ZVBB-NEXT:    ret
  %a = call <vscale x 16 x i32> @llvm.ctpop.nxv16i32(<vscale x 16 x i32> %va)
