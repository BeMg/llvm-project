...
; V128-NEXT:    vid.v v12
; V128-NEXT:    vsrl.vi v14, v12, 1
; V128-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; V128-NEXT:    vrgatherei16.vv v12, v8, v14
; V128-NEXT:    vsetivli zero, 1, e8, mf8, ta, ma
; V128-NEXT:    vmv.v.i v8, 10
; V128-NEXT:    vsetivli zero, 4, e64, m2, ta, mu
; V128-NEXT:    vmv1r.v v0, v8
; V128-NEXT:    vrgatherei16.vv v12, v10, v14, v0.t
; V128-NEXT:    vmv.v.v v8, v12
; V128-NEXT:    ret
;
; RV32-V512-LABEL: interleave_v2i64:
; RV32-V512:       # %bb.0:
; RV32-V512-NEXT:    vmv1r.v v11, v9
; RV32-V512-NEXT:    vmv1r.v v12, v8
; RV32-V512-NEXT:    vsetivli zero, 4, e16, mf4, ta, ma
; RV32-V512-NEXT:    vid.v v8
; RV32-V512-NEXT:    vsrl.vi v10, v8, 1
; RV32-V512-NEXT:    vsetvli zero, zero, e64, m1, ta, mu
; RV32-V512-NEXT:    vmv.v.i v9, 10
; RV32-V512-NEXT:    vrgatherei16.vv v8, v12, v10
; RV32-V512-NEXT:    vmv.v.v v0, v9
; RV32-V512-NEXT:    vrgatherei16.vv v8, v11, v10, v0.t
; RV32-V512-NEXT:    ret
;
; RV64-V512-LABEL: interleave_v2i64:
; RV64-V512:       # %bb.0:
; RV64-V512-NEXT:    vmv1r.v v11, v9
; RV64-V512-NEXT:    vmv1r.v v12, v8
; RV64-V512-NEXT:    vsetivli zero, 4, e64, m1, ta, mu
; RV64-V512-NEXT:    vid.v v8
; RV64-V512-NEXT:    vsrl.vi v10, v8, 1
; RV64-V512-NEXT:    vmv.v.i v9, 10
; RV64-V512-NEXT:    vrgather.vv v8, v12, v10
; RV64-V512-NEXT:    vmv.v.v v0, v9
; RV64-V512-NEXT:    vrgather.vv v8, v11, v10, v0.t
; RV64-V512-NEXT:    ret
...
; V128-NEXT:    vid.v v8
; V128-NEXT:    vsrl.vi v10, v8, 1
; V128-NEXT:    vrgather.vv v8, v9, v10
; V128-NEXT:    vmv.v.i v9, 10
; V128-NEXT:    vadd.vi v10, v10, 1
; V128-NEXT:    vmv.v.v v0, v9
; V128-NEXT:    vrgather.vv v8, v11, v10, v0.t
; V128-NEXT:    ret
;
...
; V512-NEXT:    vid.v v8
; V512-NEXT:    vsrl.vi v10, v8, 1
; V512-NEXT:    vrgather.vv v8, v9, v10
; V512-NEXT:    vmv.v.i v9, 10
; V512-NEXT:    vadd.vi v10, v10, 1
; V512-NEXT:    vmv1r.v v0, v9
; V512-NEXT:    vrgather.vv v8, v11, v10, v0.t
; V512-NEXT:    ret
...
; V128-NEXT:    vle16.v v0, (a0)
; V128-NEXT:    lui a0, %hi(.LCPI17_1)
; V128-NEXT:    addi a0, a0, %lo(.LCPI17_1)
; V128-NEXT:    vle16.v v16, (a0)
; V128-NEXT:    addi a0, sp, 16
; V128-NEXT:    vs4r.v v16, (a0) # Unknown-size Folded Spill
; V128-NEXT:    lui a0, 699051
; V128-NEXT:    addi a0, a0, -1366
; V128-NEXT:    vmv.s.x v4, a0
; V128-NEXT:    vrgatherei16.vv v16, v8, v0
; V128-NEXT:    vmv1r.v v0, v4
; V128-NEXT:    addi a0, sp, 16
; V128-NEXT:    vl4r.v v4, (a0) # Unknown-size Folded Reload
; V128-NEXT:    vrgatherei16.vv v16, v24, v4, v0.t
; V128-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; V128-NEXT:    vwaddu.vv v0, v8, v24
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v0, a0, v24
...
; V128-NEXT:    vrgather.vv v8, v10, v9
; V128-NEXT:    ret
;
...
; V512-NEXT:    vrgather.vv v8, v10, v9
; V512-NEXT:    ret
...
; V128-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; V128-NEXT:    vwaddu.vv v8, v12, v10
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v8, a0, v10
; V128-NEXT:    ret
;
