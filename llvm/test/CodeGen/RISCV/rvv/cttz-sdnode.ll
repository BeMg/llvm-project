...
; CHECK-ZVE64X-NEXT:    vand.vv v9, v8, v9
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v9, 1
; CHECK-ZVE64X-NEXT:    li a0, 85
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vsub.vv v8, v9, v8
; CHECK-ZVE64X-NEXT:    li a0, 51
; CHECK-ZVE64X-NEXT:    vand.vx v9, v8, a0
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v8, 2
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vadd.vv v9, v9, v8
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v9, 4
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    vmv1r.v v10, v8
; CHECK-F-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v8, v10, v8
...
; CHECK-F-NEXT:    vnsrl.wi v9, v8, 0
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vmseq.vi v0, v10, 0
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    vmv1r.v v10, v8
; CHECK-D-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; CHECK-D-NEXT:    vrsub.vi v8, v8, 0
; CHECK-D-NEXT:    vand.vv v8, v10, v8
...
; CHECK-D-NEXT:    vnsrl.wi v9, v8, 0
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vmseq.vi v0, v10, 0
...
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v9, v10, v8
; CHECK-F-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK-F-NEXT:    vzext.vf2 v8, v9
...
; CHECK-D-NEXT:    vrsub.vi v8, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v10, v8
; CHECK-D-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK-D-NEXT:    vzext.vf2 v8, v9
...
; CHECK-ZVE64X-NEXT:    vnot.v v8, v8
; CHECK-ZVE64X-NEXT:    vand.vv v10, v8, v10
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v10, 1
; CHECK-ZVE64X-NEXT:    li a0, 85
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vsub.vv v8, v10, v8
; CHECK-ZVE64X-NEXT:    li a0, 51
; CHECK-ZVE64X-NEXT:    vand.vx v10, v8, a0
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v8, 2
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vadd.vv v10, v10, v8
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v10, 4
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    vmv2r.v v12, v8
; CHECK-F-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v14, v12, v8
; CHECK-F-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; CHECK-F-NEXT:    vzext.vf2 v8, v14
; CHECK-F-NEXT:    vfwcvt.f.xu.v v24, v8
; CHECK-F-NEXT:    vnsrl.wi v16, v24, 23
; CHECK-F-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; CHECK-F-NEXT:    vnsrl.wi v10, v16, 0
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vmseq.vi v8, v12, 0
; CHECK-F-NEXT:    vsub.vx v10, v10, a0
; CHECK-F-NEXT:    vmv1r.v v0, v8
; CHECK-F-NEXT:    vmerge.vim v8, v10, 8, v0
; CHECK-F-NEXT:    ret
;
; CHECK-D-LABEL: cttz_nxv16i8:
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    vmv2r.v v12, v8
; CHECK-D-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; CHECK-D-NEXT:    vrsub.vi v8, v8, 0
; CHECK-D-NEXT:    vand.vv v14, v12, v8
; CHECK-D-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; CHECK-D-NEXT:    vzext.vf2 v8, v14
; CHECK-D-NEXT:    vfwcvt.f.xu.v v24, v8
; CHECK-D-NEXT:    vnsrl.wi v16, v24, 23
; CHECK-D-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; CHECK-D-NEXT:    vnsrl.wi v10, v16, 0
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vmseq.vi v8, v12, 0
; CHECK-D-NEXT:    vsub.vx v10, v10, a0
; CHECK-D-NEXT:    vmv1r.v v0, v8
...
; CHECK-NEXT:    vand.vx v8, v8, a0
; CHECK-NEXT:    vadd.vv v12, v12, v8
; CHECK-NEXT:    vsrl.vi v8, v12, 4
...
; CHECK-ZVE64X-NEXT:    vnot.v v8, v8
; CHECK-ZVE64X-NEXT:    vand.vv v12, v8, v12
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v12, 1
; CHECK-ZVE64X-NEXT:    lui a0, 5
; CHECK-ZVE64X-NEXT:    addi a0, a0, 1365
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vsub.vv v8, v12, v8
; CHECK-ZVE64X-NEXT:    lui a0, 3
; CHECK-ZVE64X-NEXT:    addi a0, a0, 819
; CHECK-ZVE64X-NEXT:    vand.vx v12, v8, a0
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v8, 2
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vadd.vv v12, v12, v8
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v12, 4
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    vmv4r.v v16, v8
; CHECK-F-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v8, v16, v8
; CHECK-F-NEXT:    vfwcvt.f.xu.v v24, v8
; CHECK-F-NEXT:    vnsrl.wi v8, v24, 23
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsub.vx v12, v8, a0
; CHECK-F-NEXT:    vmseq.vi v8, v16, 0
; CHECK-F-NEXT:    li a0, 16
; CHECK-F-NEXT:    vmv1r.v v0, v8
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    vmv4r.v v16, v8
; CHECK-D-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; CHECK-D-NEXT:    vrsub.vi v8, v8, 0
; CHECK-D-NEXT:    vand.vv v8, v16, v8
; CHECK-D-NEXT:    vfwcvt.f.xu.v v24, v8
; CHECK-D-NEXT:    vnsrl.wi v8, v24, 23
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsub.vx v12, v8, a0
; CHECK-D-NEXT:    vmseq.vi v8, v16, 0
; CHECK-D-NEXT:    li a0, 16
; CHECK-D-NEXT:    vmv1r.v v0, v8
...
; CHECK-F-NEXT:    vsrl.vi v8, v8, 23
; CHECK-F-NEXT:    li a1, 127
; CHECK-F-NEXT:    vsub.vx v10, v8, a1
; CHECK-F-NEXT:    vmseq.vi v8, v12, 0
; CHECK-F-NEXT:    li a1, 32
; CHECK-F-NEXT:    vmv1r.v v0, v8
...
; CHECK-F-NEXT:    vsrl.vi v8, v8, 23
; CHECK-F-NEXT:    li a1, 127
; CHECK-F-NEXT:    vsub.vx v12, v8, a1
; CHECK-F-NEXT:    vmseq.vi v8, v16, 0
; CHECK-F-NEXT:    li a1, 32
; CHECK-F-NEXT:    vmv1r.v v0, v8
...
; CHECK-D-NEXT:    vfwcvt.f.xu.v v24, v8
; CHECK-D-NEXT:    li a0, 52
; CHECK-D-NEXT:    vnsrl.wx v8, v24, a0
; CHECK-D-NEXT:    li a0, 1023
; CHECK-D-NEXT:    vsub.vx v12, v8, a0
; CHECK-D-NEXT:    vmseq.vi v8, v16, 0
; CHECK-D-NEXT:    li a0, 32
...
; CHECK-ZVE64X-NEXT:    vnot.v v8, v8
; CHECK-ZVE64X-NEXT:    vand.vv v16, v8, v16
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v16, 1
; CHECK-ZVE64X-NEXT:    lui a0, 349525
; CHECK-ZVE64X-NEXT:    addi a0, a0, 1365
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vsub.vv v8, v16, v8
; CHECK-ZVE64X-NEXT:    lui a0, 209715
; CHECK-ZVE64X-NEXT:    addi a0, a0, 819
; CHECK-ZVE64X-NEXT:    vand.vx v16, v8, a0
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v8, 2
; CHECK-ZVE64X-NEXT:    vand.vx v8, v8, a0
; CHECK-ZVE64X-NEXT:    vadd.vv v16, v16, v8
; CHECK-ZVE64X-NEXT:    vsrl.vi v8, v16, 4
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    vmv8r.v v24, v8
; CHECK-F-NEXT:    vsetvli a0, zero, e32, m8, ta, ma
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v8, v24, v8
; CHECK-F-NEXT:    fsrmi a0, 1
; CHECK-F-NEXT:    vfcvt.f.xu.v v8, v8
; CHECK-F-NEXT:    vsrl.vi v8, v8, 23
; CHECK-F-NEXT:    li a1, 127
; CHECK-F-NEXT:    vsub.vx v16, v8, a1
; CHECK-F-NEXT:    vmseq.vi v8, v24, 0
; CHECK-F-NEXT:    li a1, 32
; CHECK-F-NEXT:    vmv1r.v v0, v8
...
; RV32I-NEXT:    vand.vv v9, v8, v9
; RV32I-NEXT:    vsrl.vi v10, v9, 1
...
; RV32I-NEXT:    vadd.vv v9, v9, v8
; RV32I-NEXT:    vsrl.vi v8, v9, 4
; RV32I-NEXT:    vadd.vv v9, v9, v8
...
; RV32I-NEXT:    vmv.v.x v8, a0
; RV32I-NEXT:    vsetvli a0, zero, e64, m1, ta, ma
; RV32I-NEXT:    vand.vv v9, v9, v8
; RV32I-NEXT:    lui a0, 4112
; RV32I-NEXT:    addi a0, a0, 257
; RV32I-NEXT:    vsetvli a1, zero, e32, m1, ta, ma
; RV32I-NEXT:    vmv.v.x v8, a0
; RV32I-NEXT:    vsetvli a0, zero, e64, m1, ta, ma
; RV32I-NEXT:    vmul.vv v8, v9, v8
; RV32I-NEXT:    li a0, 56
...
; RV64I-NEXT:    vand.vx v8, v8, a0
; RV64I-NEXT:    vadd.vv v9, v9, v8
; RV64I-NEXT:    vsrl.vi v8, v9, 4
...
; RV64F:       # %bb.0:
; RV64F-NEXT:    vmv1r.v v10, v8
; RV64F-NEXT:    vsetvli a0, zero, e64, m1, ta, ma
; RV64F-NEXT:    vrsub.vi v8, v8, 0
; RV64F-NEXT:    vand.vv v9, v10, v8
; RV64F-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; RV64F-NEXT:    fsrmi a0, 1
; RV64F-NEXT:    vfncvt.f.xu.w v8, v9
; RV64F-NEXT:    vsrl.vi v9, v8, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; RV64F-NEXT:    vzext.vf2 v8, v9
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v9, v8, a1
; RV64F-NEXT:    vmseq.vi v0, v10, 0
; RV64F-NEXT:    li a1, 64
...
; RV32D:       # %bb.0:
; RV32D-NEXT:    vmv1r.v v10, v8
; RV32D-NEXT:    vsetvli a0, zero, e64, m1, ta, ma
; RV32D-NEXT:    vmseq.vx v0, v8, zero
; RV32D-NEXT:    vrsub.vi v8, v8, 0
; RV32D-NEXT:    vand.vv v8, v10, v8
...
; RV64D:       # %bb.0:
; RV64D-NEXT:    vmv1r.v v10, v8
; RV64D-NEXT:    vsetvli a0, zero, e64, m1, ta, ma
; RV64D-NEXT:    vrsub.vi v8, v8, 0
; RV64D-NEXT:    vand.vv v8, v10, v8
; RV64D-NEXT:    fsrmi a0, 1
; RV64D-NEXT:    vfcvt.f.xu.v v8, v8
; RV64D-NEXT:    li a1, 52
; RV64D-NEXT:    vsrl.vx v8, v8, a1
; RV64D-NEXT:    li a1, 1023
; RV64D-NEXT:    vsub.vx v9, v8, a1
; RV64D-NEXT:    vmseq.vi v0, v10, 0
; RV64D-NEXT:    li a1, 64
...
; RV32I-NEXT:    vnot.v v8, v8
; RV32I-NEXT:    vand.vv v10, v8, v10
; RV32I-NEXT:    vsrl.vi v12, v10, 1
; RV32I-NEXT:    lui a0, 349525
; RV32I-NEXT:    addi a0, a0, 1365
...
; RV32I-NEXT:    vadd.vv v10, v10, v8
; RV32I-NEXT:    vsrl.vi v8, v10, 4
; RV32I-NEXT:    vadd.vv v10, v10, v8
; RV32I-NEXT:    lui a0, 61681
; RV32I-NEXT:    addi a0, a0, -241
; RV32I-NEXT:    vsetvli a1, zero, e32, m2, ta, ma
; RV32I-NEXT:    vmv.v.x v8, a0
; RV32I-NEXT:    vsetvli a0, zero, e64, m2, ta, ma
; RV32I-NEXT:    vand.vv v10, v10, v8
; RV32I-NEXT:    lui a0, 4112
; RV32I-NEXT:    addi a0, a0, 257
; RV32I-NEXT:    vsetvli a1, zero, e32, m2, ta, ma
; RV32I-NEXT:    vmv.v.x v8, a0
; RV32I-NEXT:    vsetvli a0, zero, e64, m2, ta, ma
; RV32I-NEXT:    vmul.vv v8, v10, v8
; RV32I-NEXT:    li a0, 56
; RV32I-NEXT:    vsrl.vx v8, v8, a0
; RV32I-NEXT:    ret
;
...
; RV64I-NEXT:    vnot.v v8, v8
; RV64I-NEXT:    vand.vv v10, v8, v10
; RV64I-NEXT:    vsrl.vi v8, v10, 1
; RV64I-NEXT:    lui a0, 349525
; RV64I-NEXT:    addiw a0, a0, 1365
; RV64I-NEXT:    slli a1, a0, 32
; RV64I-NEXT:    add a0, a0, a1
; RV64I-NEXT:    vand.vx v8, v8, a0
; RV64I-NEXT:    vsub.vv v8, v10, v8
; RV64I-NEXT:    lui a0, 209715
; RV64I-NEXT:    addiw a0, a0, 819
; RV64I-NEXT:    slli a1, a0, 32
; RV64I-NEXT:    add a0, a0, a1
...
; RV64I-NEXT:    vsrl.vi v8, v8, 2
; RV64I-NEXT:    vand.vx v8, v8, a0
; RV64I-NEXT:    vadd.vv v10, v10, v8
; RV64I-NEXT:    vsrl.vi v8, v10, 4
...
; RV64F:       # %bb.0:
; RV64F-NEXT:    vmv2r.v v12, v8
; RV64F-NEXT:    vsetvli a0, zero, e64, m2, ta, ma
; RV64F-NEXT:    vrsub.vi v8, v8, 0
; RV64F-NEXT:    vand.vv v10, v12, v8
; RV64F-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV64F-NEXT:    fsrmi a0, 1
; RV64F-NEXT:    vfncvt.f.xu.w v8, v10
; RV64F-NEXT:    vsrl.vi v10, v8, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; RV64F-NEXT:    vzext.vf2 v8, v10
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v10, v8, a1
; RV64F-NEXT:    vmseq.vi v8, v12, 0
; RV64F-NEXT:    li a1, 64
; RV64F-NEXT:    vmv1r.v v0, v8
...
; RV64D:       # %bb.0:
; RV64D-NEXT:    vmv2r.v v12, v8
; RV64D-NEXT:    vsetvli a0, zero, e64, m2, ta, ma
; RV64D-NEXT:    vrsub.vi v8, v8, 0
; RV64D-NEXT:    vand.vv v8, v12, v8
; RV64D-NEXT:    fsrmi a0, 1
; RV64D-NEXT:    vfcvt.f.xu.v v8, v8
; RV64D-NEXT:    li a1, 52
; RV64D-NEXT:    vsrl.vx v8, v8, a1
; RV64D-NEXT:    li a1, 1023
; RV64D-NEXT:    vsub.vx v10, v8, a1
; RV64D-NEXT:    vmseq.vi v8, v12, 0
; RV64D-NEXT:    li a1, 64
; RV64D-NEXT:    vmv1r.v v0, v8
...
; RV32I-NEXT:    vnot.v v8, v8
; RV32I-NEXT:    vand.vv v12, v8, v12
; RV32I-NEXT:    vsrl.vi v16, v12, 1
; RV32I-NEXT:    lui a0, 349525
; RV32I-NEXT:    addi a0, a0, 1365
...
; RV32I-NEXT:    vadd.vv v12, v12, v8
; RV32I-NEXT:    vsrl.vi v8, v12, 4
; RV32I-NEXT:    vadd.vv v12, v12, v8
; RV32I-NEXT:    lui a0, 61681
; RV32I-NEXT:    addi a0, a0, -241
; RV32I-NEXT:    vsetvli a1, zero, e32, m4, ta, ma
; RV32I-NEXT:    vmv.v.x v8, a0
; RV32I-NEXT:    vsetvli a0, zero, e64, m4, ta, ma
; RV32I-NEXT:    vand.vv v12, v12, v8
; RV32I-NEXT:    lui a0, 4112
; RV32I-NEXT:    addi a0, a0, 257
; RV32I-NEXT:    vsetvli a1, zero, e32, m4, ta, ma
; RV32I-NEXT:    vmv.v.x v8, a0
; RV32I-NEXT:    vsetvli a0, zero, e64, m4, ta, ma
; RV32I-NEXT:    vmul.vv v8, v12, v8
; RV32I-NEXT:    li a0, 56
; RV32I-NEXT:    vsrl.vx v8, v8, a0
; RV32I-NEXT:    ret
;
...
; RV64I-NEXT:    vnot.v v8, v8
; RV64I-NEXT:    vand.vv v12, v8, v12
; RV64I-NEXT:    vsrl.vi v8, v12, 1
; RV64I-NEXT:    lui a0, 349525
; RV64I-NEXT:    addiw a0, a0, 1365
; RV64I-NEXT:    slli a1, a0, 32
; RV64I-NEXT:    add a0, a0, a1
; RV64I-NEXT:    vand.vx v8, v8, a0
; RV64I-NEXT:    vsub.vv v8, v12, v8
; RV64I-NEXT:    lui a0, 209715
; RV64I-NEXT:    addiw a0, a0, 819
; RV64I-NEXT:    slli a1, a0, 32
; RV64I-NEXT:    add a0, a0, a1
...
; RV64I-NEXT:    vsrl.vi v8, v8, 2
; RV64I-NEXT:    vand.vx v8, v8, a0
; RV64I-NEXT:    vadd.vv v12, v12, v8
; RV64I-NEXT:    vsrl.vi v8, v12, 4
...
; RV64F:       # %bb.0:
; RV64F-NEXT:    vmv4r.v v16, v8
; RV64F-NEXT:    vsetvli a0, zero, e64, m4, ta, ma
; RV64F-NEXT:    vrsub.vi v8, v8, 0
; RV64F-NEXT:    vand.vv v12, v16, v8
; RV64F-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV64F-NEXT:    fsrmi a0, 1
; RV64F-NEXT:    vfncvt.f.xu.w v8, v12
; RV64F-NEXT:    vsrl.vi v12, v8, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV64F-NEXT:    vzext.vf2 v8, v12
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v12, v8, a1
; RV64F-NEXT:    vmseq.vi v8, v16, 0
; RV64F-NEXT:    li a1, 64
; RV64F-NEXT:    vmv1r.v v0, v8
...
; RV64D:       # %bb.0:
; RV64D-NEXT:    vmv4r.v v16, v8
; RV64D-NEXT:    vsetvli a0, zero, e64, m4, ta, ma
; RV64D-NEXT:    vrsub.vi v8, v8, 0
; RV64D-NEXT:    vand.vv v8, v16, v8
; RV64D-NEXT:    fsrmi a0, 1
; RV64D-NEXT:    vfcvt.f.xu.v v8, v8
; RV64D-NEXT:    li a1, 52
; RV64D-NEXT:    vsrl.vx v8, v8, a1
; RV64D-NEXT:    li a1, 1023
; RV64D-NEXT:    vsub.vx v12, v8, a1
; RV64D-NEXT:    vmseq.vi v8, v16, 0
; RV64D-NEXT:    li a1, 64
; RV64D-NEXT:    vmv1r.v v0, v8
...
; RV32I-NEXT:    vnot.v v8, v8
; RV32I-NEXT:    vand.vv v16, v8, v16
; RV32I-NEXT:    vsrl.vi v24, v16, 1
; RV32I-NEXT:    lui a0, 349525
; RV32I-NEXT:    addi a0, a0, 1365
; RV32I-NEXT:    vsetvli a1, zero, e32, m8, ta, ma
; RV32I-NEXT:    vmv.v.x v8, a0
; RV32I-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; RV32I-NEXT:    vand.vv v8, v24, v8
; RV32I-NEXT:    vsub.vv v8, v16, v8
; RV32I-NEXT:    lui a0, 209715
; RV32I-NEXT:    addi a0, a0, 819
; RV32I-NEXT:    vsetvli a1, zero, e32, m8, ta, ma
...
; RV32I-NEXT:    vadd.vv v16, v16, v8
; RV32I-NEXT:    vsrl.vi v8, v16, 4
; RV32I-NEXT:    vadd.vv v16, v16, v8
; RV32I-NEXT:    lui a0, 61681
; RV32I-NEXT:    addi a0, a0, -241
; RV32I-NEXT:    vsetvli a1, zero, e32, m8, ta, ma
...
; RV64I-NEXT:    vnot.v v8, v8
; RV64I-NEXT:    vand.vv v16, v8, v16
; RV64I-NEXT:    vsrl.vi v8, v16, 1
; RV64I-NEXT:    lui a0, 349525
; RV64I-NEXT:    addiw a0, a0, 1365
; RV64I-NEXT:    slli a1, a0, 32
; RV64I-NEXT:    add a0, a0, a1
; RV64I-NEXT:    vand.vx v8, v8, a0
; RV64I-NEXT:    vsub.vv v8, v16, v8
; RV64I-NEXT:    lui a0, 209715
; RV64I-NEXT:    addiw a0, a0, 819
; RV64I-NEXT:    slli a1, a0, 32
; RV64I-NEXT:    add a0, a0, a1
...
; RV64I-NEXT:    vsrl.vi v8, v8, 2
; RV64I-NEXT:    vand.vx v8, v8, a0
; RV64I-NEXT:    vadd.vv v16, v16, v8
; RV64I-NEXT:    vsrl.vi v8, v16, 4
...
; RV64F:       # %bb.0:
; RV64F-NEXT:    vmv8r.v v24, v8
; RV64F-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; RV64F-NEXT:    vrsub.vi v8, v8, 0
; RV64F-NEXT:    vand.vv v16, v24, v8
; RV64F-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV64F-NEXT:    fsrmi a0, 1
; RV64F-NEXT:    vfncvt.f.xu.w v8, v16
; RV64F-NEXT:    vsrl.vi v16, v8, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64F-NEXT:    vzext.vf2 v8, v16
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v16, v8, a1
; RV64F-NEXT:    vmseq.vi v8, v24, 0
; RV64F-NEXT:    li a1, 64
; RV64F-NEXT:    vmv1r.v v0, v8
...
; RV64D:       # %bb.0:
; RV64D-NEXT:    vmv8r.v v24, v8
; RV64D-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; RV64D-NEXT:    vrsub.vi v8, v8, 0
; RV64D-NEXT:    vand.vv v8, v24, v8
; RV64D-NEXT:    fsrmi a0, 1
; RV64D-NEXT:    vfcvt.f.xu.v v8, v8
; RV64D-NEXT:    li a1, 52
; RV64D-NEXT:    vsrl.vx v8, v8, a1
; RV64D-NEXT:    li a1, 1023
; RV64D-NEXT:    vsub.vx v16, v8, a1
; RV64D-NEXT:    vmseq.vi v8, v24, 0
; RV64D-NEXT:    li a1, 64
; RV64D-NEXT:    vmv1r.v v0, v8
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    vmv1r.v v9, v8
; CHECK-F-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v8, v9, v8
; CHECK-F-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; CHECK-F-NEXT:    vzext.vf2 v9, v8
; CHECK-F-NEXT:    vfwcvt.f.xu.v v8, v9
; CHECK-F-NEXT:    vnsrl.wi v8, v8, 23
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    vmv1r.v v9, v8
; CHECK-D-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; CHECK-D-NEXT:    vrsub.vi v8, v8, 0
; CHECK-D-NEXT:    vand.vv v8, v9, v8
; CHECK-D-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; CHECK-D-NEXT:    vzext.vf2 v9, v8
; CHECK-D-NEXT:    vfwcvt.f.xu.v v8, v9
; CHECK-D-NEXT:    vnsrl.wi v8, v8, 23
...
; CHECK-F-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v10, v9, v8
; CHECK-F-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-F-NEXT:    vzext.vf2 v8, v10
; CHECK-F-NEXT:    vfwcvt.f.xu.v v12, v8
; CHECK-F-NEXT:    vnsrl.wi v10, v12, 23
; CHECK-F-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
...
; CHECK-D-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; CHECK-D-NEXT:    vrsub.vi v8, v8, 0
; CHECK-D-NEXT:    vand.vv v10, v9, v8
; CHECK-D-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-D-NEXT:    vzext.vf2 v8, v10
; CHECK-D-NEXT:    vfwcvt.f.xu.v v12, v8
; CHECK-D-NEXT:    vnsrl.wi v10, v12, 23
; CHECK-D-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    vmv2r.v v10, v8
; CHECK-F-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v12, v10, v8
; CHECK-F-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; CHECK-F-NEXT:    vzext.vf2 v8, v12
; CHECK-F-NEXT:    vfwcvt.f.xu.v v16, v8
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    vmv2r.v v10, v8
; CHECK-D-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; CHECK-D-NEXT:    vrsub.vi v8, v8, 0
; CHECK-D-NEXT:    vand.vv v12, v10, v8
; CHECK-D-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; CHECK-D-NEXT:    vzext.vf2 v8, v12
; CHECK-D-NEXT:    vfwcvt.f.xu.v v16, v8
...
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v10, v10, v8
...
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v12, v12, v8
...
; CHECK-F-NEXT:    vrsub.vi v8, v8, 0
; CHECK-F-NEXT:    vand.vv v16, v16, v8
