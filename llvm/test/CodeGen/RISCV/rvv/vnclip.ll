...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclip.wv v8, v12, v10
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclip.wv v8, v16, v12
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclip.wv v8, v24, v16
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclip.wx v8, v10, a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclip.wx v8, v12, a0
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclip.wx v8, v16, a0
; CHECK-NEXT:    ret
entry:
