...
; RV32ZVFHMIN:       # %bb.0:
; RV32ZVFHMIN-NEXT:    vmv1r.v v10, v8
; RV32ZVFHMIN-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32ZVFHMIN-NEXT:    vid.v v8
; RV32ZVFHMIN-NEXT:    vmsltu.vx v8, v8, a0
; RV32ZVFHMIN-NEXT:    vmand.mm v8, v9, v8
; RV32ZVFHMIN-NEXT:    vmandn.mm v9, v10, v8
; RV32ZVFHMIN-NEXT:    vmand.mm v8, v0, v8
; RV32ZVFHMIN-NEXT:    vmor.mm v0, v8, v9
; RV32ZVFHMIN-NEXT:    ret
;
; RV64ZVFHMIN-LABEL: vpmerge_vv_v4i1:
; RV64ZVFHMIN:       # %bb.0:
; RV64ZVFHMIN-NEXT:    vmv1r.v v12, v8
; RV64ZVFHMIN-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV64ZVFHMIN-NEXT:    vid.v v10
; RV64ZVFHMIN-NEXT:    vmsltu.vx v8, v10, a0
; RV64ZVFHMIN-NEXT:    vmand.mm v8, v9, v8
; RV64ZVFHMIN-NEXT:    vmandn.mm v9, v12, v8
; RV64ZVFHMIN-NEXT:    vmand.mm v8, v0, v8
; RV64ZVFHMIN-NEXT:    vmor.mm v0, v8, v9
...
; CHECK-NEXT:    vslidedown.vi v8, v1, 2
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, tu, ma
...
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vfmerge.vfm v24, v24, fa0, v0
