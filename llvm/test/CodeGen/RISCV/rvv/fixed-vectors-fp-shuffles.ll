...
; RV32-NEXT:    vmul.vx v11, v10, a0
; RV32-NEXT:    vmv.v.i v10, 3
; RV32-NEXT:    vsetvli zero, zero, e64, m2, ta, mu
; RV32-NEXT:    vmv1r.v v0, v10
; RV32-NEXT:    vrgatherei16.vv v8, v12, v11, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    li a0, 3
; RV64-NEXT:    vmul.vx v11, v10, a0
; RV64-NEXT:    vmv.v.i v10, 3
; RV64-NEXT:    vsetvli zero, zero, e64, m2, ta, mu
; RV64-NEXT:    vmv1r.v v0, v10
; RV64-NEXT:    vrgatherei16.vv v8, v12, v11, v0.t
; RV64-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; CHECK-NEXT:    vslidedown.vi v8, v12, 5
