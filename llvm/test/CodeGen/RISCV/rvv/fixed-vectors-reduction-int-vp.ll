...
; CHECK-NEXT:    vredsum.vs v8, v10, v8, v0.t
...
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredmaxu.vs v8, v10, v8, v0.t
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredmax.vs v8, v10, v8, v0.t
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredminu.vs v8, v10, v8, v0.t
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredmin.vs v8, v10, v8, v0.t
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredand.vs v8, v10, v8, v0.t
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredor.vs v8, v10, v8, v0.t
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredxor.vs v8, v10, v8, v0.t
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vredmaxu.vs v8, v10, v8, v0.t
...
; RV64-NEXT:    vredmaxu.vs v8, v10, v8, v0.t
...
; RV32-NEXT:    vmv.s.x v8, a0
; RV32-NEXT:    vsetvli zero, a1, e16, mf4, ta, ma
; RV32-NEXT:    vredminu.vs v8, v10, v8, v0.t
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e16, mf4, ta, ma
; RV64-NEXT:    vredminu.vs v8, v10, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; CHECK-NEXT:    vredxor.vs v8, v24, v8, v0.t
...
; RV64-NEXT:    vredsum.vs v8, v10, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredmax.vs v8, v10, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredmin.vs v8, v10, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredand.vs v8, v10, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredor.vs v8, v10, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredxor.vs v8, v10, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vredsum.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; RV64-NEXT:    vredmaxu.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; RV64-NEXT:    vredmax.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; RV64-NEXT:    vredminu.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; RV64-NEXT:    vredmin.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; RV64-NEXT:    vredand.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; RV64-NEXT:    vredor.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV64-NEXT:    vmv.s.x v8, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; RV64-NEXT:    vredxor.vs v8, v12, v8, v0.t
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; RV32-NEXT:    vid.v v8
; RV32-NEXT:    vmsltu.vx v8, v8, a1
; RV32-NEXT:    vmand.mm v0, v8, v0
; RV32-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; RV32-NEXT:    vmv.v.i v8, 1
; RV32-NEXT:    vmerge.vvm v9, v8, v10, v0
; RV32-NEXT:    vrgather.vi v8, v9, 1
...
; RV64-NEXT:    vid.v v8
; RV64-NEXT:    vmsltu.vx v8, v8, a1
; RV64-NEXT:    vmand.mm v0, v8, v0
; RV64-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; RV64-NEXT:    vmv.v.i v8, 1
; RV64-NEXT:    vmerge.vvm v9, v8, v10, v0
; RV64-NEXT:    vrgather.vi v8, v9, 1
...
; RV32-NEXT:    vid.v v10
; RV32-NEXT:    vmsltu.vx v8, v10, a1
; RV32-NEXT:    vmand.mm v0, v8, v0
; RV32-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; RV32-NEXT:    vmv.v.i v8, 1
; RV32-NEXT:    vmerge.vvm v9, v8, v12, v0
...
; RV64-NEXT:    vid.v v10
; RV64-NEXT:    vmsltu.vx v8, v10, a1
; RV64-NEXT:    vmand.mm v0, v8, v0
; RV64-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; RV64-NEXT:    vmv.v.i v8, 1
; RV64-NEXT:    vmerge.vvm v9, v8, v12, v0
; RV64-NEXT:    vslidedown.vi v8, v9, 4
; RV64-NEXT:    vmul.vv v9, v9, v8
; RV64-NEXT:    vslidedown.vi v8, v9, 2
; RV64-NEXT:    vmul.vv v9, v9, v8
; RV64-NEXT:    vrgather.vi v8, v9, 1
...
; RV32-NEXT:    vid.v v12
; RV32-NEXT:    vmsltu.vx v8, v12, a1
; RV32-NEXT:    vmand.mm v0, v8, v0
; RV32-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; RV32-NEXT:    vmv.v.i v8, 1
; RV32-NEXT:    vmerge.vvm v9, v8, v10, v0
; RV32-NEXT:    vslidedown.vi v8, v9, 8
; RV32-NEXT:    vmul.vv v9, v9, v8
; RV32-NEXT:    vslidedown.vi v8, v9, 4
; RV32-NEXT:    vmul.vv v9, v9, v8
; RV32-NEXT:    vslidedown.vi v8, v9, 2
...
; RV64-NEXT:    vid.v v12
; RV64-NEXT:    vmsltu.vx v8, v12, a1
; RV64-NEXT:    vmand.mm v0, v8, v0
; RV64-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; RV64-NEXT:    vmv.v.i v8, 1
; RV64-NEXT:    vmerge.vvm v9, v8, v10, v0
; RV64-NEXT:    vslidedown.vi v8, v9, 8
; RV64-NEXT:    vmul.vv v9, v9, v8
; RV64-NEXT:    vslidedown.vi v8, v9, 4
; RV64-NEXT:    vmul.vv v9, v9, v8
; RV64-NEXT:    vslidedown.vi v8, v9, 2
...
; RV32-NEXT:    vid.v v16
; RV32-NEXT:    vmsltu.vx v8, v16, a1
; RV32-NEXT:    vmand.mm v0, v8, v0
; RV32-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; RV32-NEXT:    vmv.v.i v8, 1
; RV32-NEXT:    vmerge.vvm v10, v8, v12, v0
; RV32-NEXT:    vslidedown.vi v8, v10, 16
; RV32-NEXT:    vmul.vv v10, v10, v8
; RV32-NEXT:    vslidedown.vi v8, v10, 8
; RV32-NEXT:    vmul.vv v10, v10, v8
; RV32-NEXT:    vslidedown.vi v8, v10, 4
; RV32-NEXT:    vmul.vv v10, v10, v8
; RV32-NEXT:    vslidedown.vi v8, v10, 2
; RV32-NEXT:    vmul.vv v10, v10, v8
; RV32-NEXT:    vrgather.vi v8, v10, 1
...
; RV64-NEXT:    vid.v v16
; RV64-NEXT:    vmsltu.vx v8, v16, a1
; RV64-NEXT:    vmand.mm v0, v8, v0
; RV64-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; RV64-NEXT:    vmv.v.i v8, 1
; RV64-NEXT:    vmerge.vvm v10, v8, v12, v0
; RV64-NEXT:    vslidedown.vi v8, v10, 16
; RV64-NEXT:    vmul.vv v10, v10, v8
; RV64-NEXT:    vslidedown.vi v8, v10, 8
; RV64-NEXT:    vmul.vv v10, v10, v8
; RV64-NEXT:    vslidedown.vi v8, v10, 4
; RV64-NEXT:    vmul.vv v10, v10, v8
; RV64-NEXT:    vslidedown.vi v8, v10, 2
; RV64-NEXT:    vmul.vv v10, v10, v8
; RV64-NEXT:    vrgather.vi v8, v10, 1
...
; RV32-NEXT:    vmul.vv v12, v12, v8
; RV32-NEXT:    vslidedown.vi v8, v12, 16
; RV32-NEXT:    vmul.vv v12, v12, v8
; RV32-NEXT:    vslidedown.vi v8, v12, 8
; RV32-NEXT:    vmul.vv v12, v12, v8
; RV32-NEXT:    vslidedown.vi v8, v12, 4
; RV32-NEXT:    vmul.vv v12, v12, v8
; RV32-NEXT:    vslidedown.vi v8, v12, 2
; RV32-NEXT:    vmul.vv v12, v12, v8
; RV32-NEXT:    vrgather.vi v8, v12, 1
...
; RV64-NEXT:    vmand.mm v0, v8, v0
; RV64-NEXT:    vmv.v.i v8, 1
; RV64-NEXT:    vmerge.vvm v12, v8, v24, v0
; RV64-NEXT:    vslidedown.vx v8, v12, a3
; RV64-NEXT:    vmul.vv v12, v12, v8
; RV64-NEXT:    vslidedown.vi v8, v12, 16
; RV64-NEXT:    vmul.vv v12, v12, v8
; RV64-NEXT:    vslidedown.vi v8, v12, 8
; RV64-NEXT:    vmul.vv v12, v12, v8
; RV64-NEXT:    vslidedown.vi v8, v12, 4
; RV64-NEXT:    vmul.vv v12, v12, v8
; RV64-NEXT:    vslidedown.vi v8, v12, 2
; RV64-NEXT:    vmul.vv v12, v12, v8
; RV64-NEXT:    vrgather.vi v8, v12, 1
; RV64-NEXT:    vmul.vv v8, v12, v8
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    mv a1, a2
; RV64-NEXT:    call __muldi3@plt
; RV64-NEXT:    slli a0, a0, 56
