...
; CHECK-NEXT:    vmadc.vvm v8, v10, v9, v0
...
; CHECK-NEXT:    vmadc.vvm v8, v12, v10, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vvm v8, v16, v12, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vvm v8, v24, v16, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vxm v8, v10, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vxm v8, v12, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vxm v8, v16, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vxm v8, v24, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmadc.vvm v8, v10, v9, v0
...
; RV64-NEXT:    vmadc.vxm v8, v10, a0, v0
...
; RV32-NEXT:    vmadc.vvm v8, v12, v10, v0
...
; RV64-NEXT:    vmadc.vxm v8, v12, a0, v0
...
; RV32-NEXT:    vmadc.vvm v8, v16, v12, v0
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmadc.vxm v8, v16, a0, v0
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    ret
entry:
...
; RV32-NEXT:    vmadc.vvm v8, v24, v16, v0
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmadc.vxm v8, v24, a0, v0
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmv1r.v v10, v8
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vmadc.vim v8, v10, 9, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmadc.carry.in.nxv1i8.i8(
...
; CHECK-NEXT:    vmv2r.v v12, v8
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, ma
; CHECK-NEXT:    vmadc.vim v8, v12, 9, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i1> @llvm.riscv.vmadc.carry.in.nxv16i8.i8(
...
; CHECK-NEXT:    vmv4r.v v16, v8
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; CHECK-NEXT:    vmadc.vim v8, v16, 9, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i1> @llvm.riscv.vmadc.carry.in.nxv32i8.i8(
...
; CHECK-NEXT:    vmv8r.v v24, v8
; CHECK-NEXT:    vsetvli zero, a0, e8, m8, ta, ma
; CHECK-NEXT:    vmadc.vim v8, v24, 9, v0
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 64 x i1> @llvm.riscv.vmadc.carry.in.nxv64i8.i8(
